# mSCIdblit release v1.9.189

Release date: 2026-09-22

Graph identifier: `module20_24_mechanism_graph:2026-09-22-literature-expansion-303`

Bundle: `data/processed/mechanism_graph_module20_24_v2026_09_21_literature_expansion303/`

## Functional readout curation

This release adds 14 topology-unlinked output annotations for primary-supported
ERK/NMDAR, LTP, receptor insertion, immune-control, fibrillogenesis, and
activin-antagonism readouts. No complete ligand→receptor→intracellular→TF route
is inferred.
