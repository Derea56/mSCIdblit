...
[`RELEASE_v1.9.230.md`](RELEASE_v1.9.230.md). Earlier snapshots, including
v1.9.149 and the v1.8.x series, are retained as implementation and historical
baseline references.

Current release identifier: `module20_24_mechanism_graph:2026-09-23-il6-parallel-jak-348`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_23_literature_expansion348/`.
...
334,068 records across entry, output, intracellular, TF, and combined route
...
edges for all 334,068 routes, including explicit missing-link rows and
