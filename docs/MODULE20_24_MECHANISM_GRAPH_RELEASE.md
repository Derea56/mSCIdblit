...
[`RELEASE_v1.9.265.md`](RELEASE_v1.9.265.md). Earlier snapshots, including
...
Current release identifier: `module20_24_mechanism_graph:2026-09-24-il1a-il33-il18-routes-388`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_24_literature_expansion388/`.
...
and 96 boundary groups. It retains 341,048 evidence-route records and 7,380
literature-expansion annotations, including 1,370 explicit
`ligand>receptor>intracellular>TF>target_gene_expression` records. The
normalized route artifacts contain 1,311,345 route nodes and 1,287,967 route
edges. This release adds one IL-1A/MYD88/RELA route, two IL-33/MYD88/STAT3
target-gene routes, and one IL-18/MYD88/STAT4/IFNG route while preserving the
unresolved receptor-to-relay and relay-to-TF handoffs. It carries forward the
