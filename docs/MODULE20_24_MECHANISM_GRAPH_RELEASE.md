...
[`RELEASE_v1.9.213.md`](RELEASE_v1.9.213.md). Earlier snapshots, including
v1.9.149 and the v1.8.x series, are retained as implementation and historical
baseline references.

Current release identifier: `module20_24_mechanism_graph:2026-09-23-primary-full-sequence-routes-331`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_23_literature_expansion331/`.
...
333,722 records across entry, output, intracellular, TF, and combined route
...
retains 40 full-sequence primary route annotations across 16 ligands, including
the IL1B TF-family-supported routes and the expanded cytokine/JAK/STAT routes.
...
edges for all 333,722 routes, including explicit missing-link rows and
