...
[`RELEASE_v1.9.206.md`](RELEASE_v1.9.206.md). Earlier snapshots, including
v1.9.149 and the v1.8.x series, are retained as implementation and historical
baseline references.

Current release identifier: `module20_24_mechanism_graph:2026-09-22-disposition-320`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_21_literature_expansion320/`.
...
19,713 records across entry, output, intracellular, TF, and combined route
...
creating graph edges or confidence scores. The current audit wave added 20
source-linked downstream annotations and reviewed eight further records as
binding-only, contextual, or already represented by another output route.
