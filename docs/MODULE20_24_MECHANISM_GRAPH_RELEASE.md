...
[`RELEASE_v1.9.251.md`](RELEASE_v1.9.251.md). Earlier snapshots, including
v1.9.149 and the v1.8.x series, are retained as implementation and historical
baseline references.

Current release identifier: `module20_24_mechanism_graph:2026-09-23-alias-target-routes-374`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_23_literature_expansion374/`.
...
340,117 records across entry, output, intracellular, TF, and combined route
...
retains 6,449 literature-expansion route annotations across 1,870 ligand labels,
...
routes across eight ligand aliases. The prior
...
439 explicit `ligand>receptor>intracellular>TF>target_gene_expression` records
...
edges for all 340,117 routes, including explicit missing-link rows and
