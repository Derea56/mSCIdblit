...
[`RELEASE_v1.9.215.md`](RELEASE_v1.9.215.md). Earlier snapshots, including
v1.9.149 and the v1.8.x series, are retained as implementation and historical
baseline references.

Current release identifier: `module20_24_mechanism_graph:2026-09-23-primary-full-sequence-routes-333`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_23_literature_expansion333/`.
...
333,750 records across entry, output, intracellular, TF, and combined route
...
retains 68 full-sequence primary route annotations across 20 ligand labels,
including the IL1B TF-family-supported routes, the expanded cytokine/JAK/STAT
routes, reconciled IL-4/IL-15 JAK1/JAK3 branches, receptor aliases, and
Biglycan–TLR–MyD88/NF-kappaB routes.
...
edges for all 333,750 routes, including explicit missing-link rows and
