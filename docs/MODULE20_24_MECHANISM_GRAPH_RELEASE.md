...
[`RELEASE_v1.9.220.md`](RELEASE_v1.9.220.md). Earlier snapshots, including
v1.9.149 and the v1.8.x series, are retained as implementation and historical
baseline references.

Current release identifier: `module20_24_mechanism_graph:2026-09-23-primary-full-sequence-routes-338`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_23_literature_expansion338/`.
...
334,021 records across entry, output, intracellular, TF, and combined route
...
retains 339 full-sequence route annotations across 101 ligand labels,
...
edges for all 334,021 routes, including explicit missing-link rows and
