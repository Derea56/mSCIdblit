...
[`RELEASE_v1.9.216.md`](RELEASE_v1.9.216.md). Earlier snapshots, including
v1.9.149 and the v1.8.x series, are retained as implementation and historical
baseline references.

Current release identifier: `module20_24_mechanism_graph:2026-09-23-primary-full-sequence-routes-334`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_23_literature_expansion334/`.
...
333,794 records across entry, output, intracellular, TF, and combined route
...
retains 112 full-sequence primary route annotations across 42 ligand labels,
...
edges for all 333,794 routes, including explicit missing-link rows and
