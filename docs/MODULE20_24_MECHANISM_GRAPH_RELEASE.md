...
[`RELEASE_v1.9.226.md`](RELEASE_v1.9.226.md). Earlier snapshots, including
v1.9.149 and the v1.8.x series, are retained as implementation and historical
baseline references.

Current release identifier: `module20_24_mechanism_graph:2026-09-23-common-gamma-primary-344`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_23_literature_expansion344/`.
...
334,051 records across entry, output, intracellular, TF, and combined route
...
edges for all 334,051 routes, including explicit missing-link rows and
