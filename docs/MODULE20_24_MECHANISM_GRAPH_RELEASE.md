...
[`RELEASE_v1.9.247.md`](RELEASE_v1.9.247.md). Earlier snapshots, including
v1.9.149 and the v1.8.x series, are retained as implementation and historical
baseline references.

Current release identifier: `module20_24_mechanism_graph:2026-09-23-gh-jak2-stat5-cish-370`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_23_literature_expansion370/`.
...
340,053 records across entry, output, intracellular, TF, and combined route
...
retains 6,385 literature-expansion route annotations across 1,868 ligand labels,
...
edges for all 340,053 routes, including explicit missing-link rows and
