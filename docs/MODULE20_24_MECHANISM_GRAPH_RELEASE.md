...
[`RELEASE_v1.9.154.md`](RELEASE_v1.9.154.md). Earlier snapshots, including
v1.9.149 and the v1.8.x series, are retained as implementation and historical
baseline references.

Current release identifier: `module20_24_mechanism_graph:2026-09-21-literature-expansion-267`

Current bundle: `data/processed/mechanism_graph_module20_24_v2026_09_21_literature_expansion267/`.
...
16,274 records across entry, output, intracellular, TF, and combined route
...
creating graph edges or confidence scores. See the v1.9.154 release note for
