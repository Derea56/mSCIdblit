...
Five of the eight rows retained reusable target capacity. Bsg, Adra2a, Grm7, and Mtnr1a reused existing target contexts; and Npy2r gained IRF1 and FOXI1 promoter-regulatory contexts from allele-sensitive promoter perturbation and TF-specific manipulation. Gpr83, Npy1r, and Npy4r remained bounded holds because the targeted material provided expression, promoter-motif, receptor-signaling, or pathway evidence without establishing a qualifying named activating TF-to-target relationship.

The retained contexts remain separate from the submitted Ppia and Ppy handoffs and do not establish source-to-TF activation. The reusable contexts are non-SCI signed mouse, TRRUST, rat endocrine/colonic, neuronal, renal-injury, and human/rat neuroendocrine comparators. The individual search log contains 2788 rows through M22B-IND-2788. This tranche added two standalone target edges and one evidence record, reused target contexts for four rows, and kept Gpr83, Npy1r, and Npy4r on hold.
