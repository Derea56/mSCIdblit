...
B073 adds a new medium-high-confidence EFNB1 ligand-side reverse-signaling relay using a primary HEK293 transfection study. Ephrin-B1 expression activates JNK through TAK1/MKK4/MKK7, requires the cytoplasmic domain, persists after removal of all six intracellular tyrosines, and is blocked by JNK inhibition but not Src inhibition. The edge is deliberately receptor-unassigned: no EphB receptor, direct binary interaction, exact relay ordering, terminal TF, native tissue mechanism, or traumatic-SCI transfer is asserted, and the existing low/conflicted EFNB1-to-EphB6 JNK/Rac1 edge remains separate.
...
B077 adds two high-confidence, receptor-unassigned ephrin-B2 astrocyte function edges using a primary mouse conditional-deletion study. Astrocyte-specific GFAP-Cre deletion reduces astrogliosis and glial-scar size, increases corticospinal axon regeneration, and improves motor recovery after lateral-hemisection SCI; co-culture and functional-blockade assays support inhibition of neurite outgrowth by astrocyte ephrin-B2. The regeneration-inhibition and gliosis/scar outputs are kept as separate downstream edges. EphA4/EphB2 mechanisms are discussed as hypotheses rather than promoted receptor assignments, and no direct affinity, complete relay, or transfer beyond mouse SCI/culture models is asserted.
B078 adds four medium-high-confidence EMILIN1/gC1q–integrin edges using primary mouse and human skin/epithelial studies: cellular engagement of α4β1 and α9β1, an α4-tail-dependent HRAS/ERK receptor-proximal relay, and a bounded anti-proliferative skin-cell function. The direct layer is cellular receptor engagement rather than purified monovalent affinity; the HRAS/ERK relay is assigned only to α4β1, and the proliferation output retains combined α4/α9 receptor-context and non-SCI limits. No complete biochemical ordering, terminal TF, or traumatic-SCI transfer is asserted.
B079 adds two medium-high-confidence MATN1/matrilin-1 (cartilage matrix protein)–α1β1 edges using a primary rabbit and human cartilage/fibroblast study: cellular α1β1 engagement and α1β1-dependent chondrocyte/fibroblast adhesion and spreading. The primary abstract reports α1/β1 blockade, α1 co-precipitation of radiolabeled CMP, competition, and native type-II-collagen synergy. The record is abstract-level and does not assert a downstream kinase relay, terminal TF, or traumatic-SCI transfer.
B080 adds one high-confidence collagen-I-grown scar-forming astrocyte cellular-function edge using a primary full-text mouse transplantation and chronic-SCI study: transplanted Col-I-SAs convert adjacent host naïve astrocytes into scar-forming astrocytes, and anti-β1-integrin treatment blocks recruitment while reducing chronic glial-scar volume. This is kept separate from the existing collagen-I–β1/N-cadherin receptor-proximal edges; no purified collagen-I–integrin affinity, promoter occupancy, complete relay, or non-mouse SCI transfer is asserted.
## Review-led expansion: B081 (2026-09-05)

B081 adds three medium-high-confidence FN1/P2Y1 astrocyte edges from the primary rat spinal-cord astrocyte study PMID 24687862: fibronectin promotes α5β1-dependent astrocyte proliferation, fibronectin-associated P2Y1 upregulation is linked to Ca2+/ILK/Akt and ERK1/2 pathway context, and ATP/P2Y1 signaling promotes astrocyte proliferation with arachidonic acid/prostaglandin E2 release. The source is represented at PubMed-abstract resolution because the Wiley full text was not available; no direct FN1–P2Y1 binding, in-vivo SCI intervention, promoter occupancy, or complete relay is asserted.
## Review-led expansion: B082 (2026-09-05)

B082 adds three medium-high-confidence edges from a primary full-text 3D fibrotic-scar hydrogel study (PMID 39259933; PMCID PMC11480936): ITGB1 blockade reduces GFAP/N-cadherin astrocyte activation markers, ITGB1 blockade reduces nuclear YAP localization in the composite hydrogel model, and Rho-ROCK inhibition increases DRG neurite outgrowth. These are kept separate from existing collagen-I–β1/N-cadherin and stiffness/ILK edges; the evidence remains pharmacological and in vitro, with no direct ITGB1–YAP binding, genetic Rho/ROCK perturbation, in-vivo SCI causality, or complete relay asserted.
## Review-led expansion: B083 (2026-09-05)

B083 adds seven paired medium-high/high-confidence CSPG/LAR/PTPσ and NPC-derived-astrocyte edges using a primary full-text study (PMID 39303705; PMCID PMC11561464). The study supports combined LAR/PTPσ-sensitive CSPG receptor-mediated endocytosis, CSPG-induced and receptor-blockade-sensitive ADAMTS1/9 release, ADAMTS1/9 knockdown-dependent extracellular and intracellular CSPG degradation, NPC-derived-astrocyte CSPG clearance in rat/mouse SCI tissue, and paracrine promotion of NPC neurogenesis, neuronal differentiation, neuronal maturation, and synaptogenesis. Combined receptor pharmacology is retained without individual LAR-versus-PTPσ assignment; no purified CSPG-receptor affinity, complete intracellular ordering, terminal-TF transfer, or function beyond the reported human-cell and rat/mouse SCI models is asserted.
B084 adds two medium-high-confidence, family-level collagen-VI/CSPG4-NG2 edges using primary rat neural, human glioma, and embryonic-rat studies (PMIDs 2269670 and 8305732; PMCIDs PMC2116373 and PMC275746). The studies support type-VI-collagen association with cell-surface NG2/CSPG4 and NG2-dependent collagen-VI retention/pericellular matrix assembly. The records resolve a family-level receptor/function layer without assigning COL6A4, COL6A5, or COL6A6 specifically; cell-based/colocalization, non-SCI model, no-purified-affinity, and no-complete-relay limits remain explicit.
B085 adds three Ryk receptor-function edges using the primary full-text mouse SCI study PMCID PMC12012454/PMID 40208942: astrocyte-specific Ryk loss accelerates reactive-astrocyte process elongation and glial-border formation; NrCAM antisense rescue supports a bounded Ryk-NrCAM morphology relay; and Ryk loss reduces lesion volume, preserves neurons and corticospinal axons, and improves grip strength and rotarod performance. Human injured-spinal-cord tissue is retained as expression context only. No Wnt ligand identity, direct Ryk-NrCAM binding, complete intracellular ordering, or causal human treatment effect is asserted.
B086 adds three CCN1-SDC4 white-matter-repair edges using the primary full-text Nature study (PMCID PMC12823418; PMID 41407858; DOI 10.1038/s41586-025-09887-y): cell-based CCN1-SDC4 association in microglia, SDC4-blockade-sensitive CCN1-induced microglial lipid-droplet storage, and astrocyte-specific Ccn1-loss effects on white-matter debris clearance and sensory recovery after mouse incomplete SCI. Human injured-spinal-cord tissue is retained as expression context only. No purified binary affinity, complete intracellular ordering, universal microglial-state transfer, or causal human treatment effect is asserted.
B087 adds four MAOB-GABA-proBDNF/TrkB SCI-repair edges using the primary full-text Signal Transduction and Targeted Therapy study (PMCID PMC12423301; PMID 40931022; DOI 10.1038/s41392-025-02398-2): astrocytic MAOB-associated GABA/tonic inhibition, GABA suppression of astrocytic proBDNF, astrocytic BDNF contribution to survival, and MAOB-dependent motor/tissue recovery and neural repair. Species and perturbation boundaries remain explicit across mouse, rat, and monkey SCI models; healthy-human phase-1 data are safety/PK only. No GABAA subtype assignment, complete intracellular ordering, combined MAOB/BDNF rescue, or human efficacy claim is asserted.
B088 adds four CSPG-CYP450 microglia-astrocyte crosstalk edges using the primary full-text Advanced Science study (PMCID PMC12866793; PMID 41221600; DOI 10.1002/advs.202516269): CSPG suppression of microglial CYP450 detoxification, a TLR4-mediated CYP450 suppression layer, CSPG-primed microglial induction of astrocyte scar-forming markers, and astrocytic CSPG-core-protein expression/secretion. The primary mouse SCI, microglial perturbation, TLR4-inhibitor, and transwell boundaries remain explicit. No direct CSPG-TLR4 binding, single CSPG-core assignment, astrocyte receptor identity, or complete intracellular ordering is asserted; dFLPP-ChABC recovery is retained as source context rather than a duplicated treatment edge.
B089 adds four collagen-VI substrate-state-specific integrin-binding edges using the primary Experimental Cell Research study (PMID 8387021; DOI 10.1006/excr.1993.1134): native triple-helical collagen VI with alpha1beta1 and alpha2beta1, and denatured/unfolded collagen VI with alpha5beta1 and alphaVbeta3 activity. The source is PubMed-abstract-only in this acquisition; native versus denatured substrate, weaker binding than collagen I/IV, weak alphaIIbbeta3 activity, cell-line/non-SCI scope, and no traumatic-SCI relay or downstream function are preserved.
B090 adds four PACAP-VPAC1 postsynaptic amygdala-potentiation edges using the primary full-text Journal of Neuroscience study (PMCID PMC3490216; PMID 23055486; DOI 10.1523/JNEUROSCI.1402-12.2012): selective VPAC1-antagonist mediation plus postsynaptic PKA, CaMKII, and GluR1-containing AMPAR-targeting layers in rat BLA-CeL slices. Pharmacological inhibitor, acute-slice, no-direct-binding, non-SCI, and no-terminal-TF limits remain explicit; the existing broad low PACAP relay row is not upgraded.
B091 adds three EphrinB1-CNK1 EphB-independent reverse-signaling edges using the primary full-text Journal of Biological Chemistry study (PMCID PMC4140269; PMID 24825906; DOI 10.1074/jbc.M114.558809): cellular EphrinB1-CNK1 association, CNK1/RhoA-p115RhoGEF-MKK4-JNK relay, and CNK1/Rho-kinase/JNK-dependent cell migration. Human cell-line, co-immunoprecipitation, overexpression/siRNA/inhibitor, fibronectin-adhesion, no-EphB-assignment, non-SCI, and no-terminal-TF limits remain explicit; the existing low EphB6 row is not upgraded.
B092 adds one laminin-SV2 exact binding edge using the primary Journal of Biological Chemistry study (PMID 10617638; DOI 10.1074/jbc.275.1.451): high-affinity purified SV2-laminin-1 binding plus alpha5-containing laminin/SV2 association on electric-organ synaptosomes. The PubMed-abstract-only acquisition preserves the alpha5-containing-complex versus laminin-1 assay distinction, electric-organ comparator, SV2-family/isoform boundary, and no traumatic-SCI relay or downstream function; the unresolved laminin-SV2 queue boundary is narrowed but not generalized to LAMB2-SV2A/B/C.
