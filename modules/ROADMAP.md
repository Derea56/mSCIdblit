...
| Module 3B | Immune and myeloid modulation evidence consolidation | Observation and claim linkage | PROVISIONAL SEED-CONSENSUS FIRST PASS | 7 observations, 12 author claims, 21 evidence links, 6 boundary records, and 6 provisional consensus statements from the current Module 3A seed corpus; not saturation-level until Module 3A is completed |
...
| Module 5B | Axon regeneration, remyelination, and white matter repair evidence consolidation | Observation and claim linkage | PROVISIONAL SEED-CONSENSUS FIRST PASS | 9 observations, 14 author claims, 21 evidence links, 6 boundary records, and 6 provisional consensus statements from the current Module 5A seed corpus; not saturation-level until Module 5A is completed |
...
The Module 3B-5B synthesis draft is recorded in `docs/MODULE_3_5_CONSENSUS.md`. It bridges immune/myeloid state, cell transplantation, and axon/white-matter repair, while explicitly marking Modules 3B and 5B as provisional seed-consensus layers until their A-phase corpora are saturated.
