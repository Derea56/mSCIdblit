...
| Module 3B | Immune and myeloid modulation evidence consolidation | Observation and claim linkage | PROVISIONAL / NEEDS REFRESH FROM SATURATED 3A | Existing seed layer has 7 observations, 12 author claims, 21 evidence links, 6 boundary records, and 6 provisional statements; refresh from saturated Module 3A is now queued |
...
| Module 5B | Axon regeneration, remyelination, and white matter repair evidence consolidation | Observation and claim linkage | PROVISIONAL / NEEDS REFRESH FROM SATURATED 5A | Existing seed layer has 9 observations, 14 author claims, 21 evidence links, 6 boundary records, and 6 provisional statements; refresh from saturated Module 5A is now queued |
...
The Module 3B-5B synthesis draft is recorded in `docs/MODULE_3_5_CONSENSUS.md`. It bridges immune/myeloid state, cell transplantation, and axon/white-matter repair, but the 3B and 5B portions now require refresh from the saturated 3A and 5A corpora.
