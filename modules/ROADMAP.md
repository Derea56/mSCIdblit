...
| Module 4A | Cell transplantation and graft integration after SCI | Corpus saturation | ACTIVE | Phase 1B seeded with 45 primary/clinical papers, 12 review/map anchors, and 83 abstract-level experiment rows across NS/PC, iPSC, Schwann, OEC, MSC/BMMC, restricted precursor, OPC, organoid, clinical safety, and scaffold-cell categories |
