...
| Module 1B | Chronic SCI lesion architecture evidence consolidation | Observation and claim linkage | CONSENSUS-READY FIRST PASS | 84 observations, 50 author claims, 107 evidence links, and 7 boundary records from the saturated Module 1A corpus |
...
| Module 2B | Biomaterials and scaffold repair evidence consolidation | Observation and claim linkage | CONSENSUS-READY FIRST PASS | 50 observations, 36 author claims, 56 evidence links, 8 boundary records, and 8 consensus-ready statements from the saturated Module 2A corpus |
...
| Module 4A | Cell transplantation and graft integration after SCI | Corpus saturation | ACTIVE | Includes neural stem/progenitor cells, Schwann cells, MSCs, olfactory ensheathing cells, iPSC-derived grafts, and host-graft integration |
