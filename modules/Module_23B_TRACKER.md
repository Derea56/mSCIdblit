...
B075 adds three paired 23B medium-high-confidence EFNB1/EFNB2–IL-7Rα edges using a primary mouse immune-cell study. Cellular FRET and immunoprecipitation support separate EFNB1–IL-7Rα and EFNB2–IL-7Rα associations, while combined T-cell-specific Efnb1/Efnb2 knockout and overexpression assays support IL-7Rα surface stabilization, delayed internalization, STAT5 activation, and homeostatic proliferation. The function edge is intentionally assigned to the combined ligand perturbation rather than either ligand alone. Cellular association is not purified affinity, and immune-model, overexpression/crosslinking, no-terminal-TF, neural, and traumatic-SCI boundaries remain explicit. Canonical signaling tables and simulator outputs remain untouched.

## Review-led expansion: B076 (2026-09-05)

B076 adds two paired 23B medium-high-confidence EFNB2–EphB2 SCI-context edges using a primary adult rat thoracic-transection study. Ephrin-B2 is localized to reactive astrocytes and EphB2 to invading meningeal fibroblasts; early lesion-interface cell intermingling is accompanied by reciprocal phosphorylation, followed by astrocyte-fibroblast segregation and glial-fibrotic scar-boundary formation. The receptor-proximal edge and downstream function edge are kept separate, and the function record remains observational because the study did not perform pair-specific perturbation. No purified affinity, complete intracellular ordering, exclusion of other Eph/ephrin members, or transfer beyond adult rat SCI is asserted. Canonical signaling tables and simulator outputs remain untouched.

## Review-led expansion: B077 (2026-09-05)

B077 adds two paired 23B high-confidence, receptor-unassigned ephrin-B2 astrocyte function edges using a primary mouse conditional-deletion study. Astrocyte-specific GFAP-Cre deletion reduces astrogliosis and glial-scar size, increases corticospinal axon regeneration, and improves motor recovery after lateral-hemisection SCI; co-culture and functional-blockade assays support inhibition of neurite outgrowth by astrocyte ephrin-B2. The regeneration-inhibition and gliosis/scar outputs are kept as separate downstream edges. EphA4/EphB2 mechanisms are discussed as hypotheses rather than promoted receptor assignments, and no direct affinity, complete relay, or transfer beyond mouse SCI/culture models is asserted. Canonical signaling tables and simulator outputs remain untouched.
B078 adds four paired 23B medium-high-confidence EMILIN1/gC1q–integrin edges using primary mouse and human skin/epithelial studies: cellular engagement of α4β1 and α9β1, an α4-tail-dependent HRAS/ERK receptor-proximal relay, and a bounded anti-proliferative skin-cell function. The direct layer is cellular receptor engagement rather than purified monovalent affinity; the HRAS/ERK relay is assigned only to α4β1, and the proliferation output retains combined α4/α9 receptor-context and non-SCI limits. No complete biochemical ordering, terminal TF, or traumatic-SCI transfer is asserted. Canonical signaling tables and simulator outputs remain untouched.
B079 adds two paired 23B medium-high-confidence MATN1/matrilin-1 (cartilage matrix protein)–α1β1 edges using a primary rabbit and human cartilage/fibroblast study: cellular α1β1 engagement and α1β1-dependent chondrocyte/fibroblast adhesion and spreading. The primary abstract reports α1/β1 blockade, α1 co-precipitation of radiolabeled CMP, competition, and native type-II-collagen synergy. The record is abstract-level and does not assert a downstream kinase relay, terminal TF, or traumatic-SCI transfer. Canonical signaling tables and simulator outputs remain untouched.
B080 adds one paired 23B high-confidence collagen-I-grown scar-forming astrocyte recruitment/function edge using a primary full-text mouse transplantation and chronic-SCI study: transplanted Col-I-SAs convert adjacent host naïve astrocytes into scar-forming astrocytes, and anti-β1-integrin treatment blocks recruitment while reducing chronic glial-scar volume. This is kept separate from the existing collagen-I–β1/N-cadherin receptor-proximal edges; no purified collagen-I–integrin affinity, promoter occupancy, complete relay, or non-mouse SCI transfer is asserted. Canonical signaling tables and simulator outputs remain untouched.
## Review-led expansion: B081 (2026-09-05)

B081 adds three paired 23B medium-high-confidence FN1/P2Y1 astrocyte edges from the primary rat spinal-cord astrocyte study PMID 24687862: fibronectin promotes α5β1-dependent astrocyte proliferation, fibronectin-associated P2Y1 upregulation is linked to Ca2+/ILK/Akt and ERK1/2 pathway context, and ATP/P2Y1 signaling promotes astrocyte proliferation with arachidonic acid/prostaglandin E2 release. The source is represented at PubMed-abstract resolution because the Wiley full text was not available; no direct FN1–P2Y1 binding, in-vivo SCI intervention, promoter occupancy, or complete relay is asserted. Canonical signaling tables and simulator outputs remain untouched.
## Review-led expansion: B082 (2026-09-05)

B082 adds three paired 23B medium-high-confidence edges from a primary full-text 3D fibrotic-scar hydrogel study (PMID 39259933; PMCID PMC11480936): ITGB1 blockade reduces GFAP/N-cadherin astrocyte activation markers, ITGB1 blockade reduces nuclear YAP localization in the composite hydrogel model, and Rho-ROCK inhibition increases DRG neurite outgrowth. These are kept separate from existing collagen-I–β1/N-cadherin and stiffness/ILK edges; the evidence remains pharmacological and in vitro, with no direct ITGB1–YAP binding, genetic Rho/ROCK perturbation, in-vivo SCI causality, or complete relay asserted. Canonical signaling tables and simulator outputs remain untouched.
## Review-led expansion: B083 (2026-09-05)

B083 adds seven paired 23B CSPG/LAR/PTPσ and NPC-derived-astrocyte edges using a primary full-text study (PMID 39303705; PMCID PMC11561464): combined LAR/PTPσ-sensitive CSPG endocytosis; CSPG-induced, receptor-blockade-sensitive ADAMTS1/9 release; ADAMTS1/9 knockdown-dependent CSPG degradation; NPC-derived-astrocyte CSPG clearance in rat/mouse SCI tissue; and paracrine NPC neurogenesis, neuronal differentiation, neuronal maturation, and synaptogenesis. The records retain separate receptor, enzyme, whole-lesion, and paracrine layers. Combined receptor pharmacology does not assign effects to LAR or PTPσ individually, and no purified affinity, complete ordering, terminal-TF transfer, or function beyond the reported human-cell and rat/mouse SCI models is asserted. Canonical signaling tables and simulator outputs remain untouched.
B084 adds two paired 23B family-level collagen-VI/CSPG4-NG2 edges using primary rat neural, human glioma, and embryonic-rat studies (PMIDs 2269670 and 8305732; PMCIDs PMC2116373 and PMC275746): type-VI-collagen association with cell-surface NG2/CSPG4 and NG2-dependent collagen-VI retention/pericellular matrix assembly. The records preserve separate receptor-interaction and functional-retention layers and do not assign COL6A4, COL6A5, or COL6A6 specifically. Cell-based/colocalization, non-SCI model, no-purified-affinity, no-complete-relay, and no-traumatic-SCI limits remain explicit. Canonical signaling tables and simulator outputs remain untouched.
B085 adds three paired 23B Ryk receptor-function edges using the primary full-text mouse SCI study (PMCID PMC12012454; PMID 40208942; DOI 10.1073/pnas.2417400122): astrocyte-specific Ryk loss accelerates reactive-astrocyte process elongation and glial-border formation; NrCAM antisense rescue supports a bounded Ryk-NrCAM morphology relay; and Ryk loss reduces lesion volume, preserves neurons and corticospinal axons, and improves grip strength and rotarod performance. Human injured-spinal-cord tissue is retained as expression context only. No Wnt ligand identity, direct Ryk-NrCAM binding, complete intracellular ordering, or causal human treatment effect is asserted. Canonical signaling tables and simulator outputs remain untouched.
B086 adds three paired 23B CCN1-SDC4 white-matter-repair edges using the primary full-text Nature study (PMCID PMC12823418; PMID 41407858; DOI 10.1038/s41586-025-09887-y): cell-based CCN1-SDC4 association in microglia, SDC4-blockade-sensitive CCN1-induced microglial lipid-droplet storage, and astrocyte-specific Ccn1-loss effects on white-matter debris clearance and sensory recovery after mouse incomplete SCI. Human injured-spinal-cord tissue is retained as expression context only. No purified binary affinity, complete intracellular ordering, universal microglial-state transfer, or causal human treatment effect is asserted. Canonical signaling tables and simulator outputs remain untouched.
B087 adds four paired 23B MAOB-GABA-proBDNF/TrkB SCI-repair edges using the primary full-text Signal Transduction and Targeted Therapy study (PMCID PMC12423301; PMID 40931022; DOI 10.1038/s41392-025-02398-2): astrocytic MAOB-associated GABA/tonic inhibition, GABA suppression of astrocytic proBDNF, astrocytic BDNF contribution to survival, and MAOB-dependent motor/tissue recovery and neural repair. Species and perturbation boundaries remain explicit across mouse, rat, and monkey SCI models; healthy-human phase-1 data are safety/PK only. No GABAA subtype assignment, complete intracellular ordering, combined MAOB/BDNF rescue, or human efficacy claim is asserted. Canonical signaling tables and simulator outputs remain untouched.
B088 adds four paired 23B CSPG-CYP450 microglia-astrocyte crosstalk edges using the primary full-text Advanced Science study (PMCID PMC12866793; PMID 41221600; DOI 10.1002/advs.202516269): CSPG suppression of microglial CYP450 detoxification, a TLR4-mediated CYP450 suppression layer, CSPG-primed microglial induction of astrocyte scar-forming markers, and astrocytic CSPG-core-protein expression/secretion. Primary mouse SCI, microglial perturbation, TLR4-inhibitor, and transwell boundaries remain explicit. No direct CSPG-TLR4 binding, single CSPG-core assignment, astrocyte receptor identity, or complete intracellular ordering is asserted; dFLPP-ChABC recovery is retained as source context rather than a duplicated treatment edge. Canonical signaling tables and simulator outputs remain untouched.
B089 adds four paired 23B collagen-VI substrate-state-specific integrin-binding edges using the primary Experimental Cell Research study (PMID 8387021; DOI 10.1006/excr.1993.1134): native triple-helical collagen VI with alpha1beta1 and alpha2beta1, and denatured/unfolded collagen VI with alpha5beta1 and alphaVbeta3 activity. The source is PubMed-abstract-only in this acquisition; native versus denatured substrate, weaker binding than collagen I/IV, weak alphaIIbbeta3 activity, cell-line/non-SCI scope, and no traumatic-SCI relay or downstream function are preserved. Canonical signaling tables and simulator outputs remain untouched.
B090 adds four paired 23B PACAP-VPAC1 postsynaptic amygdala-potentiation edges from the primary full-text Journal of Neuroscience study (PMCID PMC3490216; PMID 23055486; DOI 10.1523/JNEUROSCI.1402-12.2012): selective VPAC1-antagonist mediation plus postsynaptic PKA, CaMKII, and GluR1-containing AMPAR-targeting layers in rat BLA-CeL slices. Pharmacological inhibitor, acute-slice, no-direct-binding, non-SCI, and no-terminal-TF limits remain explicit; canonical signaling tables and simulator outputs remain untouched.
B091 adds three paired 23B EphrinB1-CNK1 EphB-independent reverse-signaling edges from the primary full-text Journal of Biological Chemistry study (PMCID PMC4140269; PMID 24825906; DOI 10.1074/jbc.M114.558809): cellular EphrinB1-CNK1 association, CNK1/RhoA-p115RhoGEF-MKK4-JNK relay, and CNK1/Rho-kinase/JNK-dependent cell migration. Human cell-line, co-immunoprecipitation, overexpression/siRNA/inhibitor, fibronectin-adhesion, no-EphB-assignment, non-SCI, and no-terminal-TF limits remain explicit; canonical signaling tables and simulator outputs remain untouched.
B092 adds one paired 23B laminin-SV2 exact binding edge from the primary Journal of Biological Chemistry study (PMID 10617638; DOI 10.1074/jbc.275.1.451): high-affinity purified SV2-laminin-1 binding plus alpha5-containing laminin/SV2 association on electric-organ synaptosomes. The PubMed-abstract-only acquisition preserves the alpha5-containing-complex versus laminin-1 assay distinction, electric-organ comparator, SV2-family/isoform boundary, and no traumatic-SCI relay or downstream function; canonical signaling tables and simulator outputs remain untouched.
