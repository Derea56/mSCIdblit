#!/usr/bin/env python3
"""Merge the bounded Batch 003 evidence lanes into one audit register."""
...
def main() -> int:
    ...
    pair_paths = [
        input_dir / "public_tf_evidence_review_batch003_ranks0105_pairs.tsv",
        input_dir / "public_tf_evidence_review_batch003_ranks0610_pairs.tsv",
        input_dir / "public_tf_evidence_review_batch003_ranks1115_pairs.tsv",
        input_dir / "public_tf_evidence_review_batch003_ranks1625_pairs.tsv",
    ]
    register_paths = [
        input_dir / "public_tf_evidence_review_batch003_ranks0105_regulator_register.tsv",
        input_dir / "public_tf_evidence_review_batch003_ranks0610_regulator_register.tsv",
        input_dir / "public_tf_evidence_review_batch003_ranks1115_regulator_register.tsv",
        input_dir / "public_tf_evidence_review_batch003_ranks1625_regulator_register.tsv",
    ]
    ...
    pair_path = input_dir / "public_tf_evidence_review_batch003_pairs.tsv"
    register_path = input_dir / "public_tf_evidence_review_batch003_regulator_register.tsv"
    summary_path = input_dir / "batch_003_evidence_review_summary.json"
    report_path = input_dir / "EVIDENCE_REVIEW_BATCH003.md"
    ...
    summary = {
        "status": "staging_only", "batch_id": "public_tf_evidence_batch_003",
    ...
    report_path.write_text(
        "# Evidence review: public TF batch 003\n\n"
        ...
        f"- **{summary['partial_or_near_match_rows']}** pair was a contextual near match and was not promotable.\n"
        ...
        "The one near match was ZNF750/ADAM10: a skin-context article discussed ZNF750 and an ADAM10–Notch axis together, but did not provide ZNF750 occupancy, perturbation, or reporter evidence at ADAM10. Regulator-level records for ZNF652, HOXC5, ZNF750, ZNF398, RBAK, TEAD3, HOXD11, NPAS4, ZFAT, OVOL2, BHLHA15, ZBTB11, SOX3, ASCL2, ZBED1, HOXA6, and ZNF121 were kept separate from queued target edges.\n\n"
