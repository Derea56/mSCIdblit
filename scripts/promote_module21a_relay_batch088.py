#!/usr/bin/env python3
"""Promote six validated Module 21A relay rows from EVID-3111--3160."""
...
REVIEW_FILES = [
    RELAY / "module21a_pair_relay_review_batches130_131.tsv",
    RELAY / "module21a_pair_relay_review_batches132_133.tsv",
]
PROMOTION_GLOB = "module21a_relay_promotion_batch*.tsv"
AUDIT = RELAY / "module21a_relay_promotion_batch088.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch088_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-3130", "M20A-EXT-2145", "M21A-REUSE-1625"),
    ("M21A-PAIR-EVID-3131", "M20A-EXT-2146", "M21A-REUSE-1626"),
    ("M21A-PAIR-EVID-3132", "M20A-EXT-2148", "M21A-REUSE-1627"),
    ("M21A-PAIR-EVID-3147", "M20A-EXT-2168", "M21A-REUSE-1629"),
    ("M21A-PAIR-EVID-3149", "M20A-EXT-2170", "M21A-REUSE-1630"),
    ("M21A-PAIR-EVID-3150", "M20A-EXT-2171", "M21A-REUSE-1631"),
]

PROMOTION_NOTE = (
    "Module 21A qualified-relay promotion batch088 (2026-09-02): exact pair-associated "
    "receptor-proximal relay is raised to high at the validated layer. IL15RA/AXL, "
    "IL16/CD4/CCR5 or CD9 co-receptor, IL1B/IL-1R/SIGIRR inhibitory-complex, and "
    "processed-IL-38/IL1RL2/IL1RAP or IL1RAPL1 topology, ligand/source form, "
    "species/model, assay, antagonist or cofactor, pathway, and no-terminal-TF/SCI "
    "boundaries remain explicit; no unsupported autonomous receptor or universal "
    "ligand-binding claim is made."
)
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                ...
                "co-receptor, complex, source-form, model, and pathway boundaries remain "
                "unchanged."
            ),
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch088"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-il15-il16-il38-relay-batch088-2026-09-02",
