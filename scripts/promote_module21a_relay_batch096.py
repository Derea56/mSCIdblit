#!/usr/bin/env python3
"""Promote six validated Module 21A PTH/PTN/PTPN6/peptidase rows."""
...
AUDIT = RELAY / "module21a_relay_promotion_batch096.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch096_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-3662", "M20A-EXT-2850", "M21A-REUSE-1800"),
    ("M21A-PAIR-EVID-3690", "M20A-EXT-2887", ""),
    ("M21A-PAIR-EVID-3696", "M20A-EXT-2894", "M21A-REUSE-1801"),
    ("M21A-PAIR-EVID-3698", "M20A-EXT-2896", "M21A-REUSE-1802"),
    ("M21A-PAIR-EVID-3699", "M20A-EXT-2897", "M21A-REUSE-1803"),
    ("M21A-PAIR-EVID-3703", "M20A-EXT-2901", ""),
]

PROMOTION_NOTE = (
    "Module 21A qualified-relay promotion batch096 (2026-09-02): exact pair-associated "
    "receptor-complex binding, receptor-proximal regulator relay, peptidase processing, "
    "or bounded downstream function is raised to high at the validated layer. PTH/ADRB2 "
    "cross-talk, PTN/NCL and PTN/SDC3 association, CD300LF/CLEC12A ITIM-to-PTPN6/SHP-1 "
    "regulator edges, FAP/PYY processing, direction, receptor-complex, co-receptor, "
    "substrate, isoform, species/model, assay, pathway, and no-direct-binding boundaries "
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact receptor-complex binding, receptor-proximal regulator relay, "
                "peptidase processing, or bounded downstream function supports qualified-high "
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        if reuse_key:
            reuse[reuse_key]["validation_status"] = "promoted_high_batch096"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-pth-ptn-ptpn6-peptidase-batch096-2026-09-02",
