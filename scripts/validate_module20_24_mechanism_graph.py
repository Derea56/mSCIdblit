...
ALLOWED_ROUTE_TIERS = {
    ...
    "ligand_receptor_tf_output_missing_target_gene",
    ...
    "ligand_receptor_intracellular_tf_target_two_pair_source_overlap",
    "ligand_receptor_intracellular_tf_target_one_pair_source_overlap",
    "ligand_receptor_intracellular_tf_output_source_queue_composition",
    "ligand_receptor_intracellular_tf_output_pairwise_source_overlap",
