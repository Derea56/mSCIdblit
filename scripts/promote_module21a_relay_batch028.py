#!/usr/bin/env python3
"""Promote three bounded Module 21A GALP/GAS6 receptor packets."""
...
REVIEW_FILE = RELAY / "module21a_pair_relay_review_batches214_215.tsv"
AUDIT = RELAY / "module21a_relay_promotion_batch028.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch028_summary.json"

PACKET = {
    "M21A-PAIR-EVID-5241": {
        "pair_key": "galp galr1",
        "reuse_key": "M21A-REUSE-2443",
        "review_id": "M20A-EXT-1746",
        "citations": "PMID:10601261;PMID:15249737",
        "basis": "Exact GALP-GALR1 agonist/binding evidence with receptor-proximal Gi/o signaling supports qualified-high relay/function; central GALP phenotypes were not abolished by GALR1 knockout, so GALR1 is not treated as the sole in-vivo mediator.",
    },
    "M21A-PAIR-EVID-5242": {
        "pair_key": "galp galr2",
        "reuse_key": "M21A-REUSE-2444",
        "review_id": "M20A-EXT-1747",
        "citations": "PMID:10601261;PMID:15249737;DOI:10.1074/jbc.274.52.37041",
        "basis": "Exact GALP-GALR2 binding/agonism and [35S]GTPgammaS receptor-proximal activation support qualified-high subtype-specific relay/function; central GALP phenotypes were not abolished by GALR2 knockout, so GALR2 is not treated as the sole in-vivo mediator.",
    },
    "M21A-PAIR-EVID-5246": {
        "pair_key": "gas6 tyro3",
        "reuse_key": "M21A-REUSE-2447",
        "review_id": "M20A-EXT-1751",
        "citations": "PMID:5686386;PMCID:PMC5686386;PMID:29382817;PMID:17980494;PMCID:PMC2231337",
        "basis": "Exact GAS6-TYRO3 activation with receptor phosphorylation and Shc/B-Raf plus PLCgamma-PKCalpha neuronal signaling supports qualified-high relay/function; gamma-carboxylated GAS6, phosphatidylserine/cofactor dependence, and engineered-versus-neuronal context remain explicit.",
    },
}

PROMOTION_NOTE = "Module 21A relay/function promotion batch028 (2026-09-02): evidence tier raised to high for the exact, context-bounded packet; evidence-layer scope, upstream Module 20A LR confidence, terminal-TF status, and SCI transfer remain unchanged."
...
def main():
    ...
    for evidence_id, expected in PACKET.items():
        ...
        reuse_row["validation_status"] = "promoted_high_batch028"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-relay-function-batch028-2026-09-02",
