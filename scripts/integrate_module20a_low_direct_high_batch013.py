#!/usr/bin/env python3
"""Promote low-confidence Module 20B direct packets after exact review."""
...
A_EVIDENCE = STARTER / "module20a_low_direct_high_batch013_evidence_register.tsv"
A_DECISIONS = STARTER / "module20a_low_direct_high_batch013_decision_register.tsv"
A_SUMMARY = STARTER / "module20a_low_direct_high_batch013_summary.json"
B_AUDIT = B_DIR / "module20b_low_direct_high_batch013_2026_09_01.tsv"

EDGE_TO_PRIMARY = {
    "M20B-E004198": "M20B-EVID-004198-P2-DIRECT",
    "M20B-E004217": "M20B-EVID-004217-P2-DIRECT",
    "M20B-E004220": "M20B-EVID-004220-P2-DIRECT",
    "M20B-E004221": "M20B-EVID-004221-P2-DIRECT",
    "M20B-E004229": "M20B-EVID-004229-P2-DIRECT",
    "M20B-E004232": "M20B-EVID-004232-P2-DIRECT",
    "M20B-E004250": "M20B-EVID-004250-P2-DIRECT",
    "M20B-E004255": "M20B-EVID-004255-P2-DIRECT",
    "M20B-E004257": "M20B-EVID-004257-P2-DIRECT",
    "M20B-E004258": "M20B-EVID-004258-P2-DIRECT",
    "M20B-E004260": "M20B-EVID-004260-P2-DIRECT",
    "M20B-E004263": "M20B-EVID-004263-P2-DIRECT",
    "M20B-E004265": "M20B-EVID-004265-P2-DIRECT",
    "M20B-E004266": "M20B-EVID-004266-P2-DIRECT",
    "M20B-E004275": "M20B-EVID-004275-P2-DIRECT",
}
...
BASIS = (
    "Exact pair-specific primary direct, processing, or preserved receptor-complex "
    "evidence was adjudicated high for the tested molecular interaction. High is "
    "limited to the cited topology, ligand form, domain, species, and assay; it "
    "does not imply conventional agonism, downstream signaling, TF, or SCI relevance."
)
...
def main() -> None:
    ...
    for index, edge_id in enumerate(sorted(EDGE_TO_PRIMARY), start=1):
        ...
        q["curator_notes"] = append_once(q["curator_notes"], "Low-direct-high batch013: exact primary direct, processing, or preserved complex evidence adjudicated high for the tested topology; no unsupported agonism, relay, TF, or SCI inference added.")
        edge.update({"confidence_tier": "high", "export_priority": "high", "exportable": "true", "consolidation_note": append_once(edge["consolidation_note"], "Low-direct-high batch013: exact primary molecular evidence promoted; processing, topology, and context boundaries retained.")})
        fr.update({"confidence_tier": "high", "exportable": "true", "consolidation_note": append_once(fr["consolidation_note"], "Low-direct-high batch013: exact primary molecular evidence promoted; topology and context boundaries retained.")})
