#!/usr/bin/env python3
"""Promote eight validated Module 21A Wnt/adhesion/receptor rows."""
...
REVIEW_FILES = [
    RELAY / "module21a_pair_relay_review_batches168_169.tsv",
    RELAY / "module21a_pair_relay_review_batches170_171.tsv",
]
PROMOTION_GLOB = "module21a_relay_promotion_batch*.tsv"
AUDIT = RELAY / "module21a_relay_promotion_batch101.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch101_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-4115", "M20A-EXT-3482", "M21A-REUSE-1932"),
    ("M21A-PAIR-EVID-4117", "M20A-EXT-3487", "M21A-REUSE-1933"),
    ("M21A-PAIR-EVID-4118", "M20A-EXT-3488", "M21A-REUSE-1934"),
    ("M21A-PAIR-EVID-4129", "M20A-EXT-3499", "M21A-REUSE-1938"),
    ("M21A-PAIR-EVID-4153", "M20A-EXT-3527", "M21A-REUSE-1940"),
    ("M21A-PAIR-EVID-4156", "M20A-LIANA-REMAINING-0001", "M21A-REUSE-1942"),
    ("M21A-PAIR-EVID-4159", "M20A-LIANA-REMAINING-0004", "M21A-REUSE-1945"),
    ("M21A-PAIR-EVID-4160", "M20A-LIANA-REMAINING-0005", "M21A-REUSE-1946"),
]

PROMOTION_NOTE = (
    "Module 21A qualified-relay promotion batch101 (2026-09-02): exact pair-associated "
    "Wnt-dependent function, extracellular inhibitor association, adaptor/co-receptor "
    "function, proteolytic receptor activation, syntaxin association, adhesion, or bounded "
    "receptor-complex function is raised to high at the validated layer. WNT1/CD36, "
    "WNT3A/APCDD1 and ATP6AP2, WNT5A/FZD5-LRP5, ZP3/CHRNA7, ALCAM/NRP1, ANXA2/TLR2, "
    "and APOE/LRP1 topology, processing, complex, isoform, species/model, assay, pathway, "
    "and no-SCI boundaries remain explicit. No new terminal-TF or SCI claim is created."
)
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact pair-associated Wnt, receptor-complex, adaptor, adhesion, or bounded "
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch101"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-wnt-adhesion-receptor-complex-batch101-2026-09-02",
