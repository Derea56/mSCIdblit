#!/usr/bin/env python3
"""Add a direct, reusable RXRA-to-Ccl9 lane found in holds 0285-0292."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch055.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch055_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch055-2026-09-04"

UPDATE = {
    "holds": "M22B-HOLD-AUDIT-0289;M22B-HOLD-AUDIT-0290",
    "tf": "RXRA",
    "target": "Ccl9",
    "species": "mouse",
    "locator": "PMID:20498053; PMCID:PMC2890831; DOI:10.1073/pnas.0913545107",
    "context": "Primary mouse peritoneal macrophage and myeloid-RXRA knockout experiments showed RXRA-dependent Ccl9 expression; RXR ligand induction, Ccl9 promoter mutation, RXRA ChIP, and sequence-specific binding supported direct regulation; sepsis/inflammation comparator, non-SCI.",
    "summary": "RXRA ligand response, myeloid knockout, promoter mutation, ChIP, and sequence-specific binding support a direct RXRA-to-Ccl9 target lane in mouse macrophages.",
    "limitations": "The study concerns RXRA transcriptional signaling in mouse macrophages and sepsis/inflammation, not Ccl9-Ccr1 or Ccl9-Ccr1l1 receptor signaling and not SCI. The standalone RXRA-to-Ccl9 lane is not transferred to either receptor handoff.",
}
...
def main() -> int:
    ...
    edges.append({
        ...
        "relation_type": "RXRA regulates the Ccl9 target gene in primary-study evidence",
        "target_entity": UPDATE["target"],
        "pathway_name": "target_gene",
        "evidence_layer": "ligand_receptor_or_direct_molecular",
        "source_a_edge_id": "M22B-TARGET-SEARCH-0289",
    ...
    evidence.append({
        ...
        "source_a_evidence_id": "M22B-TARGET-SEARCH-EVID-0289",
        "b_edge_ids": edge_id,
