#!/usr/bin/env python3
"""Add five neural-context RORA target lanes recovered from remaining holds."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch017.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch017_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch017-2026-09-03"
...
UPDATES = [
    (
        ...
        "human",
        "PMID:23697635",
        "Human neuronal-cell model with RORA ChIP-on-chip, independent ChIP-qPCR validation, and RORA-deficiency expression analyses; neural but non-SCI comparator.",
        "The primary study identified RORA occupancy at the A2BP1 promoter and found reduced A2BP1 expression in RORA-deficient human neuronal cells.",
        "This is a general human neuronal RORA target-gene edge and does not establish the submitted CEL or DHCR7 handoffs or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0061;M22B-HOLD-AUDIT-0062",
        "RORA",
        ...
        "PMID:23697635",
        "Human neuronal-cell model with RORA ChIP-on-chip, independent ChIP-qPCR validation, and RORA-deficiency expression analyses; neural but non-SCI comparator.",
        "The primary study identified RORA occupancy at the HSD17B10 promoter and found reduced HSD17B10 expression in RORA-deficient human neuronal cells.",
        "This is a general human neuronal RORA target-gene edge and does not establish the submitted CEL or DHCR7 handoffs or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0061;M22B-HOLD-AUDIT-0062",
        ...
        "PMID:23697635",
        "Human neuronal-cell model with RORA ChIP-on-chip, independent ChIP-qPCR validation, and RORA-deficiency expression analyses; neural but non-SCI comparator.",
        "The primary study identified RORA occupancy at the ITPR1 promoter and found reduced ITPR1 expression in RORA-deficient human neuronal cells.",
        "This is a general human neuronal RORA target-gene edge and does not establish the submitted CEL or DHCR7 handoffs or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0061;M22B-HOLD-AUDIT-0062",
        ...
        "PMID:23697635",
        "Human neuronal-cell model with RORA ChIP-on-chip, independent ChIP-qPCR validation, and RORA-deficiency expression analyses; neural but non-SCI comparator.",
        "The primary study identified RORA occupancy at the NLGN1 promoter and found reduced NLGN1 expression in RORA-deficient human neuronal cells.",
        "This is a general human neuronal RORA target-gene edge and does not establish the submitted CEL or DHCR7 handoffs or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0061;M22B-HOLD-AUDIT-0062",
        ...
        "PMID:23697635",
        "Human neuronal-cell model with RORA ChIP-on-chip, independent ChIP-qPCR validation, and RORA-deficiency expression analyses; neural but non-SCI comparator.",
        "The primary study identified RORA occupancy at the NTRK2 promoter and found reduced NTRK2 expression in RORA-deficient human neuronal cells.",
        "This is a general human neuronal RORA target-gene edge and does not establish the submitted CEL or DHCR7 handoffs or SCI specificity.",
    ),
]
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=109):
