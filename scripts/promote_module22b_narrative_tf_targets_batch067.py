#!/usr/bin/env python3
"""Add the direct mouse Hand1-to-Adgrg1 lane found in hold 0418."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch067.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch067_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch067-2026-09-04"

UPDATE = {
    "holds": "M22B-HOLD-AUDIT-0418",
    "tf": "Hand1",
    "target": "Adgrg1",
    "species": "mouse",
    "locator": "PMID:36228547; DOI:10.1016/j.jri.2022.103753; GEO:GSE193214",
    "context": "Mouse trophoblast giant-cell studies identified Hand1 binding at the Adgrg1 promoter and showed Hand1-dependent Adgrg1 activation during trophoblast differentiation. Non-SCI placental-development comparator.",
    "summary": "Hand1 promoter binding and Hand1-dependent Adgrg1 activation support direct HAND1 activation of mouse Adgrg1.",
    "limitations": "The study concerns mouse trophoblast differentiation and does not establish COL3A1-ADGRG1 signaling to HAND1 or SCI activity.",
}
...
def main() -> int:
    ...
    edges.append({
        ...
        "source_a_edge_id": "M22B-TARGET-SEARCH-0418-01",
    ...
    evidence.append({
        ...
        "source_a_evidence_id": "M22B-TARGET-SEARCH-EVID-0418-01",
        "b_edge_ids": edge_id,
