#!/usr/bin/env python3
"""Add two primary-study FOXO1 target lanes recovered from remaining holds."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch020.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch020_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch020-2026-09-03"
...
UPDATES = [
    (
        ...
        "human",
        "PMID:15987820",
        "Primary human endometrial fibroblast/adenocarcinoma-cell model with FOXO1A promoter-element activity, IGFBP1 promoter reporter assays, and FOXO1A perturbation; non-SCI comparator.",
        "The primary study showed FOXO1A-dependent activation of the human IGFBP1 promoter and reduced IGFBP1 expression after FOXO1A silencing.",
        "This is a general human FOXO1 target-gene edge from an endometrial model and does not establish the submitted FGF15-FGFR4 handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0032",
        "FOXO1",
        ...
        "human",
        "PMID:15047604",
        "Human metabolic-cell promoter model with FOXO1A/FOXO3A insulin-response-element binding and PDK4 promoter activity assays; non-SCI comparator.",
        "The primary study identified FOXO1A/FOXO3A-binding insulin response elements in the human PDK4 promoter and showed that FOXO1 activity supports PDK4 promoter induction.",
        "This is a general human FOXO1 target-gene edge from a metabolic regulation model and does not establish the submitted FGF15-FGFR4 handoff or SCI specificity.",
    ),
]
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=115):
