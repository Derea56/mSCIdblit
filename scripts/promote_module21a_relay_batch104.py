#!/usr/bin/env python3
"""Promote a locally revalidated Module 21A Fas/FGF/GDF/integrin packet."""
...
AUDIT = RELAY / "module21a_relay_promotion_batch104.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch104_summary.json"

PACKET = [
    (4262, "M20A-LIANA-REMAINING-0111", "M21A-REUSE-2006"),
    (4268, "M20A-LIANA-REMAINING-0117", "M21A-REUSE-2008"),
    (4269, "M20A-LIANA-REMAINING-0118", "M21A-REUSE-2009"),
    (4270, "M20A-LIANA-REMAINING-0119", "M21A-REUSE-2010"),
    (4271, "M20A-LIANA-REMAINING-0120", "M21A-REUSE-2011"),
    (4272, "M20A-LIANA-REMAINING-0121", "M21A-REUSE-2012"),
    (4277, "M20A-LIANA-REMAINING-0126", "M21A-REUSE-2016"),
    (4278, "M20A-LIANA-REMAINING-0127", "M21A-REUSE-2017"),
    (4284, "M20A-LIANA-REMAINING-0133", "M21A-REUSE-2021"),
    (4285, "M20A-LIANA-REMAINING-0134", "M21A-REUSE-2022"),
    (4286, "M20A-LIANA-REMAINING-0135", "M21A-REUSE-2023"),
    (4287, "M20A-LIANA-REMAINING-0136", "M21A-REUSE-2024"),
    (4290, "M20A-LIANA-REMAINING-0139", "M21A-REUSE-2025"),
    (4292, "M20A-LIANA-REMAINING-0141", "M21A-REUSE-2027"),
    (4296, "M20A-LIANA-REMAINING-0145", "M21A-REUSE-2030"),
    (4298, "M20A-LIANA-REMAINING-0148", "M21A-REUSE-2031"),
]

PROMOTION_NOTE = (
    "Module 21A qualified-relay promotion batch104 (2026-09-02): exact pair-associated "
    "Fas death-receptor activation, FGFR ligand-receptor signaling, processed irisin/"
    "integrin function, or GDF receptor-complex relay is raised to high at the validated "
    "layer. Membrane presentation, oligomerization, heparan-sulfate, splice form, processed "
    "ligand, integrin heterodimer, receptor stoichiometry, co-ligand, species/model, assay, "
    "and no-SCI boundaries remain explicit. Existing Module 22A metadata is preserved "
    "unchanged; no new terminal-TF or SCI claim is created."
)
...
def main():
    ...
    for number, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch104"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-local-revalidated-fas-fgf-gdf-integrin-batch104-2026-09-02",
