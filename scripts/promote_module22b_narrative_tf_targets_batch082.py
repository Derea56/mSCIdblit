#!/usr/bin/env python3
"""Add a reusable FGF-responsive ELK1 target lane found while reviewing holds 0701-0708."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch082.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch082_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch082-2026-09-04"

UPDATES = [
    {
        "hold": "M22B-HOLD-AUDIT-0703", "tf": "ELK1", "target": "Ier2", "species": "rat", "relation": "regulates", "status": "reviewed_direct_target", "scope": "direct_edge",
        "locator": "PMID:9528798; PMCID:PMC121477; DOI:10.1128/MCB.18.4.2272",
        "context": "Rat hippocampal neuronal H19-7 cells treated with bFGF showed induction of the immediate-early gene pip92/Ier2; promoter deletion and heterologous reporter assays identified an Ets site, and Elk1 binding/phosphorylation and Elk1-GAL4 transactivation supported ELK1-dependent transcription. Non-SCI neuronal comparator.",
        "summary": "FGF-responsive pip92/Ier2 promoter assays, Elk1 Ets-site binding, and Elk1 transactivation support a direct rat ELK1-to-Ier2 target relationship.",
        "limitations": "The study uses bFGF/FGF2 and does not isolate FGFR1, FGFR2, or FGFR3, nor the submitted FGF1/FGF10/FGF15 ligand pairs; it does not establish SCI activity or upgrade the upstream holds.",
    },
]
...
def main() -> int:
    ...
    for index, update in enumerate(UPDATES, start=1):
        ...
        edges.append({
            ...
            "source_a_edge_id": f"M22B-TARGET-SEARCH-0703-{index:02d}", "edge_status": update["status"],
        ...
        evidence.append({
            "b_evidence_id": evidence_id, "source_a_evidence_id": f"M22B-TARGET-SEARCH-EVID-0703-{index:02d}", "b_edge_ids": edge_id, "source_kind": "reviewed_direct_target",
