#!/usr/bin/env python3
"""Promote validated receptor-complex relay rows from EVID-2011–2060."""
...
AUDIT = RELAY / "module21a_relay_promotion_batch075.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch075_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-2011", "M20A-CELLCHAT-REMAINING-1609", "M21A-REUSE-1291"),
    ("M21A-PAIR-EVID-2012", "M20A-CELLCHAT-REMAINING-1610", "M21A-REUSE-1292"),
    ("M21A-PAIR-EVID-2021", "M20A-CELLCHAT-REMAINING-1619", "M21A-REUSE-1293"),
    ("M21A-PAIR-EVID-2022", "M20A-CELLCHAT-REMAINING-1620", "M21A-REUSE-1294"),
    ("M21A-PAIR-EVID-2057", "M20A-CELLCHAT-REMAINING-1655", "M21A-REUSE-1318"),
    ("M21A-PAIR-EVID-2058", "M20A-CELLCHAT-REMAINING-1656", "M21A-REUSE-1319"),
    ("M21A-PAIR-EVID-2060", "M20A-CELLCHAT-REMAINING-1658", "M21A-REUSE-1321"),
]

PROMOTION_NOTE = (
    "Module 21A receptor-complex promotion batch075 (2026-09-02): exact ligand/receptor "
    "complex binding and qualified receptor-proximal relay/function are raised to high at "
    "the validated layer. Complex topology, processed-ligand or source-enzyme context, "
    "species, model, assay, and adaptor boundaries remain explicit; no standalone subunit, "
    "terminal-TF, or SCI claim is made."
)
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact receptor-complex interaction and qualified receptor-proximal or "
                "bounded functional relay support qualified-high promotion; recorded "
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch075"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-receptor-complex-batch075-2026-09-02",
