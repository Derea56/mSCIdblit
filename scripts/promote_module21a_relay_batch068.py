#!/usr/bin/env python3
"""Promote validated glutamate-receptor rows from the 1261–1310 audit."""
...
REVIEW_FILES = [
    RELAY / "module21a_pair_relay_review_batches056_057.tsv",
    RELAY / "module21a_pair_relay_review_batches058_059.tsv",
]
AUDIT = RELAY / "module21a_relay_promotion_batch068.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch068_summary.json"

PACKET = []
for evidence_number in [*range(1261, 1284), 1298]:
    review_number = evidence_number - 441
    reuse_number = evidence_number - 453 if evidence_number < 1298 else 843
    PACKET.append((
...
PROMOTION_NOTE = (
    "Module 21A glutamate-receptor promotion batch068 (2026-09-02): exact mature glutamate "
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch068"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-glutamate-receptor-batch068-2026-09-02",
