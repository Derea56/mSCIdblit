#!/usr/bin/env python3
"""Add CREB target lanes recovered while reviewing Module 22B holds 0013-0016."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch027.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch027_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch027-2026-09-03"

UPDATES = [
    (
        "M22B-HOLD-AUDIT-0014",
        "CREB",
        "CCNB1",
        "human",
        "PMID:22403610",
        "Primary human breast-cancer-cell and xenograft models; non-SCI comparator.",
        "In ROR1-positive human breast-cancer cells, ROR1 silencing reduced CCNB1 expression, and dominant-negative CREB reduced expression of CREB-target genes; CCNB1 was among the validated CREB-associated genes in this program.",
        "This is a standalone CREB target-gene lane from a human cancer model; it does not establish the submitted WNT5A-ROR1-to-CREB handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0014",
        "CREB",
        ...
        "PMID:22403610",
        "Primary human breast-cancer-cell and xenograft models; non-SCI comparator.",
        "In ROR1-positive human breast-cancer cells, ROR1 silencing reduced BCL2 expression, and dominant-negative CREB reduced expression of CREB-target genes; BCL2 was among the validated CREB-associated genes in this program.",
        "This is a standalone CREB target-gene lane from a human cancer model; it does not establish the submitted WNT5A-ROR1-to-CREB handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0014",
        ...
        "PMID:22403610",
        "Primary human breast-cancer-cell and xenograft models; non-SCI comparator.",
        "In ROR1-positive human breast-cancer cells, ROR1 silencing reduced CCND1 expression, and dominant-negative CREB reduced expression of CREB-target genes; CCND1 was among the validated CREB-associated genes in this program.",
        "This is a standalone CREB target-gene lane from a human cancer model; it does not establish the submitted WNT5A-ROR1-to-CREB handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0016",
        "CREB",
        "FOS",
        "rat",
        "PMID:7583020",
        "Primary rat striatal dopamine-depletion model; neural non-SCI comparator.",
        "Dopamine stimulation produced CREB phosphorylation, and CREB interacted with functional regulatory elements in the rat c-fos gene while coupling dopamine receptor signaling to gene regulation.",
        "This is a standalone CREB target-gene lane from rat striatum; it does not establish the submitted D2-like-receptor-to-CREB handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0016",
        "CREB",
        ...
        "PMID:7583020",
        "Primary rat striatal dopamine-depletion model; neural non-SCI comparator.",
        "Dopamine stimulation produced CREB phosphorylation, and CREB interacted with functional regulatory elements in the rat prodynorphin (PDYN) gene while coupling dopamine receptor signaling to gene regulation.",
        "This is a standalone CREB target-gene lane from rat striatum; it does not establish the submitted D2-like-receptor-to-CREB handoff or SCI specificity.",
    ),
]
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=127):
