#!/usr/bin/env python3
"""Promote three validated Module 21A receptor-regulator relay rows."""
...
REVIEW_FILES = [RELAY / "module21a_pair_relay_review_batches138_139.tsv"]
PROMOTION_GLOB = "module21a_relay_promotion_batch*.tsv"
AUDIT = RELAY / "module21a_relay_promotion_batch090.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch090_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-3338", "M20A-EXT-2406", "M21A-REUSE-1686"),
    ("M21A-PAIR-EVID-3346", "M20A-EXT-2416", "M21A-REUSE-1688"),
    ("M21A-PAIR-EVID-3347", "M20A-EXT-2417", "M21A-REUSE-1689"),
]

PROMOTION_NOTE = (
    "Module 21A qualified-relay promotion batch090 (2026-09-02): exact pair-associated "
    "receptor-proximal relay or bounded downstream function is raised to high at the "
    "validated layer. LRIG2/EGFR, LRRC4B/PTPRS synaptic adhesion, and LTalpha3/TNFR1 "
    "complex/RIPK1 topology, transmembrane-regulator or phosphatase-complex scope, "
    "species/model, assay, pathway, no-direct-binding where recorded, and "
    "no-terminal-TF/SCI boundaries remain explicit; no unsupported isolated-subunit or "
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact receptor-proximal relay or bounded downstream function supports "
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch090"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-regulator-adhesion-relay-batch090-2026-09-02",
