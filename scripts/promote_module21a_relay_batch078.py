#!/usr/bin/env python3
"""Promote eighteen validated Module 21A protease/cofactor relay rows."""
...
REVIEW_FILES = [
    RELAY / "module21a_pair_relay_review_batches092_093.tsv",
    RELAY / "module21a_pair_relay_review_batches094_095.tsv",
]
AUDIT = RELAY / "module21a_relay_promotion_batch078.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch078_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-2162", "M20A-EXT-0633", "M21A-REUSE-1359"),
    ("M21A-PAIR-EVID-2163", "M20A-EXT-0634", "M21A-REUSE-1360"),
    ("M21A-PAIR-EVID-2164", "M20A-EXT-0635", "M21A-REUSE-1361"),
    ("M21A-PAIR-EVID-2165", "M20A-EXT-0636", "M21A-REUSE-1362"),
    ("M21A-PAIR-EVID-2166", "M20A-EXT-0637", "M21A-REUSE-1363"),
    ("M21A-PAIR-EVID-2167", "M20A-EXT-0638", "M21A-REUSE-1364"),
    ("M21A-PAIR-EVID-2168", "M20A-EXT-0639", "M21A-REUSE-1365"),
    ("M21A-PAIR-EVID-2173", "M20A-EXT-0644", "M21A-REUSE-1370"),
    ("M21A-PAIR-EVID-2174", "M20A-EXT-0645", "M21A-REUSE-1371"),
    ("M21A-PAIR-EVID-2175", "M20A-EXT-0646", "M21A-REUSE-1372"),
    ("M21A-PAIR-EVID-2176", "M20A-EXT-0647", "M21A-REUSE-1373"),
    ("M21A-PAIR-EVID-2177", "M20A-EXT-0648", "M21A-REUSE-1374"),
    ("M21A-PAIR-EVID-2178", "M20A-EXT-0649", "M21A-REUSE-1375"),
    ("M21A-PAIR-EVID-2180", "M20A-EXT-0651", "M21A-REUSE-1376"),
    ("M21A-PAIR-EVID-2187", "M20A-EXT-0659", "M21A-REUSE-1380"),
    ("M21A-PAIR-EVID-2188", "M20A-EXT-0660", "M21A-REUSE-1381"),
    ("M21A-PAIR-EVID-2189", "M20A-EXT-0661", "M21A-REUSE-1382"),
    ("M21A-PAIR-EVID-2192", "M20A-EXT-0665", "M21A-REUSE-1384"),
]

PROMOTION_NOTE = (
    "Module 21A receptor-complex promotion batch078 (2026-09-02): exact processing, "
    "cofactor, receptor-complex, and qualified receptor-proximal relay/function are raised "
    "to high at the validated layer. Protease-versus-ligand, substrate/cofactor, complex "
    "topology, species, model, assay, and adaptor boundaries remain explicit; no standalone "
    "subunit, terminal-TF, or SCI claim is made."
)
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact processing/cofactor or receptor-complex evidence and qualified "
                "receptor-proximal relay or bounded function support qualified-high promotion; "
                "recorded topology and context boundaries remain unchanged."
            ),
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch078"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-receptor-complex-batch078-2026-09-02",
