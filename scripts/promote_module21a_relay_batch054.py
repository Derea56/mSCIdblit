#!/usr/bin/env python3
"""Promote the two bounded Module 21A WNT9 receptor-complex packets."""
...
REVIEW_FILES = [RELAY / "module21a_pair_relay_review_batches238_239.tsv"]
AUDIT = RELAY / "module21a_relay_promotion_batch054.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch054_summary.json"

PACKET = {
    "M21A-PAIR-EVID-5842": (
        "wnt9a fzd9_lrp6",
        "M21A-REUSE-2828",
        "M20A-LIANA-REMAINING-0581",
        "PMCID:PMC6559346; DOI:10.1038/s41556-019-0330-5; PMCID:PMC11103623",
        "Exact WNT9A-FZD9/Fzd9b-LRP6 cell-based and receptor-dependent relay/function supports qualified-high promotion; preserve zebrafish Fzd9b versus human FZD9, EGFR cofactor, LRP6-dependence, and no native purified ternary-binding or terminal-TF claim.",
        "reviewed_relay_candidate",
    ),
    "M21A-PAIR-EVID-5854": (
        "wnt9b fzd5_lrp6",
        "M21A-REUSE-2829",
        "M20A-LIANA-REMAINING-0593",
        "PMID:28733458; PMCID:PMC5636703; DOI:10.1096/fj.201700144R; PMID:30978219; PMCID:PMC6461349; DOI:10.1371/journal.pone.0215139; PMID:20093360; PMCID:PMC2838336; DOI:10.1074/jbc.M109.092130",
        "Exact WNT9B-FZD5-LRP6-dependent canonical function supports qualified-high promotion; preserve the single mouse nephron-progenitor-like model, RSPO1 context, LRP6 knockdown/non-rescue semantics, and absence of purified ternary binding or terminal-TF evidence.",
        "reviewed_function_only",
    ),
}
PROMOTION_NOTE = "Module 21A relay/function promotion batch054 (2026-09-02): evidence tier raised to high for the exact, context-bounded packet; evidence-layer scope, upstream Module 20A LR confidence, terminal-TF status, and SCI transfer remain unchanged."
...
def main():
    ...
    coverage = {evidence_id: next((row for row in pair_rows if row.get("module21a_evidence_ids") == evidence_id), None) for evidence_id in PACKET}
    ...
    for evidence_id, (pair_key, reuse_key, review_id, citations, _basis, review_status) in PACKET.items():
        ...
        if review is None or review.get("evidence_id") != evidence_id or review.get("pair_key") != pair_key or review.get("source_locators") != citations or review.get("confidence_tier") not in {"medium", "medium-high"} or review.get("review_status") != review_status:
    ...
    for evidence_id, packet in PACKET.items():
        ...
        reuse[packet[1]]["validation_status"] = "promoted_high_batch054"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-relay-function-batch054-2026-09-02",
