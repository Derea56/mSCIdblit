#!/usr/bin/env python3
"""Promote two validated MHC-Ib/CD8 receptor-proximal relay rows."""
...
REVIEW_FILES = [
    RELAY / "module21a_pair_relay_review_batches072_073.tsv",
    RELAY / "module21a_pair_relay_review_batches074_075.tsv",
]
AUDIT = RELAY / "module21a_relay_promotion_batch071.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch071_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-1673", "M20A-CELLCHAT-REMAINING-1232", "M21A-REUSE-1130"),
    ("M21A-PAIR-EVID-1683", "M20A-CELLCHAT-REMAINING-1242", "M21A-REUSE-1131"),
]

PROMOTION_NOTE = (
    "Module 21A MHC-Ib/CD8 promotion batch071 (2026-09-02): exact ligand binding "
    "and receptor-proximal function are raised to high at the validated complex layer. "
    "The complete receptor complex, peptide/ligand presentation, cell-state, species, "
    "and assay boundaries remain explicit; no standalone subunit, terminal-TF, or SCI "
    "claim is made."
)
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact MHC-Ib ligand/receptor-complex binding and receptor-proximal function "
                "support qualified-high promotion; complete-complex and presentation "
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch071"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-mhc1b-cd8-batch071-2026-09-02",
