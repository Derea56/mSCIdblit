#!/usr/bin/env python3
"""Promote two validated Module 21A chemokine-integrin relay rows."""
...
REVIEW_FILES = [RELAY / "module21a_pair_relay_review_batches114_115.tsv"]
PROMOTION_GLOB = "module21a_relay_promotion_batch*.tsv"
AUDIT = RELAY / "module21a_relay_promotion_batch084.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch084_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-2700", "M20A-EXT-1409", "M21A-REUSE-1484"),
    ("M21A-PAIR-EVID-2701", "M20A-EXT-1410", "M21A-REUSE-1485"),
]

PROMOTION_NOTE = (
    "Module 21A qualified-relay promotion batch084 (2026-09-02): exact CX3CL1-associated "
    "alphaVbeta3 receptor-complex binding/activation and bounded relay/function are raised "
    "to high at the validated layer. The alphaVbeta3 heterodimer and CX3CR1 ternary context, "
    "integrin-subunit boundary, species/model, assay, pathway, and no-terminal-TF/SCI limits "
    "remain explicit; no isolated ITGAV/ITGB3 or universal complex claim is made."
)
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact CX3CL1-associated alphaVbeta3 complex binding/activation and bounded "
                "receptor-proximal relay/function support qualified-high promotion; recorded "
                "heterodimer, ternary-context, and subunit boundaries remain unchanged."
            ),
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch084"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-cx3cl1-integrin-batch084-2026-09-02",
