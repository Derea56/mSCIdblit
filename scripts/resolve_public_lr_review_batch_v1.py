...
def main() -> None:
    ...
    for row in batch:
        ...
        if row.get("review_lane") == "alias_adjudication":
        ...
        elif row.get("review_batch") == "batch_138":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is already represented by graph edge(s) {matched_ids}. "
                "The public locators are pathway or database records, while the existing graph edge-source records "
                "provide primary-supported CD320-JAML binding, CD34-E-selectin glycoform rolling, CD40L binding and "
                "biased signaling through alphaIIbbeta3, alpha5beta1 or Mac-1, and E-cadherin-alphaEbeta7 adhesion "
                "at the stated molecular resolution."
            )
            limitations = (
                "Do not add a duplicate edge or collapse CD34 glycoforms, CD40L soluble/trimeric versus membrane form, "
                "integrin activation state, KGD/E162-L170 motif, alphaIIbbeta3/alpha5beta1/Mac-1 heterodimers, or "
                "E-cadherin alphaEbeta7 topology into autonomous subunit receptors. Preserve ligand processing, motif, "
                "glycoform, heterodimer and complex resolution, species and assay limits, and the distinction between "
                "binding, receptor-proximal signaling and functional output; the existing edges do not assert a "
                "universal intracellular cascade or terminal TF route."
            )
        elif row.get("review_batch") == "batch_139":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is already represented by graph edge(s) {matched_ids}. "
                "The public locators are pathway or database records, while the existing graph edge-source records "
                "provide primary-supported Factor H-L-selectin binding, CHAD-alpha2beta1 adhesion, clusterin-LRP2 "
                "transport, clusterin-TREM2 uptake, contactin-1-NF155 and CNTN2-CNTNAP2 adhesion, CLDN3-CLDN1 "
                "junctional interaction, CNTN3-APLP1 binding and evidence-bounded CLCF1-LIFR association at the "
                "stated molecular resolution."
            )
            limitations = (
                "Do not add a duplicate edge or collapse Factor H sialylation, CHAD alpha2beta1 integrin context, "
                "clusterin cargo/transport versus signaling, contactin paranodal complexes, CNTN2/CNTNAP2 cis/trans "
                "topology, claudin heteropolymer strands, or CLCF1-LIFR cytokine-receptor context into autonomous "
                "binary receptors. Preserve ligand modification, cargo, isoform, heterodimer and adhesion-complex "
                "resolution, species and assay limits, and the distinction between binding, receptor-proximal signaling "
                "and functional output; the frozen CHAD-alpha2 and CLCF1-LIFR records remain evidence-bounded where "
                "no stable primary locator is present, and the existing edges do not assert a universal intracellular "
                "cascade or terminal TF route."
            )
        elif row.get("review_batch") == "batch_140":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is already represented by graph edge(s) {matched_ids}. "
                "The public locators are pathway or database records, while the existing graph edge-source records "
                "provide primary-supported CNTN3/4-APP binding, CNTN5-PTPRG binding, collagen XIII-alpha11beta1 "
                "binding, collagen XI-alpha2beta1 matrix interaction and evidence-bounded collagen X-alpha2/1beta1 "
                "records at the stated molecular resolution."
            )
            limitations = (
                "Do not add a duplicate edge or collapse contactin/APP ectodomain interfaces, PTPRG paranodal "
                "complexes, collagen XIII transmembrane and alpha11beta1 topology, or matrix-composition-dependent "
                "collagen X/XI integrin interactions into autonomous subunit receptors. Preserve collagen processing, "
                "matrix, ectodomain, heterodimer and complex resolution, species and assay limits, and the distinction "
                "between binding, receptor-proximal signaling and functional output; frozen collagen X/XI records "
        ...
        elif row.get("review_batch") == "batch_142":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is already represented by graph edge(s) {matched_ids}. "
                "The public locators are pathway or database records, while the existing graph edge-source records "
                "provide primary-supported collagen-I GFOGER alpha1beta1/alpha2beta1 binding, collagen-I "
                "alpha11beta1 association, collagen-I native receptor-complex evidence and evidence-bounded "
                "collagen-X and collagen-XXII integrin aliases at the stated molecular resolution."
            )
            limitations = (
                "Do not add a duplicate edge or collapse fibrillar collagen-I multichain presentation, GFOGER and "
                "other collagen motifs, collagen-X/XXII chain assignments, integrin heterodimers, cation dependence, "
                "or native matrix context into autonomous subunit receptors. Preserve collagen chain, domain, motif, "
                "processing, heterodimer and matrix-complex resolution, species and assay limits, and the distinction "
                "between binding, receptor-proximal signaling and functional output; frozen collagen-X/XXII aliases "
                "remain evidence-bounded where no stable primary locator is present, and the existing edges do not "
                "assert a universal intracellular cascade or terminal TF route."
            )
        elif row.get("review_batch") == "batch_143":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is already represented by graph edge(s) {matched_ids}. "
                "The public locators are pathway or database records, while the existing graph edge-source records "
                "provide primary-supported collagen-II alpha10beta1 and alpha2beta1 binding/adhesion, collagen-III "
                "alpha2beta1 motif/adhesion evidence, and evidence-bounded collagen-II/III chain-to-integrin aliases "
                "at the stated molecular resolution."
            )
            limitations = (
                "Do not add a duplicate edge or collapse fibrillar/triple-helical collagen presentation, GROGER/GAOGER "
                "or other collagen motifs, collagen-chain versus assembled collagen specificity, integrin heterodimers, "
                "cation dependence, or chondrocyte/platelet matrix context into autonomous subunit receptors. Preserve "
                "collagen chain, domain, motif, heterodimer and matrix-complex resolution, species and assay limits, "
        ...
        elif row.get("review_batch") == "batch_145":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is already represented by graph edge(s) {matched_ids}. "
                "The public locators are pathway or database records, while the existing graph edge-source records "
                "provide primary-supported collagen-V-DDR1/DDR2 and collagen-VIII-DDR1 activation, COMP-alphaVbeta3 "
                "conformation-dependent adhesion, and evidence-bounded collagen-VI chain-to-alpha1beta1/alpha2beta1 "
                "aliases at the stated molecular resolution."
            )
            limitations = (
                "Do not add a duplicate edge or collapse fibrillar/triple-helical collagen presentation, DDR1 versus "
                "DDR2 specificity, collagen-VI native hexamer versus individual chains, COMP calcium/conformation "
                "dependence, or integrin heterodimers into autonomous subunit receptors. Preserve collagen chain, "
                "matrix, conformation, heterodimer and receptor-complex resolution, species and assay limits, and the "
                "distinction between binding, receptor-proximal signaling and functional output; frozen collagen-VI "
                "aliases remain evidence-bounded where no stable primary locator is present, and the existing edges do "
                "not assert a universal intracellular cascade or terminal TF route."
            )
        elif row.get("review_batch") == "batch_146":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is already represented by graph edge(s) {matched_ids}. "
                "The public locators are pathway or database records, while the existing graph edge-source records "
                "provide primary-supported COMP-alpha5beta1/alphaVbeta3 adhesion, GM-CSF-CSF2RA/CSF2RB receptor "
                "complex binding, CX3CL1-alpha4beta1/CX3CR1 coreceptor adhesion, CRHR2-Gs/GNAS receptor-proximal "
                "coupling and evidence-bounded CRLF1/CTF1 cytokine-receptor aliases at the stated molecular resolution."
            )
            limitations = (
                "Do not add a duplicate edge or collapse COMP calcium/conformation-dependent integrin binding, "
                "GM-CSF ligand-specific alpha/common-beta receptor architecture, CX3CL1 soluble/membrane and "
                "alpha4beta1-CX3CR1 coreceptor topology, CRHR2 ligand/G-protein coupling, or CRLF1/CTF1 cytokine "
                "receptor context into autonomous canonical receptors. Preserve ligand form, receptor-complex and "
                "co-receptor resolution, species and assay limits, and the distinction between binding, receptor-"
                "proximal signaling and functional output; the frozen CRLF1/CTF1 aliases remain evidence-bounded "
                "where no stable primary locator is present, and the existing edges do not assert a universal "
                "intracellular cascade or terminal TF route."
            )
        ...
        elif row.get("review_batch") == "batch_150":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is already represented by graph edge(s) {matched_ids}. "
                "The public locators are pathway or database records, while the existing graph edge-source records "
                "provide primary-supported FN1-DPP4 binding, FN1 integrin-complex adhesion through alpha2beta1, "
                "alpha3beta1, alpha4beta1/alpha4beta7, alpha5beta1, alpha8beta1, alphaVbeta1/alphaVbeta3/alphaVbeta6, "
                "and evidence-bounded fibronectin subunit aliases at the stated molecular resolution."
            )
            limitations = (
                "Do not add a duplicate edge or collapse fibronectin RGD/EIIIA fragments, alternative splicing, "
                "integrin heterodimers, matrix geometry, activation state, latent-TGFbeta context, or DPP4 catalytic "
                "versus noncatalytic binding into autonomous subunit receptors. Preserve ligand fragment, matrix, "
                "heterodimer and receptor-complex resolution, species and assay limits, and the distinction between "
                "binding, receptor-proximal signaling and functional output; the existing edges do not assert a "
                "universal intracellular cascade or terminal TF route."
            )
        ...
        elif row.get("review_batch") == "batch_160":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is already represented by graph edge(s) {matched_ids}. "
                "The existing edge-source records provide primary-supported IL20 and IL24 assembly/activation through "
                "IL20RA:IL20RB and IL22RA1:IL20RB complexes, IL22 assembly/activation through IL22RA1:IL10RB, IL23A "
                "binding/activation through IL12RB1:IL23R, and IL25 assembly/activation through IL17RA:IL17RB at the "
                "stated molecular resolution."
            )
            limitations = (
                "Do not add duplicate edges or collapse IL20RA:IL20RB, IL22RA1:IL20RB, IL22RA1:IL10RB, "
                "IL12RB1:IL23R, or IL17RA:IL17RB complexes into autonomous single-chain receptors. Preserve IL23A "
                "p19/p40 context, shared-subunit topology, receptor-complex assembly versus activation, species and "
                "assay limits, and the distinction between binding, receptor-proximal signaling and functional output; "
                "these edges do not assert a universal intracellular cascade or terminal TF route."
            )
        ...
        elif row.get("review_batch") == "batch_167":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is represented by graph edge(s) {matched_ids}. "
                "The existing edge-source records provide primary/comparator support for laminin-332 alpha3beta1, "
                "alpha6beta1 and alpha6beta4 adhesion, laminin-411 alpha6beta1 and alpha7beta1 adhesion, and "
                "LAMA4 G-domain alpha3beta1, alpha6beta1 and alphaVbeta3 adhesion. The remaining laminin Module 20 "
                "rows retain frozen ECM/integrin-family representation at the stated molecular resolution."
            )
            limitations = (
                "Do not add duplicate edges or collapse laminin-332/411 heterotrimers and ITGA3:ITGB1, ITGA6:ITGB1, "
                "ITGA6:ITGB4, ITGA7:ITGB1, or ITGAV:ITGB3 complexes into autonomous single-chain receptors. Preserve "
                "laminin isoform and G-domain context, ECM adhesion and hemidesmosome/vascular comparator context, "
                "distinguish primary/comparator evidence from frozen Module 20 aliases, and retain species and assay "
                "limits; these edges do not assert a universal intracellular cascade or terminal TF route."
            )
        elif row.get("review_batch") == "batch_168":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is represented by graph edge(s) {matched_ids}. "
                "The existing edge-source records provide primary/comparator support for laminin-521/511 alpha3beta1, "
                "alpha6beta1, alpha6beta4 and alpha7beta1 adhesion, and laminin-411 alpha6beta1/alpha7beta1 binding. "
                "The remaining laminin Module 20 rows retain frozen ECM/integrin-family representation at the stated "
                "molecular resolution."
            )
            limitations = (
                "Do not add duplicate edges or collapse laminin-511/521 or laminin-411 heterotrimers and ITGA3:ITGB1, "
                "ITGA6:ITGB1, ITGA6:ITGB4, or ITGA7:ITGB1 complexes into autonomous single-chain receptors. Preserve "
                "laminin isoform, splice-variant, ECM adhesion and hemidesmosome context, distinguish primary/comparator "
                "evidence from frozen Module 20 aliases, and retain species and assay limits; these edges do not assert "
                "a universal intracellular cascade or terminal TF route."
            )
        elif row.get("review_batch") == "batch_169":
            disposition = "already_present_exact_or_alias"
            layer_values = []
            species_values = []
            for edge_id in filter(None, matched_ids.split(";")):
            ...
            summary = (
                f"The public {ligand}-{receptor} row is represented by graph edge(s) {matched_ids}. "
                "The existing edge-source records provide primary/comparator support for laminin-521 "
                "alpha3beta1, alpha6beta1 and alpha6beta4 binding, laminin-221 alpha7beta1 binding, "
                "and laminin-332 alpha2beta1, alpha3beta1, alpha6beta1 and alpha6beta4 adhesion. "
                "The remaining laminin Module 20 rows retain frozen ECM/integrin-family representation "
                "at the stated molecular resolution."
            )
            limitations = (
                "Do not add duplicate edges or collapse laminin-221/332/511/521 heterotrimers and "
                "ITGA2:ITGB1, ITGA3:ITGB1, ITGA6:ITGB1, ITGA6:ITGB4, or ITGA7:ITGB1 complexes into "
                "autonomous single-chain receptors. Preserve laminin isoform, chain composition, ECM "
                "adhesion and hemidesmosome context, distinguish primary/comparator evidence from frozen "
