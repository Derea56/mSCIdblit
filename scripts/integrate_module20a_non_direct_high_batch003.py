#!/usr/bin/env python3
"""Integrate the qualified L1CAM-alpha5beta1 relay packet."""
...
EDGE = "M20B-E004095"
PRIMARY = "M20B-EVID-004095-P2-RELAY"
BATCH = "M20A-NONDIRECTHIGH003"
A_EVIDENCE = STARTER / "module20a_non_direct_high_batch003_evidence_register.tsv"
A_DECISIONS = STARTER / "module20a_non_direct_high_batch003_decision_register.tsv"
A_SUMMARY = STARTER / "module20a_non_direct_high_batch003_summary.json"
B_AUDIT = B_DIR / "module20b_non_direct_high_batch003_2026_09_01.tsv"
...
BASIS = "Exact pair-specific primary alpha5beta1-associated receptor-proximal relay evidence was adjudicated high for the preserved non-direct L1CAM-alpha5beta1 complex layer. High does not establish isolated binary binding, a ligand-to-kinase interaction, SCI relevance, or terminal TF occupancy; integrin-complex and model limits remain explicit."
...
def main() -> None:
    ...
    if queue[aid]["confidence_decision"] != "medium" or edge["confidence_tier"] != "medium" or frozen[EDGE]["confidence_tier"] != "medium":
        raise SystemExit("E004095 is not in the expected medium state")
    primary = evidence[PRIMARY]
    if primary["evidence_layer"] != "receptor_proximal_relay" or primary["exportable"].casefold() != "true":
        raise SystemExit("E004095 primary record is not exportable relay evidence")
    q = queue[aid]
