#!/usr/bin/env python3
"""Stage member-resolved TCF/LEF target edges from primary promoter studies."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch009.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch009_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch009-2026-09-03"

UPDATES = [
    ("M22B-E000478;M22B-E000479;M22B-E000480", "LEF1", "SNAI1", "human", "PMID:30411085", "Human hepatocellular-carcinoma cells with LEF1 ChIP and SNAI1 promoter reporter/mutation assays; non-SCI comparator.", "Primary experiments showed LEF1 binding to the human SNAI1 promoter and specific transcriptional up-regulation of an SNAI1 promoter reporter by LEF1.", "The edge is LEF1-member specific and hepatocellular-carcinoma-context dependent; it does not establish the reviewed broad TCF/LEF-family handoff or SCI activation."),
    ("M22B-E000478;M22B-E000479;M22B-E000480", "LEF1", "SNAI2", "human", "PMID:30411085", "Human hepatocellular-carcinoma cells with LEF1 ChIP and SNAI2 promoter reporter/mutation assays; non-SCI comparator.", "Primary experiments showed LEF1 binding to the human SNAI2 promoter and specific transcriptional up-regulation of an SNAI2 promoter reporter by LEF1.", "The edge is LEF1-member specific and hepatocellular-carcinoma-context dependent; it does not establish the reviewed broad TCF/LEF-family handoff or SCI activation."),
    ("M22B-E000478;M22B-E000479;M22B-E000480", "LEF1", "TWIST1", "human", "PMID:30411085", "Human hepatocellular-carcinoma cells with LEF1 ChIP and TWIST1 promoter reporter/mutation assays; non-SCI comparator.", "Primary experiments showed LEF1 binding to the human TWIST1 promoter and specific transcriptional up-regulation of a TWIST1 promoter reporter by LEF1.", "The edge is LEF1-member specific and hepatocellular-carcinoma-context dependent; it does not establish the reviewed broad TCF/LEF-family handoff or SCI activation."),
]
...
def main() -> int:
    ...
    audit = []
    for i, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=67):
