#!/usr/bin/env python3
"""Add target lanes recovered while reviewing Module 22B holds 0053-0056."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch037.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch037_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch037-2026-09-03"
...
UPDATES = [
    (
        ...
        "TNFAIP3",
        "mouse",
        "PMID:24019758; PMCID:PMC3760798",
        "Primary mouse RelA-null fibroblast reconstitution study with TNFalpha stimulation, RelA/p65 promoter ChIP, transcriptional assays, and mutant complementation; inflammatory, non-SCI comparator.",
        "TNFalpha-stimulated mouse RelA reconstitution experiments supported RelA-dependent TNFAIP3 promoter recruitment and transcription.",
    ...
    (
        ...
        "PMID:24019758; PMCID:PMC3760798",
        "Primary mouse RelA-null fibroblast reconstitution study with TNFalpha stimulation, RelA/p65 promoter ChIP, transcriptional assays, and mutant complementation; inflammatory, non-SCI comparator.",
        "TNFalpha-stimulated mouse RelA reconstitution experiments supported RelA-dependent NFKBIA promoter recruitment and transcription.",
        "This standalone RELA target lane does not establish any of the submitted LAMA3/LAMB3-integrin, MMP9-TLR9, or PROS1-AXL-to-RELA handoffs or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0054;M22B-HOLD-AUDIT-0055;M22B-HOLD-AUDIT-0056",
        ...
        "PMID:24019758; PMCID:PMC3760798",
        "Primary mouse RelA-null fibroblast reconstitution study with TNFalpha stimulation, RelA/p65 promoter ChIP, transcriptional assays, and mutant complementation; inflammatory, non-SCI comparator.",
        "TNFalpha-stimulated mouse RelA reconstitution experiments supported RelA-dependent Ptgs2 promoter recruitment and transcription.",
        "This standalone RELA target lane does not establish any of the submitted LAMA3/LAMB3-integrin, MMP9-TLR9, or PROS1-AXL-to-RELA handoffs or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0054;M22B-HOLD-AUDIT-0055;M22B-HOLD-AUDIT-0056",
        ...
        "PMID:24019758; PMCID:PMC3760798",
        "Primary mouse RelA-null fibroblast reconstitution study with TNFalpha stimulation, RelA/p65 promoter ChIP, transcriptional assays, and mutant complementation; inflammatory, non-SCI comparator.",
        "TNFalpha-stimulated mouse RelA reconstitution experiments supported RelA-dependent Cxcl2 promoter recruitment and transcription.",
        "This standalone RELA target lane does not establish any of the submitted LAMA3/LAMB3-integrin, MMP9-TLR9, or PROS1-AXL-to-RELA handoffs or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0054;M22B-HOLD-AUDIT-0055;M22B-HOLD-AUDIT-0056",
        ...
        "PMID:24019758; PMCID:PMC3760798",
        "Primary mouse RelA-null fibroblast reconstitution study with TNFalpha stimulation, RelA/p65 promoter ChIP, transcriptional assays, and mutant complementation; inflammatory, non-SCI comparator.",
        "TNFalpha-stimulated mouse RelA reconstitution experiments supported RelA-dependent Csf2 promoter recruitment and transcription.",
        "This standalone RELA target lane does not establish any of the submitted LAMA3/LAMB3-integrin, MMP9-TLR9, or PROS1-AXL-to-RELA handoffs or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0054;M22B-HOLD-AUDIT-0055;M22B-HOLD-AUDIT-0056",
        ...
        "PMID:24019758; PMCID:PMC3760798",
        "Primary mouse RelA-null fibroblast reconstitution study with TNFalpha stimulation, RelA/p65 promoter ChIP, transcriptional assays, and mutant complementation; inflammatory, non-SCI comparator.",
        "TNFalpha-stimulated mouse RelA reconstitution experiments supported RelA-dependent Tnf promoter recruitment and transcription.",
        "This standalone RELA target lane does not establish any of the submitted LAMA3/LAMB3-integrin, MMP9-TLR9, or PROS1-AXL-to-RELA handoffs or SCI specificity.",
    ),
]
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=177):
