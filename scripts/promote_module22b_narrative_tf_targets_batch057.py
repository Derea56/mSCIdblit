#!/usr/bin/env python3
"""Add the standalone STAT3-to-Cd48 lane found while reviewing hold 0300."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch057.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch057_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch057-2026-09-04"

UPDATE = {
    "holds": "M22B-HOLD-AUDIT-0300",
    "tf": "STAT3",
    "target": "Cd48",
    "species": "mouse",
    "locator": "PMID:41482455; DOI:10.1136/gutjnl-2025-336744",
    "context": "Mouse RAW264.7 macrophage experiments showed STAT3 overexpression increased Cd48 expression and Cd48-promoter reporter activity, with STAT3 ChIP confirming direct promoter binding; hepatocellular-carcinoma macrophage comparator, non-SCI.",
    "summary": "STAT3 overexpression, Cd48 promoter-reporter activation, and ChIP support a direct STAT3-to-Cd48 target lane in mouse macrophages.",
    "limitations": "The study places STAT3 downstream of an MMP14-RAP1-YAP axis and explicitly reports that this mechanism is independent of canonical CD48-CD244 signaling. It is an HCC comparator, not an SCI experiment, and the standalone STAT3-to-Cd48 lane is not transferred to CD48-CD244A.",
}
...
def main() -> int:
    ...
    edges.append({
        ...
        "relation_type": "STAT3 regulates the Cd48 target gene in primary-study evidence",
        "target_entity": UPDATE["target"],
        "pathway_name": "target_gene",
        "evidence_layer": "ligand_receptor_or_direct_molecular",
        "source_a_edge_id": "M22B-TARGET-SEARCH-0300",
    ...
    evidence.append({
        ...
        "source_a_evidence_id": "M22B-TARGET-SEARCH-EVID-0300",
        "b_edge_ids": edge_id,
