#!/usr/bin/env python3
"""Promote three validated Module 21A bounded relay rows."""
...
AUDIT = RELAY / "module21a_relay_promotion_batch081.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch081_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-2328", "M20A-EXT-0880", "M21A-REUSE-1405"),
    ("M21A-PAIR-EVID-2344", "M20A-EXT-0899", "M21A-REUSE-1410"),
    ("M21A-PAIR-EVID-2354", "M20A-EXT-0909", "M21A-REUSE-1411"),
]

PROMOTION_NOTE = (
    "Module 21A bounded-relay promotion batch081 (2026-09-02): exact pair interaction or "
    "receptor-associated relay/function is raised to high at the validated layer. The "
    "intracellular effector, noncanonical circuit, complex/cofactor, species/model, assay, "
    "and pathway-versus-terminal-TF boundaries remain explicit; no unsupported canonical "
    "ligand/receptor, terminal-TF, or SCI claim is made."
)
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact pair interaction or receptor-associated relay/function supports "
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch081"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-bounded-relay-batch081-2026-09-02",
