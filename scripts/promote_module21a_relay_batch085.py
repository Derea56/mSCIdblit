#!/usr/bin/env python3
"""Promote eleven validated Module 21A ephrin/growth-factor relay rows."""
...
REVIEW_FILES = [
    RELAY / "module21a_pair_relay_review_batches116_117.tsv",
    RELAY / "module21a_pair_relay_review_batches118_119.tsv",
]
PROMOTION_GLOB = "module21a_relay_promotion_batch*.tsv"
AUDIT = RELAY / "module21a_relay_promotion_batch085.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch085_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-2769", "M20A-EXT-1523", "M21A-REUSE-1501"),
    ("M21A-PAIR-EVID-2778", "M20A-EXT-1538", "M21A-REUSE-1504"),
    ("M21A-PAIR-EVID-2785", "M20A-EXT-1548", "M21A-REUSE-1505"),
    ("M21A-PAIR-EVID-2787", "M20A-EXT-1550", "M21A-REUSE-1507"),
    ("M21A-PAIR-EVID-2793", "M20A-EXT-1556", "M21A-REUSE-1511"),
    ("M21A-PAIR-EVID-2796", "M20A-EXT-1559", "M21A-REUSE-1512"),
    ("M21A-PAIR-EVID-2800", "M20A-EXT-1627", "M21A-REUSE-1514"),
    ("M21A-PAIR-EVID-2801", "M20A-EXT-1628", "M21A-REUSE-1515"),
    ("M21A-PAIR-EVID-2802", "M20A-EXT-1629", "M21A-REUSE-1516"),
    ("M21A-PAIR-EVID-2804", "M20A-EXT-1631", "M21A-REUSE-1517"),
    ("M21A-PAIR-EVID-2808", "M20A-EXT-1635", "M21A-REUSE-1520"),
]

PROMOTION_NOTE = (
    "Module 21A qualified-relay promotion batch085 (2026-09-02): exact pair-associated "
    "binding, activation, receptor-proximal relay, or bounded downstream function is raised "
    "to high at the validated layer. Ephrin/growth-factor receptor topology, adaptor/scaffold "
    "and integrin-complex composition, ligand/material form, species/model, assay, pathway, "
    "and no-terminal-TF/SCI boundaries remain explicit; no unsupported isolated-subunit or "
    "universal ligand-receptor claim is made."
)
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        if (
            ...
            or not set(row.get("evidence_layer", "").split(";")) & allowed_layers
        ):
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact pair-associated binding, activation, receptor-proximal relay, or "
                "bounded downstream function supports qualified-high promotion; recorded "
                "topology and context boundaries remain unchanged."
            ),
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch085"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-ephrin-growth-factor-batch085-2026-09-02",
