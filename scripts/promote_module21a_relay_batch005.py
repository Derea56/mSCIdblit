#!/usr/bin/env python3
"""Promote a narrowly validated fifth Module 21A relay/function packet."""
...
AUDIT = RELAY / "module21a_relay_promotion_batch005.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch005_summary.json"

PACKET = {
    "M21A-PAIR-EVID-4793": {
        "pair_key": "tnfsf9 tnfrsf9", "reuse_key": "M21A-REUSE-2216", "review_id": "M20A-CELLCHAT-REMAINING-1745",
        "citations": "PMID:29720398; PMID:30232281; PMCID:PMC6237232; PMID:30524423; https://pubmed.ncbi.nlm.nih.gov/29720398/",
        "basis": "4-1BBL/TNFRSF9 structural complex evidence plus TRAF/NF-kappaB/ERK pathway and T-cell functional assays support the exact receptor-proximal relay.",
    },
    "M21A-PAIR-EVID-4794": {
        "pair_key": "vegfa flt1", "reuse_key": "M21A-REUSE-2217", "review_id": "M20A-CELLCHAT-REMAINING-1757",
        "citations": "PMID:9099677; PMID:8573716; PMID:7824266; PMCID:PMC3110033; PMID:23744993",
        "basis": "VEGF-A/FLT1 binding and receptor phosphorylation, together with endothelial migration/angiogenic function and downstream PI3K-AKT/FAK evidence, support the exact relay/function record.",
    },
    "M21A-PAIR-EVID-4797": {
        "pair_key": "vegfc flt4", "reuse_key": "M21A-REUSE-2219", "review_id": "M20A-CELLCHAT-REMAINING-1760",
        "citations": "PMID:8630024; PMCID:PMC449944; PMID:11877295",
        "basis": "Mature VEGF-C/FLT4 binding and receptor phosphorylation plus ERK/PI3K-AKT and lymphatic endothelial function support the exact relay/function record.",
    },
    "M21A-PAIR-EVID-4801": {
        "pair_key": "vegfd kdr", "reuse_key": "M21A-REUSE-2222", "review_id": "M20A-CELLCHAT-REMAINING-1764",
        "citations": "PMID:9435229; PMCID:PMC18457; PMID:19366703; DOI:10.1074/jbc.M401538200",
        "basis": "Mature VEGF-D binding and activation of KDR/VEGFR2 plus downstream endothelial signaling/function support the exact receptor-proximal relay.",
    },
}

PROMOTION_NOTE = "Module 21A relay/function promotion batch005 (2026-09-02): evidence tier raised from medium-high to high for the exact receptor-complex relay/function packet; upstream Module 20A LR confidence, terminal-TF status, and SCI transfer remain unchanged."
...
def main():
    ...
    for evidence_id, expected in PACKET.items():
        ...
        ru["validation_status"] = "promoted_relay_function_high_batch005"
