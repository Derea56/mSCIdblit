#!/usr/bin/env python3
"""Add target lanes recovered while reviewing Module 22B holds 0054-0056."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch038.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch038_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch038-2026-09-03"

UPDATES = [
    (
        "M22B-HOLD-AUDIT-0054;M22B-HOLD-AUDIT-0055;M22B-HOLD-AUDIT-0056",
        "RELA",
        "PLPP3",
        "human",
        "PMID:31362988; PMCID:PMC6755815",
        "Primary human promoter and chromatin studies in HEK293T and differentiated THP-1 cells with NF-kB component expression, RelA/RelB ChIP, LPA stimulation, and NF-kB inhibition; inflammatory/vascular comparator, non-SCI.",
        "RelA/p65 bound functional NF-kB response elements in the human PLPP3 promoter and increased PLPP3 expression in primary promoter and chromatin experiments.",
        "This standalone RELA target lane does not establish any of the submitted LAMA3/LAMB3-integrin, MMP9-TLR9, or PROS1-AXL-to-RELA handoffs or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0056",
        "RELB",
        "PLPP3",
        "human",
        "PMID:31362988; PMCID:PMC6755815",
        "Primary human promoter and chromatin studies in HEK293T and differentiated THP-1 cells with NF-kB component expression, RelA/RelB ChIP, LPA stimulation, and NF-kB inhibition; inflammatory/vascular comparator, non-SCI.",
        "RelB/p52 bound functional NF-kB response elements in the human PLPP3 promoter and increased PLPP3 expression in promoter and chromatin experiments.",
        "This standalone RELB target lane does not establish the submitted LTa1b2-LTBR-to-RELA/RELB handoff or SCI specificity; the promoter response is NF-kB-complex and LPA context dependent.",
    ),
    (
        "M22B-HOLD-AUDIT-0056",
        "RELB",
        "LTB",
        "human",
        "PMID:30037996; PMCID:PMC6094125",
        "Primary human Edar-expressing HaCaT keratinocyte study with Eda stimulation, RelB knockdown, promoter ChIP-qPCR, expression assays, and mouse skin validation; epithelial organogenesis, non-SCI comparator.",
        "Eda-activated RelB bound the human LTB promoter and was required for LTB transcription in the keratinocyte model.",
        "This standalone RELB target lane does not establish the submitted LTa1b2-LTBR-to-RELA/RELB handoff or SCI specificity; the evidence is Eda/Edar and epithelial-context dependent.",
    ),
    (
        "M22B-HOLD-AUDIT-0056",
        "RELB",
        ...
        "PMID:30037996; PMCID:PMC6094125",
        "Primary human Edar-expressing HaCaT keratinocyte study with Eda stimulation, RelB knockdown, promoter ChIP-qPCR, expression assays, and mouse skin validation; epithelial organogenesis, non-SCI comparator.",
        "Eda-activated RelB bound the human TNFRSF9 promoter and was required for TNFRSF9 transcription in the keratinocyte model.",
        "This standalone RELB target lane does not establish the submitted LTa1b2-LTBR-to-RELA/RELB handoff or SCI specificity; the evidence is Eda/Edar and epithelial-context dependent.",
    ),
]
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=183):
