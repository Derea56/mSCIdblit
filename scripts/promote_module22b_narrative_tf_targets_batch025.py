#!/usr/bin/env python3
"""Add ATF2 target lanes recovered while reviewing Module 22B holds 0007-0008."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch025.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch025_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch025-2026-09-03"

UPDATES = [
    (
        "M22B-HOLD-AUDIT-0007",
        "ATF2",
        "PLOD2",
        "human",
        "PMID:29453334",
        "Primary human colon-cancer-cell models; non-SCI comparator.",
        "Independent experiments identified PLOD2 as a non-canonical Wnt target gene, and ATF2 silencing reduced PLOD2 mRNA in the Wnt5a/b-associated program.",
        "This is a standalone ATF2 target-gene edge from human colon-cancer models; it does not establish the submitted WNT5B-FZD3-to-ATF2 handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0007",
        "ATF2",
        ...
        "PMID:29453334",
        "Primary human colon-cancer-cell models; non-SCI comparator.",
        "Independent experiments identified HADH as a non-canonical Wnt target gene, and ATF2 silencing reduced HADH mRNA in the Wnt5a/b-associated program.",
        "This is a standalone ATF2 target-gene edge from human colon-cancer models; it does not establish the submitted WNT5B-FZD3-to-ATF2 handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0007",
        ...
        "PMID:29453334",
        "Primary human colon-cancer-cell models; non-SCI comparator.",
        "Independent experiments identified LCOR as a non-canonical Wnt target gene, and ATF2 silencing reduced LCOR mRNA in the Wnt5a/b-associated program.",
        "This is a standalone ATF2 target-gene edge from human colon-cancer models; it does not establish the submitted WNT5B-FZD3-to-ATF2 handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0007",
        ...
        "PMID:29453334",
        "Primary human colon-cancer-cell models; non-SCI comparator.",
        "Independent experiments identified REEP1 as a non-canonical Wnt target gene, and ATF2 silencing reduced REEP1 mRNA in the Wnt5a/b-associated program.",
        "This is a standalone ATF2 target-gene edge from human colon-cancer models; it does not establish the submitted WNT5B-FZD3-to-ATF2 handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0008",
        "ATF2",
        "DDIT3",
        "human",
        "PMID:10982836; PMID:14630918; PMID:17267404",
        "Primary human promoter and cultured-cell experiments with mouse ATF2-deficient fibroblast validation; non-SCI comparator.",
        "Amino-acid starvation activated the human CHOP/DDIT3 promoter through an AARE bound by ATF2; ATF2 inhibition or deficiency impaired CHOP transcription, and later ChIP work confirmed phospho-ATF2 binding at the promoter.",
        "This is a standalone ATF2 target-gene edge from amino-acid-response models; it does not establish the submitted CGA-TSHB-TSHR-to-ATF2 handoff or SCI specificity.",
    ),
]
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=120):
