#!/usr/bin/env python3
"""Add target lanes recovered while reviewing Module 22B holds 0125 through 0132."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch047.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch047_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch047-2026-09-03"

UPDATES = [
    {
        "holds": "M22B-HOLD-AUDIT-0132",
        "tf": "SMAD2;SMAD3",
        "target": "FSTL3",
        "species": "human",
        "locator": "PMID:36440002; PMCID:PMC9685658; DOI:10.3389/fcvm.2022.1038114",
        "status": "reviewed_regulatory_support",
        "confidence": "medium-high",
        "context": "Human hiPSC-derived cardiomyocyte experiments with Activin A stimulation, anti-Activin A blockade, phospho-SMAD2/3 measurements, and RNA-seq expression analysis; cardiac-disease comparator, non-SCI.",
        "summary": "Activin A increased SMAD2/3 phosphorylation in human hiPSC-derived cardiomyocytes and induced the reported downstream SMAD2/3-responsive gene FSTL3, with the acute response blocked by Activin A neutralization, supporting a SMAD2/3-linked FSTL3 regulatory lane.",
        "limitations": "This is regulatory support rather than direct SMAD occupancy at FSTL3. It does not establish the submitted Activin A-ACVR1C/ACVR2A or ACVR1C/ACVR2B handoff in SCI; receptor usage and cardiomyocyte context are not a traumatic-SCI receiver model.",
    },
    {
        "holds": "M22B-HOLD-AUDIT-0132",
        "tf": "SMAD2;SMAD3",
        ...
        "confidence": "medium-high",
        "context": "Human hiPSC-derived cardiomyocyte experiments with Activin A stimulation, anti-Activin A blockade, phospho-SMAD2/3 measurements, and RNA-seq expression analysis; cardiac-disease comparator, non-SCI.",
        "summary": "Activin A increased SMAD2/3 phosphorylation in human hiPSC-derived cardiomyocytes and increased the reported downstream SMAD2/3-responsive gene SERPINE1 during chronic exposure, supporting a SMAD2/3-linked SERPINE1 regulatory lane.",
        "limitations": "This is regulatory support rather than direct SMAD occupancy at SERPINE1, and SERPINE1 is also represented by a separate SMAD3 direct-target lane. It does not establish the submitted Activin A receptor composite in SCI.",
    },
]
...
def main() -> int:
    ...
    audit = []
    for index, update in enumerate(UPDATES, start=219):
