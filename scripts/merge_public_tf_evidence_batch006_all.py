#!/usr/bin/env python3
"""Merge the bounded Batch 006 evidence lanes into one audit register."""
...
def main() -> int:
    ...
    pair_paths = [
        input_dir / "public_tf_evidence_review_batch006_ranks0105_pairs.tsv",
        input_dir / "public_tf_evidence_review_batch006_ranks0625_pairs.tsv",
    ]
    register_paths = [
        input_dir / "public_tf_evidence_review_batch006_ranks0105_regulator_register.tsv",
        input_dir / "public_tf_evidence_review_batch006_ranks0625_regulator_register.tsv",
    ]
    ...
    pair_path = input_dir / "public_tf_evidence_review_batch006_pairs.tsv"
    register_path = input_dir / "public_tf_evidence_review_batch006_regulator_register.tsv"
    summary_path = input_dir / "batch_006_evidence_review_summary.json"
    report_path = input_dir / "EVIDENCE_REVIEW_BATCH006.md"
    ...
    summary = {
        "status": "staging_only", "batch_id": "public_tf_evidence_batch_006",
    ...
    report_path.write_text(
        "# Evidence review: public TF batch 006\n\n"
