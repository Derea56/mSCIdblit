#!/usr/bin/env python3
"""Add target lanes recovered while reviewing Module 22B holds 0109 through 0116."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch046.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch046_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch046-2026-09-03"

UPDATES = [
    {
        "holds": "M22B-HOLD-AUDIT-0109",
        "tf": "PGR",
        "target": "Fkbp5",
        "species": "mouse",
        "locator": "PMID:19036901; PMCID:PMC2646598",
        "status": "reviewed_direct_target",
        "confidence": "high",
        "context": "Mouse mammary adenocarcinoma-derived 3017.1 cells expressing PR, with progestin stimulation, Fkbp5 induction, PR ChIP scanning, cycloheximide testing, and intronic PRE/GATA-site reporter mutagenesis; mammary-cancer comparator, non-SCI.",
        "summary": "Progestin rapidly induced mouse Fkbp5 independently of new protein synthesis, PR occupied promoter and first-intron regulatory regions, and mutation of the intronic PRE/GATA element disrupted response, supporting Fkbp5 as a direct PGR target.",
        "limitations": "This standalone mouse PGR target lane does not establish the submitted 5alphaP-DHRS9-to-Pgr handoff in SCI; the study used synthetic progestin and a mammary-cancer cell model, and receptor-specific upstream activation remains unresolved.",
    },
    {
        "holds": "M22B-HOLD-AUDIT-0109",
        "tf": "PGR",
        ...
        "status": "reviewed_direct_target",
        "confidence": "high",
        "context": "Human FKBP5 intronic regulatory-region assays in HeLa and T47D cells, with progestin-dependent PR association, reporter activation, and RNA polymerase II recruitment; breast-cancer comparator, non-SCI.",
        "summary": "The human FKBP5 intronic region conferred progestin responsiveness, PR associated with the intronic PRE region after progestin treatment, and RNA polymerase II recruitment increased at the transcription start site, supporting FKBP5 as a direct PGR target.",
        "limitations": "This standalone human PGR target lane does not establish the submitted 5alphaP-DHRS9-to-Pgr handoff in SCI; the experiments used synthetic progestin and transformed cell models, and receptor-specific upstream activation remains unresolved.",
    },
]
...
def main() -> int:
    ...
    audit = []
    for index, update in enumerate(UPDATES, start=217):
