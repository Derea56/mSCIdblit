#!/usr/bin/env python3
"""Integrate the sixth bounded medium-to-high Module 20A LR packet."""
...
A_EVIDENCE = STARTER / "module20a_medium_direct_high_batch006_evidence_register.tsv"
A_DECISIONS = STARTER / "module20a_medium_direct_high_batch006_decision_register.tsv"
A_SUMMARY = STARTER / "module20a_medium_direct_high_batch006_summary.json"
B_AUDIT = B_DIR / "module20b_medium_direct_high_batch006_2026_09_01.tsv"

SELECTED = {
    "M20A-EXT-2952", "M20A-EXT-3117", "M20A-EXT-3118", "M20A-EXT-3164",
    "M20A-EXT-3165", "M20A-EXT-3189", "M20A-EXT-3190",
}
...
BASIS = (
    ...
    "tier in Module 20B. High applies only to the tested molecular interaction; "
    "noncanonical receptor/effector role, membrane-complex topology, ligand form, "
    "species, assay, and non-SCI limitations remain explicit. No canonical-receptor, "
...
def main() -> None:
    ...
    for index, aid in enumerate(sorted(SELECTED), start=1):
        ...
        evidence_id = f"M20A-MEDHIGH006-EVID-{index:04d}"
        ...
        q["curator_notes"] = append_once(q["curator_notes"], "Medium-direct-high batch006: exact primary direct evidence adjudicated high for the tested molecular interaction only; noncanonical role and downstream/SCI boundaries preserved.")
        edge.update({"confidence_tier": "high", "export_priority": "high", "exportable": "true", "consolidation_note": append_once(edge["consolidation_note"], "Medium-direct-high batch006: exact primary molecular interaction promoted; noncanonical role and context boundaries retained.")})
        frozen_row.update({"confidence_tier": "high", "exportable": "true", "consolidation_note": append_once(frozen_row["consolidation_note"], "Medium-direct-high batch006: exact primary molecular interaction promoted; noncanonical role and context boundaries retained.")})
    ...
    summary = {
        ...
        "batch_id": "module20a_medium_direct_high_batch006",
