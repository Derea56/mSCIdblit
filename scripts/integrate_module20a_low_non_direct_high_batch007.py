#!/usr/bin/env python3
"""Promote the final reviewed low-confidence non-direct Module 20B packets."""
...
A_EVIDENCE = STARTER / "module20a_low_non_direct_high_batch007_evidence_register.tsv"
A_DECISIONS = STARTER / "module20a_low_non_direct_high_batch007_decision_register.tsv"
A_SUMMARY = STARTER / "module20a_low_non_direct_high_batch007_summary.json"
B_AUDIT = B_DIR / "module20b_low_non_direct_high_batch007_2026_09_01.tsv"
B_EVIDENCE = B_DIR / "module20b_evidence_register.tsv"

EDGE_TO_PRIMARY = {
    "M20B-E004276": "M20B-EVID-004276-P2-FUNC",
    "M20B-E004300": "M20B-EVID-004300-P2-RELAY",
    "M20B-E004346": "M20B-EVID-004346-P2-RELAY",
    "M20B-E004347": "M20B-EVID-004347-P2-FUNC",
    "M20B-E004348": "M20B-EVID-004348-P2-RELAY",
}
...
BASIS = (
    "Exact pair-specific primary relay or functional evidence was adjudicated high "
    "at the preserved non-direct layer. High applies only to the cited relay/function, "
    "ligand form, receptor complex, species, and model; it does not establish isolated "
    "binary binding, a terminal TF, SCI relevance, or an outcome beyond the record."
)
...
def main() -> None:
    ...
    for index, edge_id in enumerate(sorted(EDGE_TO_PRIMARY), start=1):
        ...
        fr = frozen[edge_id]
        new_id = f"M20A-LOWNONDIRECTHIGH007-EVID-{index:04d}"
        ...
        q["curator_notes"] = append_once(q["curator_notes"], "Low-non-direct-high batch007: exact primary relay/function evidence adjudicated high for the preserved non-direct layer; no binary binding, TF, downstream, or SCI inference added.")
        edge.update({"confidence_tier": "high", "export_priority": "high", "exportable": "true", "consolidation_note": append_once(edge["consolidation_note"], "Low-non-direct-high batch007: exact primary relay/function evidence promoted at the non-direct layer; directness and context boundaries retained.")})
