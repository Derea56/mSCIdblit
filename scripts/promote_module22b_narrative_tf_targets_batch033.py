#!/usr/bin/env python3
"""Add target lanes recovered while reviewing Module 22B holds 0037-0040."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch033.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch033_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch033-2026-09-03"
...
UPDATES = [
    (
        ...
        "human",
        "PMCID:PMC10944507",
        "Primary human hepatocellular-carcinoma study with HOXD3 perturbation, CCR6 expression assays, HOXD3 ChIP at the CCR6 promoter, and promoter reporter testing; non-SCI comparator.",
        "HOXD3 bound and activated the human CCR6 promoter in hepatocellular-carcinoma cells.",
        "This standalone HOXD3 target lane does not establish the submitted EDIL3-integrin-to-HOXD3 handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0038",
        "JUN;FOS",
        "BDNF",
        "rat",
        "PMID:26818516; PMCID:PMC6604814",
        "Primary rat cortical-neuron study with AP-1 perturbation, AP-1 promoter binding, and functional rat Bdnf promoter-I reporter analysis; neuronal, non-SCI comparator.",
        "AP-1 complexes containing Jun/Fos directly upregulated the rat Bdnf promoter-I transcript through functional AP-1 cis-elements in cortical neurons.",
        "This composite AP-1 lane records the reported Jun/Fos-family complex rather than JUN alone; it does not establish the submitted BDNF-NGFR-to-JUN handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0039",
        "JUN",
        "MMP9",
        "human",
        "PMID:15169910; PMCID:PMC419859",
        "Primary human promoter/chromatin study with endogenous c-Jun recruitment to the MMP9 promoter during mitogen-induced transcription; AP-1/NF-κB cofactor context; non-SCI comparator.",
        "c-Jun was recruited to the human MMP9 promoter during transcriptional activation of MMP9 in the endogenous promoter model.",
        "The MMP9 promoter is regulated by a dynamic AP-1/NF-κB complex and chromatin-remodeling program, so this lane records JUN promoter association in a combinatorial context; it does not establish the submitted DMP1-integrin-to-JUN handoff or SCI specificity.",
    ),
]
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=153):
