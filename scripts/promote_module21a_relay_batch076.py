#!/usr/bin/env python3
"""Promote ten validated Module 21A receptor-proximal relay rows."""
...
REVIEW_FILES = [
    RELAY / "module21a_pair_relay_review_batches088_089.tsv",
    RELAY / "module21a_pair_relay_review_batches090_091.tsv",
]
AUDIT = RELAY / "module21a_relay_promotion_batch076.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch076_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-2061", "M20A-CELLCHAT-REMAINING-1659", "M21A-REUSE-1322"),
    ("M21A-PAIR-EVID-2073", "M20A-CELLCHAT-REMAINING-1672", "M21A-REUSE-1328"),
    ("M21A-PAIR-EVID-2074", "M20A-CELLCHAT-REMAINING-1673", "M21A-REUSE-1329"),
    ("M21A-PAIR-EVID-2075", "M20A-CELLCHAT-REMAINING-1674", "M21A-REUSE-1330"),
    ("M21A-PAIR-EVID-2076", "M20A-CELLCHAT-REMAINING-1675", "M21A-REUSE-1331"),
    ("M21A-PAIR-EVID-2095", "M20A-CELLCHAT-REMAINING-1695", "M21A-REUSE-1333"),
    ("M21A-PAIR-EVID-2096", "M20A-CELLCHAT-REMAINING-1696", "M21A-REUSE-1334"),
    ("M21A-PAIR-EVID-2099", "M20A-CELLCHAT-REMAINING-1699", "M21A-REUSE-1335"),
    ("M21A-PAIR-EVID-2102", "M20A-CELLCHAT-REMAINING-1702", "M21A-REUSE-1336"),
    ("M21A-PAIR-EVID-2110", "M20A-CELLCHAT-REMAINING-1711", "M21A-REUSE-1339"),
]

PROMOTION_NOTE = (
    "Module 21A receptor-complex promotion batch076 (2026-09-02): exact ligand/receptor "
    "complex binding and qualified receptor-proximal relay/function are raised to high at "
    "the validated layer. Complex topology, processed-ligand or source-context, species, "
    "model, assay, subunit, co-receptor, and adaptor boundaries remain explicit; no "
    "standalone subunit, terminal-TF, or SCI claim is made."
)
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact receptor-complex interaction and qualified receptor-proximal relay "
                "or bounded function support qualified-high promotion; recorded topology "
                "and context boundaries remain unchanged."
            ),
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch076"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-receptor-complex-batch076-2026-09-02",
