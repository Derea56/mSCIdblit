#!/usr/bin/env python3
"""Promote validated glutamate-receptor rows from the 1411–1460 audit."""
...
REVIEW_FILES = [
    RELAY / "module21a_pair_relay_review_batches062_063.tsv",
    RELAY / "module21a_pair_relay_review_batches064_065.tsv",
]
AUDIT = RELAY / "module21a_relay_promotion_batch066.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch066_summary.json"

PACKET = []
for evidence_number in [*range(1411, 1423), 1428, *range(1431, 1434), *range(1436, 1448), 1449]:
    if evidence_number <= 1422:
        review_number, reuse_number = evidence_number - 441, evidence_number - 465
    elif evidence_number == 1428:
        review_number, reuse_number = 987, 963
    elif evidence_number <= 1433:
        review_number, reuse_number = evidence_number - 441, evidence_number - 465
    elif evidence_number <= 1447:
        review_number, reuse_number = evidence_number - 441, evidence_number - 467
    else:
        review_number, reuse_number = 1008, 982
    PACKET.append((
...
PROMOTION_NOTE = (
    "Module 21A glutamate-receptor promotion batch066 (2026-09-02): exact mature glutamate "
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch066"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-glutamate-receptor-batch066-2026-09-02",
