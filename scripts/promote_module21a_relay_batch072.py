#!/usr/bin/env python3
"""Promote validated cytokine, adhesion, and protease relay rows from 1711–1760."""
...
REVIEW_FILES = [
    RELAY / "module21a_pair_relay_review_batches074_075.tsv",
    RELAY / "module21a_pair_relay_review_batches076_077.tsv",
]
AUDIT = RELAY / "module21a_relay_promotion_batch072.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch072_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-1732", "M20A-CELLCHAT-REMAINING-1297", "M21A-REUSE-1166"),
    ("M21A-PAIR-EVID-1733", "M20A-CELLCHAT-REMAINING-1299", "M21A-REUSE-1167"),
    ("M21A-PAIR-EVID-1734", "M20A-CELLCHAT-REMAINING-1301", "M21A-REUSE-1168"),
    ("M21A-PAIR-EVID-1739", "M20A-CELLCHAT-REMAINING-1313", "M21A-REUSE-1171"),
    ("M21A-PAIR-EVID-1740", "M20A-CELLCHAT-REMAINING-1314", "M21A-REUSE-1172"),
    ("M21A-PAIR-EVID-1742", "M20A-CELLCHAT-REMAINING-1324", "M21A-REUSE-1174"),
    ("M21A-PAIR-EVID-1744", "M20A-CELLCHAT-REMAINING-1326", "M21A-REUSE-1175"),
    ("M21A-PAIR-EVID-1747", "M20A-CELLCHAT-REMAINING-1329", "M21A-REUSE-1176"),
    ("M21A-PAIR-EVID-1756", "M20A-CELLCHAT-REMAINING-1338", "M21A-REUSE-1177"),
    ("M21A-PAIR-EVID-1758", "M20A-CELLCHAT-REMAINING-1342", "M21A-REUSE-1179"),
    ("M21A-PAIR-EVID-1759", "M20A-CELLCHAT-REMAINING-1343", "M21A-REUSE-1180"),
    ("M21A-PAIR-EVID-1760", "M20A-CELLCHAT-REMAINING-1344", "M21A-REUSE-1181"),
]

PROMOTION_NOTE = (
    "Module 21A cytokine/adhesion/protease promotion batch072 (2026-09-02): exact "
    "ligand–receptor complex binding and receptor-proximal or bounded functional relay "
    "are raised to high at the validated layer. Exact complex orientation, cofactor, "
    "processed-ligand, species, model, assay, and context boundaries remain explicit; "
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact complex binding and receptor-proximal or bounded functional relay "
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch072"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-cytokine-adhesion-protease-batch072-2026-09-02",
