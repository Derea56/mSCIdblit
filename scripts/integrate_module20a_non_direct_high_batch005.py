#!/usr/bin/env python3
"""Integrate the bounded Module 20B non-direct relay/function packet."""
...
A_EVIDENCE = STARTER / "module20a_non_direct_high_batch005_evidence_register.tsv"
A_DECISIONS = STARTER / "module20a_non_direct_high_batch005_decision_register.tsv"
A_SUMMARY = STARTER / "module20a_non_direct_high_batch005_summary.json"
B_AUDIT = B_DIR / "module20b_non_direct_high_batch005_2026_09_01.tsv"
B_EVIDENCE = B_DIR / "module20b_evidence_register.tsv"

EDGE_TO_PRIMARY = {
    "M20B-E003826": "M20B-EVID-003826-P2-RELAY",
    "M20B-E003831": "M20B-EVID-003831-P2-RELAY",
    "M20B-E003874": "M20B-EVID-003874-P2-FUNC",
    "M20B-E003888": "M20B-EVID-003888-P2-FUNC",
    "M20B-E004279": "M20B-EVID-004279-P2-FUNC",
}
...
BASIS = (
    ...
    "isolated binary binding, a terminal TF, SCI relevance, or an outcome beyond the "
    "cited record; complex, ligand-form, species, assay, and model limits remain explicit."
)
...
def main() -> None:
    ...
    for index, edge_id in enumerate(sorted(EDGE_TO_PRIMARY), start=1):
        ...
        fr = frozen[edge_id]
        new_id = f"M20A-NONDIRECTHIGH005-EVID-{index:04d}"
        ...
        q["curator_notes"] = append_once(q["curator_notes"], "Non-direct-high batch005: exact primary relay/function evidence adjudicated high for the preserved non-direct layer; no binary binding, TF, downstream, or SCI inference added.")
        edge.update({"confidence_tier": "high", "export_priority": "high", "exportable": "true", "consolidation_note": append_once(edge["consolidation_note"], "Non-direct-high batch005: exact primary relay/function evidence promoted at the non-direct layer; directness and context boundaries retained.")})
