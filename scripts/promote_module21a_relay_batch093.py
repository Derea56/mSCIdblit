#!/usr/bin/env python3
"""Promote thirteen validated Module 21A PCSK9/PDGF/opioid/PF4 rows."""
...
AUDIT = RELAY / "module21a_relay_promotion_batch093.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch093_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-3515", "M20A-EXT-2679", ""),
    ("M21A-PAIR-EVID-3516", "M20A-EXT-2681", ""),
    ("M21A-PAIR-EVID-3517", "M20A-EXT-2682", ""),
    ("M21A-PAIR-EVID-3520", "M20A-EXT-2686", ""),
    ("M21A-PAIR-EVID-3522", "M20A-EXT-2688", "M21A-REUSE-1751"),
    ("M21A-PAIR-EVID-3530", "M20A-EXT-2696", "M21A-REUSE-1755"),
    ("M21A-PAIR-EVID-3535", "M20A-EXT-2702", "M21A-REUSE-1757"),
    ("M21A-PAIR-EVID-3537", "M20A-EXT-2704", "M21A-REUSE-1759"),
    ("M21A-PAIR-EVID-3538", "M20A-EXT-2705", "M21A-REUSE-1760"),
    ("M21A-PAIR-EVID-3544", "M20A-EXT-2711", "M21A-REUSE-1762"),
    ("M21A-PAIR-EVID-3545", "M20A-EXT-2712", "M21A-REUSE-1763"),
    ("M21A-PAIR-EVID-3547", "M20A-EXT-2714", "M21A-REUSE-1764"),
    ("M21A-PAIR-EVID-3552", "M20A-EXT-2719", "M21A-REUSE-1765"),
]

PROMOTION_NOTE = (
    "Module 21A qualified-relay promotion batch093 (2026-09-02): exact pair-associated "
    "receptor-complex binding, receptor-proximal relay, or bounded downstream function is "
    "raised to high at the validated layer. PCSK9 cargo/trafficking, PD-L2/RGMB, PDGF and "
    "integrin cooperation, processed PDGF-DD receptor-complex signaling, processed dynorphin "
    "or enkephalin opioid-receptor activity, PF4/LRP1 dependence, precursor-versus-processed "
    "ligand, complex, isoform, species/model, assay, pathway, and no-direct-binding boundaries "
    "where recorded remain explicit. Existing Module 22A terminal-TF metadata is preserved "
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        if reuse_key:
            reuse[reuse_key]["validation_status"] = "promoted_high_batch093"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-pcsk9-pdgf-opioid-pf4-batch093-2026-09-02",
