#!/usr/bin/env python3
"""Stage two additional primary-study TF-target edges from 22B leads.

These are general regulatory edges and do not upgrade the upstream signaling
handoffs that led to the target search.
"""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch002.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch002_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch002-2026-09-03"

UPDATES = [
    {
        "hold_edges": "M22B-E002437",
        "tf": "STAT5", "target": "CISH", "species": "human",
        "locator": "PMID:9129017; PMID:9742102",
        "context": "Human hematopoietic and heterologous cell promoter systems; non-SCI comparator evidence.",
        "summary": (
            "Primary promoter studies identified STAT5 binding sites in the human CISH promoter; STAT5 expression with the EPO receptor conferred EPO-dependent CISH promoter activation, and STAT5-containing complexes bound the promoter."
        ),
        "limitations": "CISH activation is cytokine/receptor-context dependent and STAT5A/STAT5B behavior differs; this does not establish the exact IL15 receptor handoff or SCI activation.",
    },
    {
        "hold_edges": "M22B-E000824",
        "tf": "ELK1", "target": "FOS", "species": "human",
        "locator": "PMID:18374651; PMCID:PMC3574235",
        "context": "Human HeLa-cell MAPK-stimulation and endogenous promoter ChIP experiments; non-SCI comparator evidence.",
        "summary": (
            "Primary ChIP and perturbation experiments showed MAPK-activated ELK1 at the endogenous c-FOS promoter; ELK1/p300-dependent chromatin remodeling and NFI recruitment were required for promoter activation."
        ),
        "limitations": "The promoter response is cooperative with p300, NFI, and SRF and depends on MAPK stimulation; this does not resolve the EREG-EGFR/ERBB4 handoff or SCI activation.",
    },
]
...
def main() -> int:
    ...
    for index, update in enumerate(UPDATES, start=9):
        ...
        evidence.append({
            ...
            "confidence_tier": "high",
            "citation_note": f"Primary-study target-gene evidence identified while reviewing hold row {update['hold_edges']}; standalone general TF-regulon claim.",
