#!/usr/bin/env python3
"""Add a direct mineralocorticoid-receptor target lane recovered from a hold."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch024.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch024_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch024-2026-09-03"
...
UPDATES = [
    (
        ...
        "Scnn1a",
        "mouse",
        "PMID:24026182; PMID:17332896",
        "Primary mouse collecting-duct/IMCD3 and kidney model with mineralocorticoid-receptor/aldosterone regulation of alpha-ENaC transcription; renal non-SCI comparator.",
        "Primary studies showed that aldosterone-activated MR regulates alpha-ENaC (Scnn1a) transcription in collecting-duct cells and mouse kidney through the Scnn1a promoter regulatory system.",
        "This is a general mouse NR3C2 target-gene edge from renal epithelial models; it does not establish the submitted NR3C2-to-CYP11B1 edge or SCI specificity.",
    ),
]
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=119):
