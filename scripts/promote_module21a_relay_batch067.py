#!/usr/bin/env python3
"""Promote validated glutamate-receptor rows from the 1461–1510 audit."""
...
AUDIT = RELAY / "module21a_relay_promotion_batch067.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch067_summary.json"

PACKET = []
for evidence_number in [*range(1461, 1484), *range(1486, 1509)]:
    review_number = evidence_number - 441
    reuse_number = evidence_number - (469 if evidence_number < 1486 else 471)
    PACKET.append((
...
PROMOTION_NOTE = (
    "Module 21A glutamate-receptor promotion batch067 (2026-09-02): exact mature glutamate "
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch067"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-glutamate-receptor-batch067-2026-09-02",
