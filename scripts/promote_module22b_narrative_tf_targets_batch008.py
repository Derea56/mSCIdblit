#!/usr/bin/env python3
"""Stage cooperative retinoid-receptor target edges from primary studies."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch008.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch008_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch008-2026-09-03"

UPDATES = [
    ("M22B-E000305;M22B-E000306", "RARG;RXRA", "ABCA1", "human", "PMID:14560020", "Human ABCA1 promoter cotransfection and macrophage ChIP experiments with RARgamma/RXR under retinoid stimulation; non-SCI comparator.", "Primary promoter and ChIP experiments showed RARgamma/RXR activation and occupancy at the human ABCA1 promoter in response to retinoid ligand.", "The edge is a cooperative RARgamma/RXR complex and is retinoid/macrophage-context dependent; the reviewed CRABP2-RARG/RXRG handoff and SCI activation are not established."),
    ("M22B-E000301", "RARA;RXRA", "POU5F1", "mouse", "PMID:7823919", "Mouse P19 embryonal-carcinoma cells with ligand-dependent RARalpha/RXRalpha binding and activation of the Oct-3/4/POU5F1 promoter; non-SCI comparator.", "Primary promoter-binding and reporter experiments showed the RARalpha/RXRalpha heterodimer binds and activates the mouse POU5F1 promoter through its retinoic-acid response element.", "The edge is a cooperative RARalpha/RXRalpha complex and embryonal-retinoid-context dependent; the reviewed CRABP2-RARA/RXRA handoff and SCI activation are not established."),
    ("M22B-E000302;M22B-E000303", "RARB;RXRA", "POU5F1", "mouse", "PMID:7823919", "Mouse P19 embryonal-carcinoma cells with ligand-dependent RARbeta/RXRalpha binding and activation of the Oct-3/4/POU5F1 promoter; non-SCI comparator.", "Primary promoter-binding and reporter experiments showed the RARbeta/RXRalpha heterodimer binds and activates the mouse POU5F1 promoter through its retinoic-acid response element.", "The edge is a cooperative RARbeta/RXRalpha complex and embryonal-retinoid-context dependent; the reviewed CRABP2-RARB handoff and SCI activation are not established."),
    ("M22B-E000303", "RARB;RXRB", "POU5F1", "mouse", "PMID:7823919", "Mouse P19 embryonal-carcinoma cells with ligand-dependent RARbeta/RXRbeta binding and activation of the Oct-3/4/POU5F1 promoter; non-SCI comparator.", "Primary promoter-binding and reporter experiments showed the RARbeta/RXRbeta heterodimer binds and activates the mouse POU5F1 promoter through its retinoic-acid response element.", "The edge is a cooperative RARbeta/RXRbeta complex and embryonal-retinoid-context dependent; the reviewed CRABP2-RARB/RXRB handoff and SCI activation are not established."),
]
...
def main() -> int:
    ...
    audit = []
    for i, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=63):
