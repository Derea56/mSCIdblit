#!/usr/bin/env python3
"""Add a direct RELA target lane recovered from remaining holds."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch022.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch022_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch022-2026-09-03"
...
UPDATES = [
    (
        ...
        "human",
        "PMID:22249179",
        "Human HepG2 cells stimulated with TNF-alpha, with RelA/p65 promoter occupancy and NF-kB transcriptional activation assays at the IL8 locus; non-SCI comparator.",
        "The primary study detected RelA/p65 recruitment at the IL8 promoter and analyzed RelA-dependent NF-kB transcriptional activation in the stimulated cells.",
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=117):
