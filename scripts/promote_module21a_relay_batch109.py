#!/usr/bin/env python3
"""Promote the conservative exact-pair subset from Module 21A lanes 4611-4710."""
...
REVIEW_FILES = [
    RELAY / "module21a_pair_relay_review_batches190_191.tsv",
    RELAY / "module21a_pair_relay_review_batches192_193.tsv",
]
PROMOTION_GLOB = "module21a_relay_promotion_batch*.tsv"
AUDIT = RELAY / "module21a_relay_promotion_batch109.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch109_summary.json"

PACKET = [
    (4630, "M20A-EXT-3211", "M21A-REUSE-2120"),
    (4631, "M20A-EXT-3212", "M21A-REUSE-2121"),
    (4652, "M20A-EXT-3233", ""),
    (4663, "M20A-EXT-3244", "M21A-REUSE-2139"),
    (4669, "M20A-EXT-3250", "M21A-REUSE-2144"),
    (4670, "M20A-EXT-3251", "M21A-REUSE-2145"),
    (4678, "M20A-CELLCHAT-REMAINING-0248", "M21A-REUSE-2151"),
    (4679, "M20A-CELLCHAT-REMAINING-0249", "M21A-REUSE-2152"),
    (4684, "M20A-CELLCHAT-REMAINING-0254", "M21A-REUSE-2154"),
    (4687, "M20A-CELLCHAT-REMAINING-0257", "M21A-REUSE-2155"),
    (4695, "M20A-CELLCHAT-REMAINING-0265", "M21A-REUSE-2157"),
    (4697, "M20A-CELLCHAT-REMAINING-0267", "M21A-REUSE-2158"),
    (4701, "M20A-CELLCHAT-REMAINING-0271", "M21A-REUSE-2159"),
    (4703, "M20A-CELLCHAT-REMAINING-0273", "M21A-REUSE-2160"),
    (4707, "M20A-CELLCHAT-REMAINING-0277", "M21A-REUSE-2163"),
    (4708, "M20A-CELLCHAT-REMAINING-0370", ""),
]

PROMOTION_NOTE = (
    "Module 21A qualified-relay promotion batch109 (2026-09-02): exact SST receptor, "
    "TGF-beta latent-complex/co-receptor, chemokine-GPCR, checkpoint, mucin, and adhesion "
    "evidence is raised to high only at the recorded supported layer. Ligand processing, "
    "co-receptor, glycoform, GAG, partial-agonist, isoform, heterologous-model, membrane "
    "geometry, species, assay, and no-SCI boundaries remain explicit; no terminal-TF claim "
...
def main():
    ...
    for number, review_id, reuse_key in PACKET:
        ...
        if reuse_key:
            reuse[reuse_key]["validation_status"] = "promoted_high_batch109"
    ...
    audit_fields = [
        "evidence_id", "review_id", "pair_key", "pathway_reuse_key", "previous_tier", "new_tier",
        "source_locators", "decision_basis", "upstream_lr_confidence_unchanged",
    ...
    SUMMARY.write_text(
        json.dumps(
            {
                "promotion_id": "module21a-local-register-exact-pair-batch109-2026-09-02",
