#!/usr/bin/env python3
"""Promote one validated Module 21A co-receptor facilitation row."""
...
REVIEW_FILES = [RELAY / "module21a_pair_relay_review_batches096_097.tsv"]
AUDIT = RELAY / "module21a_relay_promotion_batch079.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch079_summary.json"

PACKET = [
    ("M21A-PAIR-EVID-2248", "M20A-EXT-0750", "M21A-REUSE-1389"),
]

PROMOTION_NOTE = (
    "Module 21A co-receptor promotion batch079 (2026-09-02): exact mature-ligand "
    "co-receptor facilitation and qualified receptor-proximal relay/function are raised "
    "to high at the validated layer. The AgRP-heparan-sulfate/syndecan-3 facilitation of "
    "MC4R antagonism, species/model, assay, and no-purified-binary-interaction boundaries "
    "remain explicit; no standalone SDC3 receptor, terminal-TF, or SCI claim is made."
)
...
def main():
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        audit_rows.append({
            ...
            "decision_basis": (
                "Exact mature-ligand co-receptor facilitation and qualified receptor-proximal "
                "relay support qualified-high promotion; recorded topology and context "
    ...
    for evidence_id, review_id, reuse_key in PACKET:
        ...
        reuse[reuse_key]["validation_status"] = "promoted_high_batch079"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-co-receptor-batch079-2026-09-02",
