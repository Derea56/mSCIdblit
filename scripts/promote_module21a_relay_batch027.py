#!/usr/bin/env python3
"""Promote three bounded Module 21A galanin receptor packets."""
...
AUDIT = RELAY / "module21a_relay_promotion_batch027.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch027_summary.json"

PACKET = {
    "M21A-PAIR-EVID-5235": {
        "pair_key": "gal galr1", "reuse_key": "M21A-REUSE-2440", "review_id": "M20A-EXT-1740",
        "citations": "PMID:8750821;PMID:7524088;DOI:10.1021/bi9728405",
        "basis": "Exact galanin-GALR1 binding, Gi/o-dependent cAMP inhibition, and beta-gamma/MAPK signaling support qualified-high subtype-specific relay/function evidence; recombinant/heterologous and rat/human receptor context remains explicit.",
    },
    "M21A-PAIR-EVID-5236": {
        "pair_key": "gal galr2", "reuse_key": "M21A-REUSE-2441", "review_id": "M20A-EXT-1741",
        "citations": "PMID:9281594;PMID:9685625;PMID:10980593",
        "basis": "Exact GALR2 binding with Gq/Gi/G12-linked cAMP, calcium/PLC, Rho, and cellular outputs supports qualified-high subtype-specific relay/function evidence; coupling remains context-dependent across recombinant and cancer-cell systems.",
    },
    "M21A-PAIR-EVID-5237": {
        "pair_key": "gal galr3", "reuse_key": "M21A-REUSE-2442", "review_id": "M20A-EXT-1742",
        "citations": "PMID:9722565;PMID:9405385;DOI:10.1074/jbc.273.36.23321",
        "basis": "Exact GALR3 binding and Gi/Go-dependent GIRK1/4 activation support qualified-high receptor-proximal relay/function evidence; low-abundance and engineered heterologous context remain explicit.",
    },
}

PROMOTION_NOTE = "Module 21A relay/function promotion batch027 (2026-09-02): evidence tier raised to high for the exact, context-bounded packet; evidence-layer scope, upstream Module 20A LR confidence, terminal-TF status, and SCI transfer remain unchanged."
...
def main():
    ...
    for evidence_id, expected in PACKET.items():
        ...
        reuse_row["validation_status"] = "promoted_high_batch027"
    ...
    SUMMARY.write_text(json.dumps({
        "promotion_id": "module21a-relay-function-batch027-2026-09-02",
