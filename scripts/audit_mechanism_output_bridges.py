...
def enrich_validated_product_forms(
    ...
    cytokine_rules = (
        ...
        ("PROTEIN:NODE01886", "OUTPUT_PROTEIN:NODE01886", r"\bCXCL10\b|\bIP[- ]?10\b"),
        ("PROTEIN:NODE01889", "OUTPUT_PROTEIN:NODE01889", r"\bCXCL10\b|\bIP[- ]?10\b"),
        ("PROTEIN:NODE01893", "OUTPUT_PROTEIN:NODE01893", r"\bCXCL12\b|\bSDF[- ]?1\b"),
        ("PROTEIN:NODE01811", "OUTPUT_PROTEIN:NODE01811", r"\bCSF[- ]?2\b|\bGM[- ]?CSF\b"),
        ("PROTEIN:NODE03802", "OUTPUT_PROTEIN:NODE03802", r"\bIFN[- ]?(?:gamma|γ)\b|\bIFNG\b"),
        ("PROTEIN:NODE03919", "OUTPUT_PROTEIN:NODE03919", r"\bIL[- ]?17A\b|\bIL17A\b"),
        ("PROTEIN:NODE03977", "OUTPUT_PROTEIN:NODE03977", r"\bIL[- ]?2\b|\bIL2\b"),
        ("PROTEIN:NODE04063", "OUTPUT_PROTEIN:NODE04063", r"\bIL[- ]?9\b|\bIL9\b"),
        ("PROTEIN:NODE00767", "OUTPUT_PROTEIN:NODE00767", r"\bBDNF\b"),
        ("PROTEIN:NODE05632", "OUTPUT_PROTEIN:NODE05632", r"\bNGF\b"),
        ("PROTEIN:NODE01164", "OUTPUT_PROTEIN:NODE01164", r"\bCCL5\b|\bRANTES\b"),
        ("PROTEIN:NODE01157", "OUTPUT_PROTEIN:NODE01157", r"\bCCL3\b|\bMIP[- ]?1(?:alpha|α)\b"),
        ("PROTEIN:NODE03893", "OUTPUT_PROTEIN:NODE03893", r"\bIL12(?:A/IL12B)?\b|\bIL[- ]?12(?:p70)?\b"),
        ("PROTEIN:NODE03894", "OUTPUT_PROTEIN:NODE03894", r"\bIL12A[_/]?IL12B\b|\bIL[- ]?12(?:p70)?\b"),
        ("PROTEIN:NODE03798", "OUTPUT_PROTEIN:NODE03798", r"\bIFN[- ]?beta\b|\bIFNB1?\b"),
        ("PROTEIN:NODE03863", "OUTPUT_PROTEIN:NODE03863", r"\bIL[- ]?1(?:alpha|α|a)\b|\bIL1A\b"),
        ("PROTEIN:NODE03944", "OUTPUT_PROTEIN:NODE03944", r"\bIL[- ]?1(?:alpha|α|a)\b|\bIL1A\b"),
        ("PROTEIN:NODE01883", "OUTPUT_PROTEIN:NODE01883", r"\bCXCL1\b|\bGRO[- ]?alpha\b|\bCINC[- ]?1\b"),
        ("PROTEIN:NODE01908", "OUTPUT_PROTEIN:NODE01908", r"\bCXCL2\b|\bMIP[- ]?2\b"),
        ("PROTEIN:NODE04038", "OUTPUT_PROTEIN:NODE04038", r"\bIL[- ]?4\b|\bIL4\b"),
        ("PROTEIN:NODE04049", "OUTPUT_PROTEIN:NODE04049", r"\bIL[- ]?5\b|\bIL5\b"),
        ("PROTEIN:NODE03907", "OUTPUT_PROTEIN:NODE03907", r"\bIL[- ]?13\b|\bIL13\b"),
        ("PROTEIN:NODE08457", "OUTPUT_PROTEIN:NODE08457", r"\bVEGF(?:[- ]?A)?\b|\bVEGFA\b"),
        ("PROTEIN:NODE01923", "OUTPUT_PROTEIN:NODE01923", r"\bCXCL9\b|\bMIG\b"),
        ("PROTEIN:NODE01924", "OUTPUT_PROTEIN:NODE01924", r"\bCXCL9\b|\bMIG\b"),
        ("PROTEIN:NODE02673", "OUTPUT_PROTEIN:NODE02673", r"\bFGF[- ]?2\b|\bFGF2\b"),
        ("PROTEIN:NODE07860", "OUTPUT_PROTEIN:NODE07860", r"\bTGF[- ]?(?:beta|β|b)\b|\bTGFB1\b"),
        ("PROTEIN:NODE00176", "OUTPUT_PROTEIN:NODE00176", r"\bADAMTS[- ]?1\b|\bADAMTS1\b"),
