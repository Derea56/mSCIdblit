#!/usr/bin/env python3
"""Integrate the bounded Module 20B direct/complex packet."""
...
A_EVIDENCE = STARTER / "module20a_medium_direct_high_batch012_evidence_register.tsv"
A_DECISIONS = STARTER / "module20a_medium_direct_high_batch012_decision_register.tsv"
A_SUMMARY = STARTER / "module20a_medium_direct_high_batch012_summary.json"
B_AUDIT = B_DIR / "module20b_medium_direct_high_batch012_2026_09_01.tsv"

EDGE_TO_PRIMARY = {
    "M20B-E003898": "M20B-EVID-003898-P2-DIRECT",
    "M20B-E004605": "M20B-EVID-004605-P2-DIRECT",
    "M20B-E004608": "M20B-EVID-004608-P2-DIRECT",
    "M20B-E004641": "M20B-EVID-004641-P2-DIRECT",
    "M20B-E004801": "M20B-EVID-004801-P2-DIRECT",
    "M20B-E004849": "M20B-EVID-004849-P2-DIRECT",
    "M20B-E004854": "M20B-EVID-004854-P2-DIRECT",
    "M20B-E004910": "M20B-EVID-004910-P2-DIRECT",
    "M20B-E004913": "M20B-EVID-004913-P2-DIRECT",
    "M20B-E004915": "M20B-EVID-004915-P2-DIRECT",
    "M20B-E004919": "M20B-EVID-004919-P2-DIRECT",
    "M20B-E004954": "M20B-EVID-004954-P2-DIRECT",
}
...
BASIS = (
    "Exact pair-specific primary direct-molecular or explicitly preserved receptor-complex "
    "evidence was adjudicated high for the tested interaction. High remains limited to "
    "the cited topology, ligand form, domain, species, and assay; no universal pathway, "
    "downstream, TF, or SCI inference is made."
)
...
def main() -> None:
    ...
    for index, edge_id in enumerate(sorted(EDGE_TO_PRIMARY), start=1):
        ...
        q["curator_notes"] = append_once(q["curator_notes"], "Medium-direct-high batch012: exact primary direct or preserved complex evidence adjudicated high for the tested topology; ligand-form, domain, species, and pathway boundaries retained.")
        edge.update({"confidence_tier": "high", "export_priority": "high", "exportable": "true", "consolidation_note": append_once(edge["consolidation_note"], "Medium-direct-high batch012: exact primary molecular evidence promoted; topology and context boundaries retained.")})
        fr.update({"confidence_tier": "high", "exportable": "true", "consolidation_note": append_once(fr["consolidation_note"], "Medium-direct-high batch012: exact primary molecular evidence promoted; topology and context boundaries retained.")})
