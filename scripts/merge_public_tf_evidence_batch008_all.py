#!/usr/bin/env python3
"""Merge the bounded Batch 008 evidence lanes into one audit register."""
...
def main() -> int:
    ...
    pair_paths = [
        input_dir / "public_tf_evidence_review_batch008_ranks0105_pairs.tsv",
        input_dir / "public_tf_evidence_review_batch008_ranks0625_pairs.tsv",
    ]
    register_paths = [
        input_dir / "public_tf_evidence_review_batch008_ranks0105_regulator_register.tsv",
        input_dir / "public_tf_evidence_review_batch008_ranks0625_regulator_register.tsv",
    ]
    ...
    pair_path = input_dir / "public_tf_evidence_review_batch008_pairs.tsv"
    register_path = input_dir / "public_tf_evidence_review_batch008_regulator_register.tsv"
    summary_path = input_dir / "batch_008_evidence_review_summary.json"
    report_path = input_dir / "EVIDENCE_REVIEW_BATCH008.md"
    ...
    summary = {
        "status": "staging_only", "batch_id": "public_tf_evidence_batch_008", "source_set_ranks_reviewed": list(range(1, 26)),
    ...
    report_path.write_text(
        "# Evidence review: public TF batch 008\n\n"
