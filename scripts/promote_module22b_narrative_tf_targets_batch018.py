#!/usr/bin/env python3
"""Add four immune/neural-context TF target lanes recovered from remaining holds."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch018.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch018_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch018-2026-09-03"

UPDATES = [
    (
        "M22B-HOLD-AUDIT-0061;M22B-HOLD-AUDIT-0062;M22B-HOLD-AUDIT-0089",
        "RORA",
        "Rorc",
        "mouse",
        "PMID:36243007",
        "Mouse Th17-cell model with RORA ChIP-seq/ChIP-qPCR, cis-regulatory analysis, and EAE spinal-cord T-cell validation; immune and spinal-cord comparator, not traumatic SCI.",
        "The primary study showed RORalpha occupancy at a conserved Rorc cis-regulatory element and included RORA-dependent Th17 effector-program evidence in EAE spinal-cord T cells.",
        "This is a mouse RORA target-gene edge with EAE spinal-cord context, not traumatic SCI; it does not establish the submitted CEL or DHCR7 handoffs or upstream receptor activation.",
    ),
    (
        "M22B-HOLD-AUDIT-0089",
        "TBX21",
        "Gzmb",
        "mouse",
        "PMID:24211184",
        "Primary mouse CD8 T-cell activation model with T-bet promoter ChIP at Gzmb and Ifng loci; immune comparator.",
        "The primary study detected T-bet binding at the Gzmb promoter in activated CD8 T cells and measured Gzmb expression in the same effector-differentiation system.",
        "This is a general mouse TBX21 target-gene edge from a CD8 T-cell model; it does not resolve the submitted SEMA4A-PLXND1 handoff or establish traumatic SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0089",
        "TBX21",
        ...
        "mouse",
        "PMID:25225667",
        "Primary mouse Th1-cell model with T-bet-dependent regulation of the Ifng–Tmevpg1 locus and chromatin/occupancy analyses; immune comparator.",
        "The primary study demonstrated T-bet-dependent regulation of the Th1 genomic locus spanning Ifng through Tmevpg1 and linked this locus to effector transcriptional control.",
        "This is a general mouse TBX21 locus-regulation edge; the cited experiments emphasize T-bet-dependent locus control rather than a single isolated promoter site, and do not establish the submitted handoff or traumatic SCI specificity.",
    ),
]
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=110):
