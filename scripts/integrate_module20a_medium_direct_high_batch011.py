#!/usr/bin/env python3
"""Integrate the bounded RSPO4/renin direct-evidence packet."""
...
A_EVIDENCE = STARTER / "module20a_medium_direct_high_batch011_evidence_register.tsv"
A_DECISIONS = STARTER / "module20a_medium_direct_high_batch011_decision_register.tsv"
A_SUMMARY = STARTER / "module20a_medium_direct_high_batch011_summary.json"
B_AUDIT = B_DIR / "module20b_medium_direct_high_batch011_2026_09_01.tsv"

EDGE_TO_PRIMARY = {
    "M20B-E004690": "M20B-EVID-004690-P2-DIRECT",
    "M20B-E004750": "M20B-EVID-004750-P2-DIRECT",
    "M20B-E004751": "M20B-EVID-004751-P2-DIRECT",
    "M20B-E004752": "M20B-EVID-004752-P2-DIRECT",
}
...
BASIS = (
    "Exact pair-specific primary direct or explicitly qualified molecular evidence was "
    "adjudicated high for the tested ligand/receptor topology. High is limited to "
    "the tested ligand form, domain or receptor family assignment, species, and "
    "assay; no universal pathway, downstream, TF, or SCI inference is made."
)
...
def main() -> None:
    ...
    for index, edge_id in enumerate(sorted(EDGE_TO_PRIMARY), start=1):
        ...
        q["curator_notes"] = append_once(q["curator_notes"], "Medium-direct-high batch011: exact primary direct or qualified molecular evidence adjudicated high for the tested topology; ligand-form, domain, species, and pathway boundaries retained.")
        edge.update({"confidence_tier": "high", "export_priority": "high", "exportable": "true", "consolidation_note": append_once(edge["consolidation_note"], "Medium-direct-high batch011: exact primary molecular evidence promoted; topology and context boundaries retained.")})
        fr.update({"confidence_tier": "high", "exportable": "true", "consolidation_note": append_once(fr["consolidation_note"], "Medium-direct-high batch011: exact primary molecular evidence promoted; topology and context boundaries retained.")})
