#!/usr/bin/env python3
"""Integrate the bounded Module 20B relay/function evidence packet."""
...
A_EVIDENCE = STARTER / "module20a_non_direct_high_batch004_evidence_register.tsv"
A_DECISIONS = STARTER / "module20a_non_direct_high_batch004_decision_register.tsv"
A_SUMMARY = STARTER / "module20a_non_direct_high_batch004_summary.json"
B_AUDIT = B_DIR / "module20b_non_direct_high_batch004_2026_09_01.tsv"
B_EVIDENCE = B_DIR / "module20b_evidence_register.tsv"

EDGE_TO_PRIMARY = {
    "M20B-E004659": "M20B-EVID-004659-P2-RELAY",
    "M20B-E004756": "M20B-EVID-004756-P2-RELAY",
    "M20B-E004764": "M20B-EVID-004764-P2-RELAY",
    "M20B-E004783": "M20B-EVID-004783-P2-RELAY",
    "M20B-E004790": "M20B-EVID-004790-P2-RELAY",
    "M20B-E004794": "M20B-EVID-004794-P2-RELAY",
    "M20B-E004863": "M20B-EVID-004863-P2-RELAY",
    "M20B-E004872": "M20B-EVID-004872-P2-FUNC",
    "M20B-E004878": "M20B-EVID-004878-P2-FUNC",
    "M20B-E005135": "M20B-EVID-005135-P2-RELAY",
    "M20B-E005136": "M20B-EVID-005136-P2-FUNC",
    "M20B-E005178": "M20B-EVID-005178-P2-FUNC",
    "M20B-E005203": "M20B-EVID-005338-P2-RELAY",
    "M20B-E005277": "M20B-EVID-005342-P2-RELAY",
}
...
BASIS = (
    "Exact pair-specific primary receptor-proximal relay or functional evidence was "
    "adjudicated high at the preserved non-direct layer. High does not establish "
    "isolated binary binding, a terminal TF, SCI relevance, or any outcome beyond "
    "the cited record; complex, isoform, ligand-form, species, assay, and model "
...
def main() -> None:
    ...
    for index, edge_id in enumerate(sorted(EDGE_TO_PRIMARY), start=1):
        ...
        q["curator_notes"] = append_once(q["curator_notes"], "Non-direct-high batch004: exact primary relay/function evidence adjudicated high for the preserved non-direct layer; no binary binding, TF, downstream, or SCI inference added.")
        edge.update({"confidence_tier": "high", "export_priority": "high", "exportable": "true", "consolidation_note": append_once(edge["consolidation_note"], "Non-direct-high batch004: exact primary relay/function evidence promoted at the non-direct layer; directness and context boundaries retained.")})
