#!/usr/bin/env python3
"""Add a reusable KLF2-to-S1pr1 lane found while reviewing holds 0237-0244."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch049.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch049_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch049-2026-09-04"

UPDATE = {
    "holds": "M22B-HOLD-AUDIT-0237",
    "tf": "Klf2",
    "target": "S1pr1",
    "species": "mouse",
    "locator": "PMID:17548599; PMID:16855590; PMID:22334704; DOI:10.4049/jimmunol.178.12.7632; DOI:10.1038/nature04882; PMCID:PMC3320915",
    "context": "Mouse primary T-cell and thymocyte studies showed KLF2-dependent S1P1/S1pr1 expression and promoter activation; CCL19-CCR7 stimulation increased KLF2 before EDG1/S1PR1 expression in primary murine T lymphocytes; lymphocyte-trafficking comparator, non-SCI.",
    "summary": "KLF2 directly activated the S1P1 promoter in reporter assays, and Klf2-deficient mouse T cells/thymocytes had impaired S1P1 expression; a separate CCL19-CCR7 study linked CCL19 stimulation to increased KLF2 preceding EDG1/S1PR1 expression in primary murine T lymphocytes.",
    "limitations": "The KLF2-to-S1pr1 lane is a standalone general regulatory relationship and does not upgrade the CCL19-CCR7 handoff to a ligand-to-TF activation edge. The supporting T-cell trafficking systems are not SCI receiver-cell experiments, and the CCL19 study used pathway timing rather than KLF2 occupancy at the endogenous S1pr1 locus.",
}
...
def main() -> int:
    ...
    edges.append({
        ...
        "relation_type": "Klf2 regulates the S1pr1 target gene in primary-study evidence",
        "target_entity": UPDATE["target"],
        "pathway_name": "target_gene",
        "evidence_layer": "ligand_receptor_or_direct_molecular",
        "source_a_edge_id": "M22B-TARGET-SEARCH-0249",
    ...
    evidence.append({
        ...
        "source_a_evidence_id": "M22B-TARGET-SEARCH-EVID-0249",
        "b_edge_ids": edge_id,
        "source_kind": "reviewed_regulatory_support",
