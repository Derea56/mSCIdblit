#!/usr/bin/env python3
"""Add two species-resolved SOX2 target lanes recovered from a remaining hold."""
...
AUDIT_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch021.tsv"
SUMMARY_PATH = ROOT / "work/module22b_low_confidence_upgrade_audit/module22b_narrative_tf_targets_batch021_summary.json"
BATCH_ID = "module22b-narrative-tf-targets-batch021-2026-09-03"

UPDATES = [
    (
        "M22B-HOLD-AUDIT-0077",
        "SOX2",
        "POU5F1",
        "mouse",
        "PMID:15988017",
        "Mouse embryonic stem-cell model with SOX2/OCT4 ChIP at the Pou5f1 enhancer and SOX2 knockdown-dependent loss of Pou5f1 expression; non-SCI comparator.",
        "The primary study showed SOX2 occupancy at the mouse Pou5f1 enhancer and reduced Pou5f1 enhancer activity and endogenous expression after SOX2 knockdown.",
        "This is a general mouse SOX2 target-gene edge from a pluripotency model; it does not establish the submitted ECM1-ITGB4 handoff or SCI specificity.",
    ),
    (
        "M22B-HOLD-AUDIT-0077",
        "SOX2",
        ...
        "human",
        "PMID:15988017",
        "Human embryonic stem-cell model with SOX2/OCT4 ChIP at the POU5F1 enhancer and SOX2 knockdown-dependent loss of POU5F1 expression; non-SCI comparator.",
        "The primary study showed SOX2 occupancy at the human POU5F1 enhancer and reduced POU5F1 enhancer activity and endogenous expression after SOX2 knockdown.",
        "This is a general human SOX2 target-gene edge from a pluripotency model; it does not establish the submitted ECM1-ITGB4 handoff or SCI specificity.",
    ),
]
...
def main() -> int:
    ...
    audit = []
    for index, (holds, tf, target, species, locator, context, summary, limitations) in enumerate(UPDATES, start=116):
