...
REVIEW = RELAY / "module21a_pair_relay_review_batches200_201.tsv"
AUDIT = RELAY / "module21a_relay_promotion_batch009.tsv"
SUMMARY = RELAY / "module21a_relay_promotion_batch009_summary.json"

PACKET = {
    "M21A-PAIR-EVID-4878": {
        "pair_key": "apln aplnr", "reuse_key": "M21A-REUSE-2277", "review_id": "M20A-EXT-0808",
        "citations": "PMID:9792798; DOI:10.1006/bbrc.1998.9489; PMID:27671350; DOI:10.1016/j.bbapap.2016.09.012; PMID:28904225; PMID:32545380",
        "basis": "Endogenous apelin/APJ identity, APLNR perturbation, and ERK/Akt metabolic or angiogenic function support qualified-high relay/function evidence.",
    },
    "M21A-PAIR-EVID-4896": {
        "pair_key": "avp avpr1a", "reuse_key": "M21A-REUSE-2292", "review_id": "M20A-EXT-0892",
        "citations": "DOI:10.1152/ajpcell.00240.2001; PMID:6313159; PMID:27671350",
        "basis": "Exact AVP/V1A pharmacology with Gq/PLC/Ca2+/PKC and receptor-dependent MEK-ERK mitogenic outputs supports qualified-high relay/function evidence.",
    },
    "M21A-PAIR-EVID-4897": {
        "pair_key": "avp avpr1b", "reuse_key": "M21A-REUSE-2293", "review_id": "M20A-EXT-0893",
        "citations": "PMID:14722621; PMCID:PMC311433; DOI:10.1172/JCI19656; PMID:19047484; DOI:10.1124/mol.108.049031",
        "basis": "AVP-induced ACTH function in primary corticotrophs and Avpr1b-null mice, with receptor-coupling assays, supports qualified-high AVPR1B relay/function evidence.",
    },
    "M21A-PAIR-EVID-4900": {
        "pair_key": "bmp2 actr2", "reuse_key": "M21A-REUSE-2295", "review_id": "M20A-EXT-0936",
        "citations": "PMID:17472960",
        "basis": "BMP2/RGMa-conditioned ActRIIA receptor-complex dependence with BMP reporter and ALP outputs supports qualified-high relay/function evidence, not a standalone binary edge.",
    },
}
PROMOTION_NOTE = "Module 21A relay/function promotion batch009 (2026-09-02): evidence tier raised from medium-high to high for the exact receptor-complex relay/function packet; upstream Module 20A LR confidence, terminal-TF status, and SCI transfer remain unchanged."
...
def main():
    ...
    for e, v in PACKET.items():
        ...
        reuse[v["reuse_key"]]["validation_status"] = "promoted_relay_function_high_batch009"
