#!/usr/bin/env python3
"""Integrate the third bounded medium-to-high Module 20A LR packet.

This packet is deliberately role-aware: direct binding can be high while the
target remains an adhesion molecule, co-receptor, sorting node, proteoglycan,
or receptor-associated complex rather than a canonical signaling receptor.
"""
...
A_EVIDENCE = STARTER / "module20a_medium_direct_high_batch003_evidence_register.tsv"
A_DECISIONS = STARTER / "module20a_medium_direct_high_batch003_decision_register.tsv"
A_SUMMARY = STARTER / "module20a_medium_direct_high_batch003_summary.json"
B_AUDIT = B_DIR / "module20b_medium_direct_high_batch003_2026_09_01.tsv"

SELECTED = {
    "M20A-EXT-2537", "M20A-EXT-2538", "M20A-EXT-2539", "M20A-EXT-2541",
    "M20A-EXT-2529", "M20A-EXT-2521", "M20A-EXT-2522", "M20A-EXT-2523",
    "M20A-EXT-2515", "M20A-EXT-2498", "M20A-EXT-2493", "M20A-EXT-2494",
    "M20A-EXT-2463", "M20A-EXT-2464", "M20A-EXT-2465", "M20A-EXT-2452",
    "M20A-EXT-2449", "M20A-EXT-2455", "M20A-EXT-2450", "M20A-EXT-2451",
    "M20A-EXT-2410", "M20A-EXT-2415", "M20A-EXT-2427", "M20A-EXT-2361",
    "M20A-EXT-2363", "M20A-EXT-2365", "M20A-EXT-2368", "M20A-EXT-2360",
    "M20A-EXT-2587", "M20A-EXT-2588", "M20A-EXT-2634", "M20A-EXT-2635",
}
...
BASIS = (
    ...
    "explicitly preserved receptor-associated complex; adhesion, co-receptor, "
    "sorting, proteoglycan, isoform, species, assay, and non-SCI limitations remain "
...
def main() -> None:
    ...
    for index, aid in enumerate(sorted(SELECTED), start=1):
        q = queue[aid]
        primary = direct[aid]
        evidence_id = f"M20A-MEDHIGH003-EVID-{index:04d}"
        ...
        q["curator_notes"] = append_once(
            q["curator_notes"],
            "Medium-direct-high batch003: exact primary direct evidence adjudicated high for the tested molecular interaction only; noncanonical role and downstream/SCI boundaries preserved.",
        )
        edge.update({
            "confidence_tier": "high",
            "export_priority": "high",
            "exportable": "true",
            "consolidation_note": append_once(edge["consolidation_note"], "Medium-direct-high batch003: exact primary molecular interaction promoted; noncanonical role and context boundaries retained."),
        })
        frozen_row.update({
            "confidence_tier": "high",
            "exportable": "true",
            "consolidation_note": append_once(frozen_row["consolidation_note"], "Medium-direct-high batch003: exact primary molecular interaction promoted; noncanonical role and context boundaries retained."),
        })
    ...
    summary = {
        ...
        "batch_id": "module20a_medium_direct_high_batch003",
