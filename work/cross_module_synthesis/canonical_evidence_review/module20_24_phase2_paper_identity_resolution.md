...
- Rows with resolved PMID: 3,553
- Rows without resolved PMID: 1,169
- Row-level unresolved exception queue: 1,169
- Deduplicated exception groups: 529
- Local artifacts parsed (only when cited by a row): 503

## Resolution status

| Status | Rows |
|---|---:|
| resolved_authoritative_local_artifact | 188 |
...
| unresolved_ambiguous_multiple_canonical_pmids | 581 |
