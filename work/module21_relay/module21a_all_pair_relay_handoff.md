...
- Batches164-165 reviewed 50 exact priority-8 rows spanning Thbs/Timp/Tln/Tnc/Tnf/Tnfsf, Tph1, Tpsb2, and transferrin families; 7 receptor-proximal relay candidates, 1 binding-only case, 1 scavenging/clearance case, 7 function-only cases, 9 explicit no-evidence boundaries, and 25 unresolved boundaries were retained. Three directly supported handoffs were routed to Module22A: RELA for matched TNF–FAS and TNF–NOTCH1 contexts and BCL6 for TPSB2–F2RL1; no TF-target programs were assigned
- Batches166-167 reviewed 50 exact priority-8 rows spanning trypsin/PAR, TSH, TSLP, TTR, UCN, VCAM/VCAN, VEGFA, and related exact-complex boundaries; 11 receptor-proximal relay candidates, 6 binding-only cases, 3 function-only cases, 8 explicit no-evidence boundaries, and 22 unresolved boundaries were retained. No terminal TF handoffs or TF-target programs were assigned
- Batches168-169 reviewed 50 exact priority-8 rows spanning VEGFA/B/C, VIP, vitronectin, von Willebrand factor, WIF/WNT, and related exact-complex boundaries; 5 receptor-proximal relay candidates, 3 binding-only cases, 10 function-only cases, 12 explicit no-evidence boundaries, and 20 unresolved boundaries were retained. No terminal TF handoffs or TF-target programs were assigned
- Batches170-171 reviewed 50 exact priority-8 rows spanning Wnt5/Wnt receptor complexes and LIANA-remaining Alcam/Angpt/Bdnf/Bmp/App/Apoe/Zp3 families; 5 receptor-proximal relay candidates, 11 function-only cases, 13 explicit no-evidence boundaries, and 21 unresolved boundaries were retained. Three directly supported handoffs were routed to Module22A: JUN for BDNF–NGFR and SMAD1/SMAD5/SMAD9 for two matched BMP8A receptor-complex rows; no TF-target programs were assigned
- Batches172-173 reviewed 50 exact LIANA-remaining rows spanning BMP8A, complement, calreticulin, chemokine, CD40L/CD70, CSF3, CXCL, and Notch families; 35 receptor-proximal relay candidates, 10 explicit no-evidence boundaries, 2 binding-only cases, 2 function-only cases, and 1 unresolved boundary were retained. No terminal TF handoffs or TF-target programs were assigned
- Batches174-175 reviewed 50 exact LIANA-remaining rows spanning DLL/Notch, EDIL3/integrin, ephrin/Eph, FAS, fibrinogen/integrin, and FGF families; 20 receptor-proximal relay candidates, 20 binding-only cases, 2 function-only cases, 7 explicit no-evidence boundaries, and 1 unresolved boundary were retained. Three directly supported handoffs were routed to Module22A: HES1/HEY1 for DLL4–NOTCH1, HOXD3 for EDIL3–ITGAV, and RUNX2 for EDIL3–ITGB3; no TF-target programs were assigned
- 162 pair-level provisional TF activation candidates are handed off to Module22A; no TF-target programs were assigned
