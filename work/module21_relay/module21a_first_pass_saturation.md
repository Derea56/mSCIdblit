...
Module 21A is saturated for a bounded first-pass relay corpus across the original nine priority families in the tracker, with a second-pass expansion adding a tenth CSF1/CSF1R glial-crosstalk family. The original seed packet contained 57 directed relay edges, 14 source-group evidence records, and 17 perturbation records. The Q001–Q009 bounded extraction batch added 37 edges, 26 grouped evidence records, and 28 perturbation records. A targeted Q001/Q003/Q004 second pass added one receptor-context edge, one evidence record, and one perturbation record. A subsequent Q007–Q009 second pass added 7 pathway/function edges, 5 evidence records, and 5 perturbation records. Broader-search batch 2 added 3 SCI-context pathway/function edges, 2 grouped evidence records, and 3 perturbation records, bringing the main saturation registers to 105 edges, 48 evidence records, and 54 perturbation records. It is ready for cross-module reconciliation and candidate simulator export, but not for unrestricted SCI receiver simulation.
...
- module21a_saturation_edge_register.tsv: 105 pre-materialization relay edges after the Q001–Q009 bounded batch, targeted second passes, and broader-search batch 2.
...
5. Complex-level nodes such as ISGF3, destruction complexes, NICD-RBPJ, and CSF1R-dependent glial repair context are intentional modeling abstractions; they should be preserved or decomposed consistently during schema materialization.
