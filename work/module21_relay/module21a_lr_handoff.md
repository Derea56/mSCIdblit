...
After batches 238–239, all 5,906 frozen Module20A pairs remain represented in
the audit coverage and Module22A handoff tables. The current audit layer has
2,830 reusable pathway groups and 5,863 detailed evidence records. Exactly
5,906 pairs have been reviewed and none remain queued; 274 pair-level rows
...
Batch 232 added 25 previously queued THBS1/2, THPO/MPL, THY1/integrin,
TIMP/CD, TNC, TNFSF, transferrin, TRH, TSLP, and urocortin contexts: 12 relay
candidates, 6 function-only rows, 2 no-downstream-evidence rows, 3
scavenging-only rows, and 2 unresolved cases. Provisional terminal-TF handoffs
were added for HES1/HES5, STAT5, CREB, and FOS for separate Module22A
validation; integrin subunits, cargo/decoy uptake, death-receptor boundaries,
and receptor-complex evidence remain layer-separated.
...
Batch 234 added 25 previously queued WNT3/WNT5/WNT7, CX3CL1/CX3CR1,
CXCL16/CXCR6, CXCL2/CXCR2, CXCL5/CXCR2, and GDF5/BMPR1B_BMPR2 contexts: 8
relay candidates, 3 function-only rows, and 14 explicit no-evidence
boundaries. Provisional terminal-TF handoffs were added for AP-1, CREB,
TCF/LEF-family, and HES5 endpoints. Exact WNT/FZD/LRP composites, WNT5A/PTK7
assay conflicts, membrane-versus-soluble chemokine behavior, and receptor
stoichiometry remain explicitly bounded.

Batch 235 added 25 previously queued WNT7A/WNT7B FZD/LRP5/6 composite rows: 5
relay candidates, 1 function-only row, 5 unresolved cases, and 14 explicit
no-evidence boundaries. Exact-composite evidence was required; FZD/LRP family
...
Batches 238–239 completed the remaining 41 queued pairs: WNT9A/WNT9B FZD/LRP5/6
composites and XCL1/XCR1. Together they added 2 relay candidates, 1
function-only row, 12 unresolved cases, and 26 explicit no-evidence boundaries.
No terminal-TF handoff was added. WNT9A/B component-level maps, LRP5/6 family
interchangeability, unmatched ternary constructs, and generic beta-catenin
reporters remain separate from exact-composite evidence; XCL1/XCR1 functional
chemotaxis and immune outputs remain distinct from a terminal TF claim.
