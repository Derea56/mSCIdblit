...
INSERT INTO Consensus (
  ...
  NULL,
  NULL,
  '{"boundary_or_contradiction_handling": "M1B-X005 and M1B-X007 separate local lesion stability/adjacent mass preservation from remote degeneration, vascular infarct-like lesions, and syrinx-associated atrophy.", "boundary_tracker_ids": ["M1B-X005", "M1B-X007"], "claim_tracker_ids": ["M1B-C035", "M1B-C036", "M1B-C037", "M1B-C038", "M1B-C039", "M1B-C040", "M1B-C047", "M1B-C048", "M1B-C049", "M1B-C050"], "consensus_draft_id": "M1B-S007", "materialization_note": "Consensus_Observation rows deferred until Observation tracker rows have database primary keys.", "observation_tracker_ids": ["M1B-O063", "M1B-O064", "M1B-O065", "M1B-O066", "M1B-O067", "M1B-O068", "M1B-O069", "M1B-O070", "M1B-O080", "M1B-O081", "M1B-O082", "M1B-O083", "M1B-O084"], "source_agreement_label": "strong first-pass", "source_tracker": "modules/Module_1B_TRACKER.md", "supporting_evidence_scope": "Supported by five full-text human studies plus source-page pediatric DTI support; observations M1B-O063-M1B-O070 and M1B-O080-M1B-O084; claims M1B-C035-M1B-C040 and M1B-C047-M1B-C050.", "topic_id": "M1B-T007"}'
);
...
INSERT INTO Consensus (
  ...
  NULL,
  NULL,
  '{"boundary_or_contradiction_handling": "M1B-X006 resolves the main tension as phase- and function-specific: protective early containment/debris roles can coexist with chronic inflammatory harm. Source-page mechanistic rows remain medium confidence.", "boundary_tracker_ids": ["M1B-X006"], "claim_tracker_ids": ["M1B-C041", "M1B-C042", "M1B-C043", "M1B-C044", "M1B-C045", "M1B-C046"], "consensus_draft_id": "M1B-S008", "materialization_note": "Consensus_Observation rows deferred until Observation tracker rows have database primary keys.", "observation_tracker_ids": ["M1B-O071", "M1B-O072", "M1B-O073", "M1B-O074", "M1B-O075", "M1B-O076", "M1B-O077", "M1B-O078", "M1B-O079"], "source_agreement_label": "moderate", "source_tracker": "modules/Module_1B_TRACKER.md", "supporting_evidence_scope": "Supported by Li 2020 full text plus source-page evidence from Zhou, Milich, and Gerber; observations M1B-O071-M1B-O079; claims M1B-C041-M1B-C046.", "topic_id": "M1B-T008"}'
);
