...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P002-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O030"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P002-E001-E002", "source_paper_tracker_id": "M2A-P002", "tracker_key": "M2A-P002::M2A-P002-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P002'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P002::M2A-P002-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M2A-P003-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O031", "M2B-O043"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P003-E001-E002", "source_paper_tracker_id": "M2A-P003", "tracker_key": "M2A-P003::M2A-P003-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P003'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P003::M2A-P003-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P004-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O004"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P004-E001-E002", "source_paper_tracker_id": "M2A-P004", "tracker_key": "M2A-P004::M2A-P004-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P004'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P004::M2A-P004-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P005-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O005"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P005-E001-E002", "source_paper_tracker_id": "M2A-P005", "tracker_key": "M2A-P005::M2A-P005-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P005'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P005::M2A-P005-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P006-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O017"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P006-E001-E002", "source_paper_tracker_id": "M2A-P006", "tracker_key": "M2A-P006::M2A-P006-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P006'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P006::M2A-P006-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P007-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O037"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P007-E001-E002", "source_paper_tracker_id": "M2A-P007", "tracker_key": "M2A-P007::M2A-P007-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P007'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P007::M2A-P007-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P008-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O024"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P008-E001-E002", "source_paper_tracker_id": "M2A-P008", "tracker_key": "M2A-P008::M2A-P008-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P008'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P008::M2A-P008-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P010-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O006"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P010-E001-E002", "source_paper_tracker_id": "M2A-P010", "tracker_key": "M2A-P010::M2A-P010-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P010'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P010::M2A-P010-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P011-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O007"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P011-E001-E002", "source_paper_tracker_id": "M2A-P011", "tracker_key": "M2A-P011::M2A-P011-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P011'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P011::M2A-P011-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P012-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O009"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P012-E001-E002", "source_paper_tracker_id": "M2A-P012", "tracker_key": "M2A-P012::M2A-P012-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P012'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P012::M2A-P012-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P013-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O032"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P013-E001-E002", "source_paper_tracker_id": "M2A-P013", "tracker_key": "M2A-P013::M2A-P013-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P013'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P013::M2A-P013-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P014-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O015"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P014-E001-E002", "source_paper_tracker_id": "M2A-P014", "tracker_key": "M2A-P014::M2A-P014-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P014'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P014::M2A-P014-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P015-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O018"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P015-E001-E002", "source_paper_tracker_id": "M2A-P015", "tracker_key": "M2A-P015::M2A-P015-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P015'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P015::M2A-P015-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P016-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O010"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P016-E001-E002", "source_paper_tracker_id": "M2A-P016", "tracker_key": "M2A-P016::M2A-P016-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P016'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P016::M2A-P016-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P018-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O025"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P018-E001-E002", "source_paper_tracker_id": "M2A-P018", "tracker_key": "M2A-P018::M2A-P018-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P018'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P018::M2A-P018-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P019-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O048"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P019-E001-E002", "source_paper_tracker_id": "M2A-P019", "tracker_key": "M2A-P019::M2A-P019-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P019'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P019::M2A-P019-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P020-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O033", "M2B-O044"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P020-E001-E002", "source_paper_tracker_id": "M2A-P020", "tracker_key": "M2A-P020::M2A-P020-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P020'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P020::M2A-P020-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P021-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O026"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P021-E001-E002", "source_paper_tracker_id": "M2A-P021", "tracker_key": "M2A-P021::M2A-P021-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P021'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P021::M2A-P021-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P022-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O034", "M2B-O045"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P022-E001-E002", "source_paper_tracker_id": "M2A-P022", "tracker_key": "M2A-P022::M2A-P022-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P022'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P022::M2A-P022-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P023-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O035"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P023-E001-E002", "source_paper_tracker_id": "M2A-P023", "tracker_key": "M2A-P023::M2A-P023-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P023'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P023::M2A-P023-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P024-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O036"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P024-E001-E002", "source_paper_tracker_id": "M2A-P024", "tracker_key": "M2A-P024::M2A-P024-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P024'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P024::M2A-P024-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P025-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O012"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P025-E001-E002", "source_paper_tracker_id": "M2A-P025", "tracker_key": "M2A-P025::M2A-P025-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P025'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P025::M2A-P025-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P026-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O038"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P026-E001-E002", "source_paper_tracker_id": "M2A-P026", "tracker_key": "M2A-P026::M2A-P026-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P026'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P026::M2A-P026-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P027-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O013"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P027-E001-E002", "source_paper_tracker_id": "M2A-P027", "tracker_key": "M2A-P027::M2A-P027-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P027'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P027::M2A-P027-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P028-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O039"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P028-E001-E002", "source_paper_tracker_id": "M2A-P028", "tracker_key": "M2A-P028::M2A-P028-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P028'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P028::M2A-P028-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P029-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O003"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P029-E001-E002", "source_paper_tracker_id": "M2A-P029", "tracker_key": "M2A-P029::M2A-P029-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P029'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P029::M2A-P029-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P030-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O040"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P030-E001-E002", "source_paper_tracker_id": "M2A-P030", "tracker_key": "M2A-P030::M2A-P030-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P030'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P030::M2A-P030-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P031-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O041"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P031-E001-E002", "source_paper_tracker_id": "M2A-P031", "tracker_key": "M2A-P031::M2A-P031-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P031'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P031::M2A-P031-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P032-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O016"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P032-E001-E002", "source_paper_tracker_id": "M2A-P032", "tracker_key": "M2A-P032::M2A-P032-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P032'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P032::M2A-P032-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P033-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O023"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P033-E001-E002", "source_paper_tracker_id": "M2A-P033", "tracker_key": "M2A-P033::M2A-P033-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P033'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P033::M2A-P033-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P034-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O019"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P034-E001-E002", "source_paper_tracker_id": "M2A-P034", "tracker_key": "M2A-P034::M2A-P034-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P034'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P034::M2A-P034-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P035-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O027"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P035-E001-E002", "source_paper_tracker_id": "M2A-P035", "tracker_key": "M2A-P035::M2A-P035-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P035'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P035::M2A-P035-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P036-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O014"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P036-E001-E002", "source_paper_tracker_id": "M2A-P036", "tracker_key": "M2A-P036::M2A-P036-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P036'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P036::M2A-P036-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P037-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O028"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P037-E001-E002", "source_paper_tracker_id": "M2A-P037", "tracker_key": "M2A-P037::M2A-P037-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P037'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P037::M2A-P037-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P038-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O020"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P038-E001-E002", "source_paper_tracker_id": "M2A-P038", "tracker_key": "M2A-P038::M2A-P038-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P038'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P038::M2A-P038-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P039-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O008"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P039-E001-E002", "source_paper_tracker_id": "M2A-P039", "tracker_key": "M2A-P039::M2A-P039-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P039'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P039::M2A-P039-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P040-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O042"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P040-E001-E002", "source_paper_tracker_id": "M2A-P040", "tracker_key": "M2A-P040::M2A-P040-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P040'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P040::M2A-P040-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P041-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O011"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P041-E001-E002", "source_paper_tracker_id": "M2A-P041", "tracker_key": "M2A-P041::M2A-P041-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P041'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P041::M2A-P041-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P042-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O029"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P042-E001-E002", "source_paper_tracker_id": "M2A-P042", "tracker_key": "M2A-P042::M2A-P042-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P042'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P042::M2A-P042-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract',
    'Tracker experiment M2A-P043-E001-E002',
    'Module 2 tracker-derived experiment placeholder.',
    NULL,
    NULL,
    '{"observation_tracker_ids": ["M2B-O021"], "source_experiment": {}, "source_experiment_tracker_id": "M2A-P043-E001-E002", "source_paper_tracker_id": "M2A-P043", "tracker_key": "M2A-P043::M2A-P043-E001-E002"}'
  FROM _m2_paper_map p
  JOIN _m2_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M2A-P043'
  RETURNING experiment_id
)
INSERT INTO _m2_experiment_map (tracker_id, experiment_id) SELECT 'M2A-P043::M2A-P043-E001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Strong translational bridge but still abstract-level here.", "experiment_tracker_id": "M2A-P029-E001-E002", "paper_tracker_id": "M2A-P029", "quantitative": "YES", "statistics_reported": "significant improvement reported in abstract", "topic_id": "M2B-T006", "tracker_id": "M2B-O003"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P029::M2A-P029-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Architecture and cell effects are bundled.", "experiment_tracker_id": "M2A-P004-E001-E002", "paper_tracker_id": "M2A-P004", "quantitative": "YES", "statistics_reported": "statistics not extracted from abstract", "topic_id": "M2B-T001", "tracker_id": "M2B-O004"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P004::M2A-P004-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Important scaffold-only guidance anchor.", "experiment_tracker_id": "M2A-P005-E001-E002", "paper_tracker_id": "M2A-P005", "quantitative": "YES", "statistics_reported": "abstract-level; exact values not extracted", "topic_id": "M2B-T001", "tracker_id": "M2B-O005"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P005::M2A-P005-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Primarily platform/architecture evidence, not direct functional outcome.", "experiment_tracker_id": "M2A-P010-E001-E002", "paper_tracker_id": "M2A-P010", "quantitative": "NO", "statistics_reported": "not applicable", "topic_id": "M2B-T001", "tracker_id": "M2B-O006"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P010::M2A-P010-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Early peptide scaffold bridge anchor.", "experiment_tracker_id": "M2A-P011-E001-E002", "paper_tracker_id": "M2A-P011", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T001", "tracker_id": "M2B-O007"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P011::M2A-P011-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Advanced guidance/electrical interface anchor.", "experiment_tracker_id": "M2A-P039-E001-E002", "paper_tracker_id": "M2A-P039", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T001", "tracker_id": "M2B-O008"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P039::M2A-P039-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Useful because scaffold-only comparator is present.", "experiment_tracker_id": "M2A-P012-E001-E002", "paper_tracker_id": "M2A-P012", "quantitative": "YES", "statistics_reported": "abstract reports approximate BBB 5 vs 2 and MEP 200-300 uV", "topic_id": "M2B-T002", "tracker_id": "M2B-O009"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P012::M2A-P012-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Separates histological benefit from locomotor equivalence.", "experiment_tracker_id": "M2A-P016-E001-E002", "paper_tracker_id": "M2A-P016", "quantitative": "YES", "statistics_reported": "\"twice as many\" reported in abstract", "topic_id": "M2B-T002", "tracker_id": "M2B-O010"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P016::M2A-P016-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Combination mechanism is highly bundled.", "experiment_tracker_id": "M2A-P041-E001-E002", "paper_tracker_id": "M2A-P041", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T002", "tracker_id": "M2B-O011"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P041::M2A-P041-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Key positive-histology/negative-function boundary.", "experiment_tracker_id": "M2A-P025-E001-E002", "paper_tracker_id": "M2A-P025", "quantitative": "YES", "statistics_reported": "1.5- to 3-fold fiber growth; function not improved", "topic_id": "M2B-T003", "tracker_id": "M2B-O012"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P025::M2A-P025-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Multiple active components make attribution difficult.", "experiment_tracker_id": "M2A-P027-E001-E002", "paper_tracker_id": "M2A-P027", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T003", "tracker_id": "M2B-O013"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P027::M2A-P027-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Strong design logic; needs full text for timing and effect sizes.", "experiment_tracker_id": "M2A-P036-E001-E002", "paper_tracker_id": "M2A-P036", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T003", "tracker_id": "M2B-O014"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P036::M2A-P036-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Important ECM benefit/boundary observation.", "experiment_tracker_id": "M2A-P014-E001-E002", "paper_tracker_id": "M2A-P014", "quantitative": "YES", "statistics_reported": "qPCR/histology reported; exact values not extracted", "topic_id": "M2B-T004", "tracker_id": "M2B-O015"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P014::M2A-P014-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "ECM source/subtype is a material boundary condition.", "experiment_tracker_id": "M2A-P032-E001-E002", "paper_tracker_id": "M2A-P032", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T004", "tracker_id": "M2B-O016"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P032::M2A-P032-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Strong chronic bridge to Module 1, but abstract-level here.", "experiment_tracker_id": "M2A-P006-E001-E002", "paper_tracker_id": "M2A-P006", "quantitative": "YES", "statistics_reported": "outcomes up to 3 months; exact stats not extracted", "topic_id": "M2B-T005", "tracker_id": "M2B-O017"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P006::M2A-P006-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Translational large-animal chronic anchor.", "experiment_tracker_id": "M2A-P015-E001-E002", "paper_tracker_id": "M2A-P015", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T005", "tracker_id": "M2B-O018"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P015::M2A-P015-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Surface-capping strategy differs from lesion-filling bridges.", "experiment_tracker_id": "M2A-P034-E001-E002", "paper_tracker_id": "M2A-P034", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T007", "tracker_id": "M2B-O019"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P034::M2A-P034-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Patch covers hematoma surface rather than filling cavity.", "experiment_tracker_id": "M2A-P038-E001-E002", "paper_tracker_id": "M2A-P038", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T007", "tracker_id": "M2B-O020"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P038::M2A-P038-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Prevents overinterpreting all recovery as bridge-mediated axon regeneration.", "experiment_tracker_id": "M2A-P043-E001-E002", "paper_tracker_id": "M2A-P043", "quantitative": "YES", "statistics_reported": "abstract-level; exact correlation metrics not extracted", "topic_id": "M2B-T008", "tracker_id": "M2B-O021"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P043::M2A-P043-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Important translational bridge but cell/scaffold effects are bundled.", "experiment_tracker_id": "M2A-P033-E001-E002", "paper_tracker_id": "M2A-P033", "quantitative": "YES", "statistics_reported": "exact human outcome values not extracted", "topic_id": "M2B-T006", "tracker_id": "M2B-O023"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P033::M2A-P033-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Combines scaffold guidance with molecular delivery.", "experiment_tracker_id": "M2A-P008-E001-E002", "paper_tracker_id": "M2A-P008", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T001", "tracker_id": "M2B-O024"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P008::M2A-P008-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Cell-source comparison is central, but scaffold provides retention/guidance platform.", "experiment_tracker_id": "M2A-P018-E001-E002", "paper_tracker_id": "M2A-P018", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T001", "tracker_id": "M2B-O025"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P018::M2A-P018-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Distinct injectable alignment strategy.", "experiment_tracker_id": "M2A-P021-E001-E002", "paper_tracker_id": "M2A-P021", "quantitative": "YES", "statistics_reported": "100-Gauss alignment condition reported", "topic_id": "M2B-T001", "tracker_id": "M2B-O026"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P021::M2A-P021-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Architecture and cell effects are bundled.", "experiment_tracker_id": "M2A-P035-E001-E002", "paper_tracker_id": "M2A-P035", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T001", "tracker_id": "M2B-O027"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P035::M2A-P035-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Also belongs to cargo/release topic.", "experiment_tracker_id": "M2A-P037-E001-E002", "paper_tracker_id": "M2A-P037", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T001", "tracker_id": "M2B-O028"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P037::M2A-P037-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Printed architecture and cell effect bundled.", "experiment_tracker_id": "M2A-P042-E001-E002", "paper_tracker_id": "M2A-P042", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T001", "tracker_id": "M2B-O029"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P042::M2A-P042-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Chronic repair bridge; full text unavailable in tracker.", "experiment_tracker_id": "M2A-P002-E001-E002", "paper_tracker_id": "M2A-P002", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T002", "tracker_id": "M2B-O030"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P002::M2A-P002-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract/source page',
    'medium',
    '{"curator_notes": "Important chronic histology-function boundary.", "experiment_tracker_id": "M2A-P003-E001-E002", "paper_tracker_id": "M2A-P003", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T002", "tracker_id": "M2B-O031"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P003::M2A-P003-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "A clear example of scaffold/cell/cue confounding by design.", "experiment_tracker_id": "M2A-P013-E001-E002", "paper_tracker_id": "M2A-P013", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T002", "tracker_id": "M2B-O032"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P013::M2A-P013-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "ECM and cell effects bundled.", "experiment_tracker_id": "M2A-P020-E001-E002", "paper_tracker_id": "M2A-P020", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T002", "tracker_id": "M2B-O033"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P020::M2A-P020-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Highly combinatorial; cannot attribute effect to one component.", "experiment_tracker_id": "M2A-P022-E001-E002", "paper_tracker_id": "M2A-P022", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T002", "tracker_id": "M2B-O034"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P022::M2A-P022-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Triple combination limits causal attribution.", "experiment_tracker_id": "M2A-P023-E001-E002", "paper_tracker_id": "M2A-P023", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T002", "tracker_id": "M2B-O035"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P023::M2A-P023-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Conductive/cell/growth-factor combination.", "experiment_tracker_id": "M2A-P024-E001-E002", "paper_tracker_id": "M2A-P024", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T002", "tracker_id": "M2B-O036"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P024::M2A-P024-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Cargo-delivery exemplar.", "experiment_tracker_id": "M2A-P007-E001-E002", "paper_tracker_id": "M2A-P007", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T003", "tracker_id": "M2B-O037"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P007::M2A-P007-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Growth-factor hydrogel anchor.", "experiment_tracker_id": "M2A-P026-E001-E002", "paper_tracker_id": "M2A-P026", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T003", "tracker_id": "M2B-O038"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P026::M2A-P026-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Complements fibrin/NT-3 boundary.", "experiment_tracker_id": "M2A-P028-E001-E002", "paper_tracker_id": "M2A-P028", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T003", "tracker_id": "M2B-O039"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P028::M2A-P028-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Large-animal cargo-release anchor.", "experiment_tracker_id": "M2A-P030-E001-E002", "paper_tracker_id": "M2A-P030", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T003", "tracker_id": "M2B-O040"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P030::M2A-P030-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Anti-inflammatory scaffold/cargo anchor.", "experiment_tracker_id": "M2A-P031-E001-E002", "paper_tracker_id": "M2A-P031", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T003", "tracker_id": "M2B-O041"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P031::M2A-P031-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Methods anchor for release rather than in vivo efficacy.", "experiment_tracker_id": "M2A-P040-E001-E002", "paper_tracker_id": "M2A-P040", "quantitative": "NO", "statistics_reported": "release details not extracted", "topic_id": "M2B-T003", "tracker_id": "M2B-O042"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P040::M2A-P040-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract/source page',
    'medium',
    '{"curator_notes": "Chronic ECM scaffold anchor.", "experiment_tracker_id": "M2A-P003-E001-E002", "paper_tracker_id": "M2A-P003", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T004", "tracker_id": "M2B-O043"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P003::M2A-P003-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Material microenvironment observation.", "experiment_tracker_id": "M2A-P020-E001-E002", "paper_tracker_id": "M2A-P020", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T004", "tracker_id": "M2B-O044"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P020::M2A-P020-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "ECM component cannot be isolated from other cargos.", "experiment_tracker_id": "M2A-P022-E001-E002", "paper_tracker_id": "M2A-P022", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T004", "tracker_id": "M2B-O045"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P022::M2A-P022-E001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract',
    'medium',
    '{"curator_notes": "Connects passive guidance to active cue delivery.", "experiment_tracker_id": "M2A-P019-E001-E002", "paper_tracker_id": "M2A-P019", "quantitative": "YES", "statistics_reported": "exact values not extracted", "topic_id": "M2B-T007", "tracker_id": "M2B-O048"}'
  FROM _m2_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M2A-P019::M2A-P019-E001-E002'
...
WITH inserted AS (
  ...
  VALUES (
    'Scaffold architecture can provide physical guidance for axons, cells, and tissue organization after SCI, especially when alignment, channels, or printed geometry match lesion topology.',
    'M2B-T001',
    1,
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Scaffold-supported cell transplantation improves retention and repair signals in many SCI models, but attribution is usually shared between scaffold, cell source, and cargo.',
    'M2B-T002',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Controlled release from scaffolds can improve trophic and inflammatory repair profiles, but histological benefit may not translate into motor recovery.',
    'M2B-T003',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'ECM and hydrogel scaffolds create permissive microenvironments, but source tissue, immune response, and lesion model determine whether integration is beneficial.',
    'M2B-T004',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Chronic scar/cavity scaffold repair is plausible when lesion anatomy permits resection/filling, but it must be interpreted with Module 1 lesion-boundary evidence.',
    'M2B-T005',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Large-animal, primate, and early human data support translational feasibility of scaffold strategies, while definitive clinical efficacy remains unestablished.',
    'M2B-T006',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Conductive, electrical, multimodal, and surface-patch scaffolds broaden scaffold repair beyond passive lesion filling by adding electrical interfaces, inflammatory modulation, or surface capping.',
    'M2B-T007',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Module 2 scaffold evidence is best synthesized by material, cell/cargo combination, lesion chronicity, species, and outcome class rather than as a single uniformly pro-regenerative intervention family.',
    'M2B-T008',
    1,
    'consensus-ready first pass',
...
BEGIN
  ...
  IF experiment_count <> 46 THEN RAISE EXCEPTION 'Unexpected experiment count %', experiment_count; END IF;
