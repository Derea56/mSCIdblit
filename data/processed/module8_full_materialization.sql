...
WITH inserted AS (
  ...
  VALUES (
    ...
    1,
    'consensus-ready first pass',
    '{"boundary_tracker_ids": ["M8B-B001", "M8B-B002", "M8B-B003", "M8B-B004", "M8B-B005", "M8B-B006", "M8B-B007", "M8B-B008"], "claim_tracker_ids": ["M8B-C004", "M8B-C005", "M8B-C006"], "consensus_draft_id": "M8B-S002", "observation_tracker_ids": ["M8B-O002"], "readiness_status": "CONSENSUS-READY FIRST PASS", "source_agreement_label": null, "supporting_evidence_notes": "Module 8 first-pass curation freeze.", "topic_id": "M8B-T002"}'
  )
  RETURNING consensus_id
)
...
WITH inserted AS (
  ...
  VALUES (
    ...
    1,
    'consensus-ready first pass',
    '{"boundary_tracker_ids": ["M8B-B001", "M8B-B002", "M8B-B003", "M8B-B004", "M8B-B005", "M8B-B006", "M8B-B007", "M8B-B008"], "claim_tracker_ids": ["M8B-C007", "M8B-C008", "M8B-C009"], "consensus_draft_id": "M8B-S003", "observation_tracker_ids": ["M8B-O003"], "readiness_status": "CONSENSUS-READY FIRST PASS", "source_agreement_label": null, "supporting_evidence_notes": "Module 8 first-pass curation freeze.", "topic_id": "M8B-T003"}'
  )
  RETURNING consensus_id
)
...
WITH inserted AS (
  ...
  VALUES (
    ...
    1,
    'consensus-ready first pass',
    '{"boundary_tracker_ids": ["M8B-B001", "M8B-B002", "M8B-B003", "M8B-B004", "M8B-B005", "M8B-B006", "M8B-B007", "M8B-B008"], "claim_tracker_ids": ["M8B-C010", "M8B-C011", "M8B-C012"], "consensus_draft_id": "M8B-S004", "observation_tracker_ids": ["M8B-O004"], "readiness_status": "CONSENSUS-READY FIRST PASS", "source_agreement_label": null, "supporting_evidence_notes": "Module 8 first-pass curation freeze.", "topic_id": "M8B-T004"}'
  )
  RETURNING consensus_id
)
...
WITH inserted AS (
  ...
  VALUES (
    ...
    1,
    'consensus-ready first pass',
    '{"boundary_tracker_ids": ["M8B-B001", "M8B-B002", "M8B-B003", "M8B-B004", "M8B-B005", "M8B-B006", "M8B-B007", "M8B-B008"], "claim_tracker_ids": ["M8B-C013", "M8B-C014", "M8B-C015"], "consensus_draft_id": "M8B-S005", "observation_tracker_ids": ["M8B-O005"], "readiness_status": "CONSENSUS-READY FIRST PASS", "source_agreement_label": null, "supporting_evidence_notes": "Module 8 first-pass curation freeze.", "topic_id": "M8B-T005"}'
  )
  RETURNING consensus_id
)
...
WITH inserted AS (
  ...
  VALUES (
    ...
    1,
    'consensus-ready first pass',
    '{"boundary_tracker_ids": ["M8B-B001", "M8B-B002", "M8B-B003", "M8B-B004", "M8B-B005", "M8B-B006", "M8B-B007", "M8B-B008"], "claim_tracker_ids": ["M8B-C016"], "consensus_draft_id": "M8B-S006", "observation_tracker_ids": ["M8B-O006"], "readiness_status": "CONSENSUS-READY FIRST PASS", "source_agreement_label": null, "supporting_evidence_notes": "Module 8 first-pass curation freeze.", "topic_id": "M8B-T006"}'
  )
  RETURNING consensus_id
)
...
WITH inserted AS (
  ...
  VALUES (
    ...
    1,
    'consensus-ready first pass',
    '{"boundary_tracker_ids": ["M8B-B001", "M8B-B002", "M8B-B003", "M8B-B004", "M8B-B005", "M8B-B006", "M8B-B007", "M8B-B008"], "claim_tracker_ids": ["M8B-C016"], "consensus_draft_id": "M8B-S007", "observation_tracker_ids": ["M8B-O007"], "readiness_status": "CONSENSUS-READY FIRST PASS", "source_agreement_label": null, "supporting_evidence_notes": "Module 8 first-pass curation freeze.", "topic_id": "M8B-T007"}'
  )
  RETURNING consensus_id
)
...
WITH inserted AS (
  ...
  VALUES (
    ...
    1,
    'consensus-ready first pass',
    '{"boundary_tracker_ids": ["M8B-B001", "M8B-B002", "M8B-B003", "M8B-B004", "M8B-B005", "M8B-B006", "M8B-B007", "M8B-B008"], "claim_tracker_ids": ["M8B-C016"], "consensus_draft_id": "M8B-S008", "observation_tracker_ids": ["M8B-O008"], "readiness_status": "CONSENSUS-READY FIRST PASS", "source_agreement_label": null, "supporting_evidence_notes": "Module 8 first-pass curation freeze.", "topic_id": "M8B-T008"}'
  )
  RETURNING consensus_id
)
...
BEGIN
  ...
  IF paper_count <> 14 THEN RAISE EXCEPTION 'Expected 14 papers, found %', paper_count; END IF;
  IF experiment_count <> 14 THEN RAISE EXCEPTION 'Unexpected experiment count %', experiment_count; END IF;
  IF observation_count <> 14 THEN RAISE EXCEPTION 'Expected 14 observations, found %', observation_count; END IF;
  ...
  IF consensus_observation_count <> 8 THEN RAISE EXCEPTION 'Unexpected consensus-observation count %', consensus_observation_count; END IF;
END $$;
