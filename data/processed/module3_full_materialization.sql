...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P001-E001-M3A-P001-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O001"], "source_experiment_tracker_id": "M3A-P001-E001-M3A-P001-E002", "source_paper_tracker_id": "M3A-P001", "tracker_key": "M3A-P001::M3A-P001-E001-M3A-P001-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P001'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P001::M3A-P001-E001-M3A-P001-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P002-E001-M3A-P002-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O002"], "source_experiment_tracker_id": "M3A-P002-E001-M3A-P002-E002", "source_paper_tracker_id": "M3A-P002", "tracker_key": "M3A-P002::M3A-P002-E001-M3A-P002-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P002'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P002::M3A-P002-E001-M3A-P002-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P003-E001-M3A-P003-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O003"], "source_experiment_tracker_id": "M3A-P003-E001-M3A-P003-E002", "source_paper_tracker_id": "M3A-P003", "tracker_key": "M3A-P003::M3A-P003-E001-M3A-P003-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P003'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P003::M3A-P003-E001-M3A-P003-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P004-E001-M3A-P004-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O004"], "source_experiment_tracker_id": "M3A-P004-E001-M3A-P004-E002", "source_paper_tracker_id": "M3A-P004", "tracker_key": "M3A-P004::M3A-P004-E001-M3A-P004-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P004'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P004::M3A-P004-E001-M3A-P004-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P005-E001-M3A-P005-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O005"], "source_experiment_tracker_id": "M3A-P005-E001-M3A-P005-E002", "source_paper_tracker_id": "M3A-P005", "tracker_key": "M3A-P005::M3A-P005-E001-M3A-P005-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P005'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P005::M3A-P005-E001-M3A-P005-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P006-E001-M3A-P006-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O006"], "source_experiment_tracker_id": "M3A-P006-E001-M3A-P006-E002", "source_paper_tracker_id": "M3A-P006", "tracker_key": "M3A-P006::M3A-P006-E001-M3A-P006-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P006'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P006::M3A-P006-E001-M3A-P006-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P007-E001-M3A-P007-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O007"], "source_experiment_tracker_id": "M3A-P007-E001-M3A-P007-E002", "source_paper_tracker_id": "M3A-P007", "tracker_key": "M3A-P007::M3A-P007-E001-M3A-P007-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P007'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P007::M3A-P007-E001-M3A-P007-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P008-E001-M3A-P008-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O008"], "source_experiment_tracker_id": "M3A-P008-E001-M3A-P008-E002", "source_paper_tracker_id": "M3A-P008", "tracker_key": "M3A-P008::M3A-P008-E001-M3A-P008-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P008'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P008::M3A-P008-E001-M3A-P008-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P009-E001-M3A-P009-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O009"], "source_experiment_tracker_id": "M3A-P009-E001-M3A-P009-E002", "source_paper_tracker_id": "M3A-P009", "tracker_key": "M3A-P009::M3A-P009-E001-M3A-P009-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P009'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P009::M3A-P009-E001-M3A-P009-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P010-E001-M3A-P010-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O010"], "source_experiment_tracker_id": "M3A-P010-E001-M3A-P010-E002", "source_paper_tracker_id": "M3A-P010", "tracker_key": "M3A-P010::M3A-P010-E001-M3A-P010-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P010'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P010::M3A-P010-E001-M3A-P010-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P011-E001-M3A-P011-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O011"], "source_experiment_tracker_id": "M3A-P011-E001-M3A-P011-E002", "source_paper_tracker_id": "M3A-P011", "tracker_key": "M3A-P011::M3A-P011-E001-M3A-P011-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P011'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P011::M3A-P011-E001-M3A-P011-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P012-E001-M3A-P012-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O012"], "source_experiment_tracker_id": "M3A-P012-E001-M3A-P012-E002", "source_paper_tracker_id": "M3A-P012", "tracker_key": "M3A-P012::M3A-P012-E001-M3A-P012-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P012'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P012::M3A-P012-E001-M3A-P012-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P013-E001-M3A-P013-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O013"], "source_experiment_tracker_id": "M3A-P013-E001-M3A-P013-E002", "source_paper_tracker_id": "M3A-P013", "tracker_key": "M3A-P013::M3A-P013-E001-M3A-P013-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P013'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P013::M3A-P013-E001-M3A-P013-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P014-E001-M3A-P014-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O014"], "source_experiment_tracker_id": "M3A-P014-E001-M3A-P014-E002", "source_paper_tracker_id": "M3A-P014", "tracker_key": "M3A-P014::M3A-P014-E001-M3A-P014-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P014'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P014::M3A-P014-E001-M3A-P014-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P015-E001-M3A-P015-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O015"], "source_experiment_tracker_id": "M3A-P015-E001-M3A-P015-E002", "source_paper_tracker_id": "M3A-P015", "tracker_key": "M3A-P015::M3A-P015-E001-M3A-P015-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P015'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P015::M3A-P015-E001-M3A-P015-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P016-E001-M3A-P016-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O016"], "source_experiment_tracker_id": "M3A-P016-E001-M3A-P016-E002", "source_paper_tracker_id": "M3A-P016", "tracker_key": "M3A-P016::M3A-P016-E001-M3A-P016-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P016'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P016::M3A-P016-E001-M3A-P016-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P017-E001-M3A-P017-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O017"], "source_experiment_tracker_id": "M3A-P017-E001-M3A-P017-E002", "source_paper_tracker_id": "M3A-P017", "tracker_key": "M3A-P017::M3A-P017-E001-M3A-P017-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P017'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P017::M3A-P017-E001-M3A-P017-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P018-E001-M3A-P018-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O018"], "source_experiment_tracker_id": "M3A-P018-E001-M3A-P018-E002", "source_paper_tracker_id": "M3A-P018", "tracker_key": "M3A-P018::M3A-P018-E001-M3A-P018-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P018'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P018::M3A-P018-E001-M3A-P018-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P019-E001-M3A-P019-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O019"], "source_experiment_tracker_id": "M3A-P019-E001-M3A-P019-E002", "source_paper_tracker_id": "M3A-P019", "tracker_key": "M3A-P019::M3A-P019-E001-M3A-P019-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P019'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P019::M3A-P019-E001-M3A-P019-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P020-E001-M3A-P020-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O020"], "source_experiment_tracker_id": "M3A-P020-E001-M3A-P020-E002", "source_paper_tracker_id": "M3A-P020", "tracker_key": "M3A-P020::M3A-P020-E001-M3A-P020-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P020'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P020::M3A-P020-E001-M3A-P020-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P021-E001-M3A-P021-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O021"], "source_experiment_tracker_id": "M3A-P021-E001-M3A-P021-E002", "source_paper_tracker_id": "M3A-P021", "tracker_key": "M3A-P021::M3A-P021-E001-M3A-P021-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P021'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P021::M3A-P021-E001-M3A-P021-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P022-E001-M3A-P022-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O022"], "source_experiment_tracker_id": "M3A-P022-E001-M3A-P022-E002", "source_paper_tracker_id": "M3A-P022", "tracker_key": "M3A-P022::M3A-P022-E001-M3A-P022-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P022'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P022::M3A-P022-E001-M3A-P022-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P023-E001-M3A-P023-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O023"], "source_experiment_tracker_id": "M3A-P023-E001-M3A-P023-E002", "source_paper_tracker_id": "M3A-P023", "tracker_key": "M3A-P023::M3A-P023-E001-M3A-P023-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P023'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P023::M3A-P023-E001-M3A-P023-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P024-E001-M3A-P024-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O024"], "source_experiment_tracker_id": "M3A-P024-E001-M3A-P024-E002", "source_paper_tracker_id": "M3A-P024", "tracker_key": "M3A-P024::M3A-P024-E001-M3A-P024-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P024'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P024::M3A-P024-E001-M3A-P024-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P025-E001-M3A-P025-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O025"], "source_experiment_tracker_id": "M3A-P025-E001-M3A-P025-E002", "source_paper_tracker_id": "M3A-P025", "tracker_key": "M3A-P025::M3A-P025-E001-M3A-P025-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P025'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P025::M3A-P025-E001-M3A-P025-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P026-E001-M3A-P026-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O026"], "source_experiment_tracker_id": "M3A-P026-E001-M3A-P026-E002", "source_paper_tracker_id": "M3A-P026", "tracker_key": "M3A-P026::M3A-P026-E001-M3A-P026-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P026'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P026::M3A-P026-E001-M3A-P026-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P027-E001-M3A-P027-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O027"], "source_experiment_tracker_id": "M3A-P027-E001-M3A-P027-E002", "source_paper_tracker_id": "M3A-P027", "tracker_key": "M3A-P027::M3A-P027-E001-M3A-P027-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P027'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P027::M3A-P027-E001-M3A-P027-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P028-E001-M3A-P028-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O028"], "source_experiment_tracker_id": "M3A-P028-E001-M3A-P028-E002", "source_paper_tracker_id": "M3A-P028", "tracker_key": "M3A-P028::M3A-P028-E001-M3A-P028-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P028'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P028::M3A-P028-E001-M3A-P028-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P029-E001-M3A-P029-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O029"], "source_experiment_tracker_id": "M3A-P029-E001-M3A-P029-E002", "source_paper_tracker_id": "M3A-P029", "tracker_key": "M3A-P029::M3A-P029-E001-M3A-P029-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P029'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P029::M3A-P029-E001-M3A-P029-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P030-E001-M3A-P030-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O030"], "source_experiment_tracker_id": "M3A-P030-E001-M3A-P030-E002", "source_paper_tracker_id": "M3A-P030", "tracker_key": "M3A-P030::M3A-P030-E001-M3A-P030-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P030'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P030::M3A-P030-E001-M3A-P030-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P031-E001-M3A-P031-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O031"], "source_experiment_tracker_id": "M3A-P031-E001-M3A-P031-E002", "source_paper_tracker_id": "M3A-P031", "tracker_key": "M3A-P031::M3A-P031-E001-M3A-P031-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P031'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P031::M3A-P031-E001-M3A-P031-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P032-E001-M3A-P032-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O032"], "source_experiment_tracker_id": "M3A-P032-E001-M3A-P032-E002", "source_paper_tracker_id": "M3A-P032", "tracker_key": "M3A-P032::M3A-P032-E001-M3A-P032-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P032'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P032::M3A-P032-E001-M3A-P032-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P033-E001-M3A-P033-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O033"], "source_experiment_tracker_id": "M3A-P033-E001-M3A-P033-E002", "source_paper_tracker_id": "M3A-P033", "tracker_key": "M3A-P033::M3A-P033-E001-M3A-P033-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P033'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P033::M3A-P033-E001-M3A-P033-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P034-E001-M3A-P034-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O034"], "source_experiment_tracker_id": "M3A-P034-E001-M3A-P034-E002", "source_paper_tracker_id": "M3A-P034", "tracker_key": "M3A-P034::M3A-P034-E001-M3A-P034-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P034'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P034::M3A-P034-E001-M3A-P034-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P035-E001-M3A-P035-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O035"], "source_experiment_tracker_id": "M3A-P035-E001-M3A-P035-E002", "source_paper_tracker_id": "M3A-P035", "tracker_key": "M3A-P035::M3A-P035-E001-M3A-P035-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P035'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P035::M3A-P035-E001-M3A-P035-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P036-E001-M3A-P036-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O036"], "source_experiment_tracker_id": "M3A-P036-E001-M3A-P036-E002", "source_paper_tracker_id": "M3A-P036", "tracker_key": "M3A-P036::M3A-P036-E001-M3A-P036-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P036'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P036::M3A-P036-E001-M3A-P036-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P037-E001-M3A-P037-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O037"], "source_experiment_tracker_id": "M3A-P037-E001-M3A-P037-E002", "source_paper_tracker_id": "M3A-P037", "tracker_key": "M3A-P037::M3A-P037-E001-M3A-P037-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P037'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P037::M3A-P037-E001-M3A-P037-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P038-E001-M3A-P038-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O038"], "source_experiment_tracker_id": "M3A-P038-E001-M3A-P038-E002", "source_paper_tracker_id": "M3A-P038", "tracker_key": "M3A-P038::M3A-P038-E001-M3A-P038-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P038'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P038::M3A-P038-E001-M3A-P038-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P039-E001-M3A-P039-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O039"], "source_experiment_tracker_id": "M3A-P039-E001-M3A-P039-E002", "source_paper_tracker_id": "M3A-P039", "tracker_key": "M3A-P039::M3A-P039-E001-M3A-P039-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P039'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P039::M3A-P039-E001-M3A-P039-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P040-E001-M3A-P040-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O040"], "source_experiment_tracker_id": "M3A-P040-E001-M3A-P040-E002", "source_paper_tracker_id": "M3A-P040", "tracker_key": "M3A-P040::M3A-P040-E001-M3A-P040-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P040'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P040::M3A-P040-E001-M3A-P040-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P041-E001-M3A-P041-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O041"], "source_experiment_tracker_id": "M3A-P041-E001-M3A-P041-E002", "source_paper_tracker_id": "M3A-P041", "tracker_key": "M3A-P041::M3A-P041-E001-M3A-P041-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P041'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P041::M3A-P041-E001-M3A-P041-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P042-E001-M3A-P042-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O042"], "source_experiment_tracker_id": "M3A-P042-E001-M3A-P042-E002", "source_paper_tracker_id": "M3A-P042", "tracker_key": "M3A-P042::M3A-P042-E001-M3A-P042-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P042'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P042::M3A-P042-E001-M3A-P042-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P043-E001-M3A-P043-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O043"], "source_experiment_tracker_id": "M3A-P043-E001-M3A-P043-E002", "source_paper_tracker_id": "M3A-P043", "tracker_key": "M3A-P043::M3A-P043-E001-M3A-P043-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P043'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P043::M3A-P043-E001-M3A-P043-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P044-E001-M3A-P044-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O044"], "source_experiment_tracker_id": "M3A-P044-E001-M3A-P044-E002", "source_paper_tracker_id": "M3A-P044", "tracker_key": "M3A-P044::M3A-P044-E001-M3A-P044-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P044'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P044::M3A-P044-E001-M3A-P044-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P045-E001-M3A-P045-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O045"], "source_experiment_tracker_id": "M3A-P045-E001-M3A-P045-E002", "source_paper_tracker_id": "M3A-P045", "tracker_key": "M3A-P045::M3A-P045-E001-M3A-P045-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P045'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P045::M3A-P045-E001-M3A-P045-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    ...
    'Tracker experiment M3A-P046-E001-M3A-P046-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O046"], "source_experiment_tracker_id": "M3A-P046-E001-M3A-P046-E002", "source_paper_tracker_id": "M3A-P046", "tracker_key": "M3A-P046::M3A-P046-E001-M3A-P046-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P046'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P046::M3A-P046-E001-M3A-P046-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  SELECT p.paper_id, ep.paradigm_id,
    1,
    'Abstract / saturated A tracker',
    'Tracker experiment M3A-P047-E001-M3A-P047-E002',
    'Module 3B tracker-derived experiment placeholder for SQL materialization.',
    '{"observation_tracker_ids": ["M3B-O047"], "source_experiment_tracker_id": "M3A-P047-E001-M3A-P047-E002", "source_paper_tracker_id": "M3A-P047", "tracker_key": "M3A-P047::M3A-P047-E001-M3A-P047-E002"}'
  FROM _m3_paper_map p
  JOIN _m3_paradigm_map ep ON ep.tracker_id = p.tracker_id
  WHERE p.tracker_id = 'M3A-P047'
  RETURNING experiment_id
)
INSERT INTO _m3_experiment_map (tracker_id, experiment_id) SELECT 'M3A-P047::M3A-P047-E001-M3A-P047-E002', experiment_id FROM inserted;
...
WITH inserted AS (
  ...
  WHERE e.tracker_id = 'M3A-P001::M3A-P001-E001-M3A-P001-E002'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: CSF1R Inhibition Reduces Microglia Proliferation, Promotes Tissue Preservation and Improves Motor Recovery After Spinal Cord Injury. Note: Microglia/macrophage modulation anchor.", "experiment_tracker_id": "M3A-P003-E001-M3A-P003-E002", "paper_tracker_id": "M3A-P003", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T001", "tracker_id": "M3B-O003"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P003::M3A-P003-E001-M3A-P003-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'depletion / inflammatory persistence / recovery'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: Inhibiting HMGB1-RAGE axis prevents pro-inflammatory macrophages/microglia polarization and affords neuroprotection after spinal cord injury. Note: Mechanistic polarization anchor.", "experiment_tracker_id": "M3A-P004-E001-M3A-P004-E002", "paper_tracker_id": "M3A-P004", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T003", "tracker_id": "M3B-O004"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P004::M3A-P004-E001-M3A-P004-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: Metabolic reprogramming through histone lactylation in microglia and macrophages recruits CD8+ T lymphocytes and aggravates spinal cord injury. Note: Recent immune-state mechanism.", "experiment_tracker_id": "M3A-P007-E001-M3A-P007-E002", "paper_tracker_id": "M3A-P007", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T008", "tracker_id": "M3B-O007"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P007::M3A-P007-E001-M3A-P007-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: A dual-drug sequential delivery hydrogel for programmatic microglia/macrophage polarization and function recovery in spinal cord injury.. Note: Macrophage/microglia polarization signaling anchor.", "experiment_tracker_id": "M3A-P010-E001-M3A-P010-E002", "paper_tracker_id": "M3A-P010", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T003", "tracker_id": "M3B-O010"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P010::M3A-P010-E001-M3A-P010-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: Microenvironment Self-Adaptive Nanomedicine Promotes Spinal Cord Repair by Suppressing Inflammation Cascade and Neural Apoptosis.. Note: Nanomedicine inflammation-cascade anchor.", "experiment_tracker_id": "M3A-P011-E001-M3A-P011-E002", "paper_tracker_id": "M3A-P011", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T008", "tracker_id": "M3B-O011"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P011::M3A-P011-E001-M3A-P011-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: Farrerol confers neuroprotection in spinal cord injury by regulating macrophages/microglia polarization through the JAK2/STAT3 pathway.. Note: JAK2/STAT3 polarization anchor.", "experiment_tracker_id": "M3A-P012-E001-M3A-P012-E002", "paper_tracker_id": "M3A-P012", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T003", "tracker_id": "M3B-O012"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P012::M3A-P012-E001-M3A-P012-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Macrophage/microglia polarization signaling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: GDF11 alleviates spinal cord injury in rats by modulating microglia polarization through Smad2/3 and MAPK/NFkappaB signaling pathways.. Note: GDF11 microglial-polarization anchor.", "experiment_tracker_id": "M3A-P013-E001-M3A-P013-E002", "paper_tracker_id": "M3A-P013", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T003", "tracker_id": "M3B-O013"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P013::M3A-P013-E001-M3A-P013-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Macrophage/microglia polarization signaling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: Fisetin Promotes Functional Recovery after Spinal Cord Injury by Inhibiting Microglia/Macrophage M1 Polarization and JAK2/STAT3 Signaling Pathway.. Note: Fisetin polarization anchor.", "experiment_tracker_id": "M3A-P014-E001-M3A-P014-E002", "paper_tracker_id": "M3A-P014", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T003", "tracker_id": "M3B-O014"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P014::M3A-P014-E001-M3A-P014-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Macrophage/microglia polarization signaling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'low',
    '{"curator_notes": "Primary title: Engineered CCR2 positive macrophages coordinate immunoregulation with neural regeneration and matrix remodeling after spinal cord injury.. Note: Single-cell / spatial immune-state mapping anchor.", "experiment_tracker_id": "M3A-P016-E001-M3A-P016-E002", "paper_tracker_id": "M3A-P016", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T006", "tracker_id": "M3B-O016"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P016::M3A-P016-E001-M3A-P016-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: Nanoparticles loaded with a CSF1R antagonist selectively depletes microglial cells and modulates inflammation in spinal cord injury.. Note: Microglial depletion / CSF1R modulation anchor.", "experiment_tracker_id": "M3A-P018-E001-M3A-P018-E002", "paper_tracker_id": "M3A-P018", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T001", "tracker_id": "M3B-O018"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P018::M3A-P018-E001-M3A-P018-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'depletion / inflammatory persistence / recovery'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'low',
    '{"curator_notes": "Primary title: Identification of repopulated microglia-associated genes in microglia depleted/repopulated mice after spinal cord injury.. Note: Microglial depletion / CSF1R modulation anchor.", "experiment_tracker_id": "M3A-P019-E001-M3A-P019-E002", "paper_tracker_id": "M3A-P019", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T001", "tracker_id": "M3B-O019"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P019::M3A-P019-E001-M3A-P019-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'depletion / inflammatory persistence / recovery'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: Nonresolving Neuroinflammation Regulates Axon Regeneration in Chronic Spinal Cord Injury.. Note: Microglial depletion / CSF1R modulation anchor.", "experiment_tracker_id": "M3A-P020-E001-M3A-P020-E002", "paper_tracker_id": "M3A-P020", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T001", "tracker_id": "M3B-O020"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P020::M3A-P020-E001-M3A-P020-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'depletion / inflammatory persistence / recovery'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'low',
    '{"curator_notes": "Primary title: Depleting non-resolving neuroinflammation in chronic spinal cord injury attenuates thermal hypersensitivity.. Note: Microglial depletion / CSF1R modulation anchor.", "experiment_tracker_id": "M3A-P021-E001-M3A-P021-E002", "paper_tracker_id": "M3A-P021", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T001", "tracker_id": "M3B-O021"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P021::M3A-P021-E001-M3A-P021-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'depletion / inflammatory persistence / recovery'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Full text / PMC12767085',
    'high',
    '{"curator_notes": "Full-text upgrade from PMID 41103249; inhibition/remodeling rather than simple depletion.", "experiment_tracker_id": "M3A-P022-E001-M3A-P022-E002", "paper_tracker_id": "M3A-P022", "quantitative": "YES", "statistics_reported": "Full text reports microglial phenotype, ECM/scar remodeling, reticulospinal regeneration, and functional recovery endpoints", "topic_id": "M3B-T001", "tracker_id": "M3B-O022"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P022::M3A-P022-E001-M3A-P022-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'depletion / inflammatory persistence / recovery'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'medium',
    '{"curator_notes": "Primary title: Lipid accumulation in foam cells drives C1q-dependent synaptic loss and impairs motor function recovery after spinal cord injury.. Note: Immune metabolism / lipid and debris handling anchor.", "experiment_tracker_id": "M3A-P024-E001-M3A-P024-E002", "paper_tracker_id": "M3A-P024", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T005", "tracker_id": "M3B-O024"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P024::M3A-P024-E001-M3A-P024-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Immune metabolism / lipid and debris handling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Full text / PMC12884443',
    'high',
    '{"curator_notes": "Full-text upgrade from PMID 41660680; contradiction boundary retained.", "experiment_tracker_id": "M3A-P025-E001-M3A-P025-E002", "paper_tracker_id": "M3A-P025", "quantitative": "YES", "statistics_reported": "Full text reports TREM2 expression, phagocytosis, foamy macrophages, DAM activation, axon regeneration, neuronal survival, BMS, and footprint outcomes", "topic_id": "M3B-T005", "tracker_id": "M3B-O025"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P025::M3A-P025-E001-M3A-P025-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Immune metabolism / lipid and debris handling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Full text / PMC13010529',
    'high',
    '{"curator_notes": "Full-text upgrade from PMID 41856077; human/translational plus mouse mechanism.", "experiment_tracker_id": "M3A-P026-E001-M3A-P026-E002", "paper_tracker_id": "M3A-P026", "quantitative": "YES", "statistics_reported": "Full text reports human serum lactate association, mouse SCI macrophage/monocyte H3K9la, multi-omics, and TXNIP/NLRP3 perturbation", "topic_id": "M3B-T004", "tracker_id": "M3B-O026"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P026::M3A-P026-E001-M3A-P026-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Full text / PMC13199823',
    'high',
    '{"curator_notes": "Full-text upgrade from PMID 42199531.", "experiment_tracker_id": "M3A-P027-E001-M3A-P027-E002", "paper_tracker_id": "M3A-P027", "quantitative": "YES", "statistics_reported": "Full text reports bioinformatics, microglial cell-death specificity, metformin/AMPK perturbation, inflammation, tissue preservation, and functional outcomes", "topic_id": "M3B-T004", "tracker_id": "M3B-O027"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P027::M3A-P027-E001-M3A-P027-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Microglia/macrophage programmed inflammatory death'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Full text / PMC13003968',
    'high',
    '{"curator_notes": "Reclassified from generic polarization to programmed inflammatory death based on full text.", "experiment_tracker_id": "M3A-P028-E001-M3A-P028-E002", "paper_tracker_id": "M3A-P028", "quantitative": "YES", "statistics_reported": "Full text reports cell-type PANoptosis scoring, candidate-gene prioritization, and therapeutic-target screening", "topic_id": "M3B-T004", "tracker_id": "M3B-O028"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P028::M3A-P028-E001-M3A-P028-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Microglia/macrophage programmed inflammatory death'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'low',
    '{"curator_notes": "Primary title: Trimethylamine N-Oxide Aggravates Neuro-inflammation in Spinal Cord Injury Through NLRP3 Inflammasome Activation in Microglia.. Note: Microglia/macrophage programmed inflammatory death anchor.", "experiment_tracker_id": "M3A-P029-E001-M3A-P029-E002", "paper_tracker_id": "M3A-P029", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T004", "tracker_id": "M3B-O029"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P029::M3A-P029-E001-M3A-P029-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Microglia/macrophage programmed inflammatory death'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'low',
    '{"curator_notes": "Primary title: Thiolutin attenuates neuroinflammation and neuronal apoptosis by suppressing microglial pyroptosis through NLRP3 inflammasome inhibition after spinal cord injury.. Note: Macrophage/microglia polarization signaling anchor.", "experiment_tracker_id": "M3A-P030-E001-M3A-P030-E002", "paper_tracker_id": "M3A-P030", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T001", "tracker_id": "M3B-O030"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P030::M3A-P030-E001-M3A-P030-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Macrophage/microglia polarization signaling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'low',
    '{"curator_notes": "Primary title: Type 2 Diabetes Promotes the Microglial Pyroptosis by Activating NLRP3 Inflammasome to Impede Remyelination After Spinal Cord Injury.. Note: Macrophage/microglia polarization signaling anchor.", "experiment_tracker_id": "M3A-P031-E001-M3A-P031-E002", "paper_tracker_id": "M3A-P031", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T003", "tracker_id": "M3B-O031"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P031::M3A-P031-E001-M3A-P031-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Macrophage/microglia polarization signaling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Full text / PMC13037223',
    'high',
    '{"curator_notes": "Reclassified from programmed death to lipid/debris handling based on full text.", "experiment_tracker_id": "M3A-P032-E001-M3A-P032-E002", "paper_tracker_id": "M3A-P032", "quantitative": "YES", "statistics_reported": "Full text reports in vitro debris phagocytosis, Clec10a perturbation, macrophage lipid/debris processing, inflammation, and repair endpoints", "topic_id": "M3B-T005", "tracker_id": "M3B-O032"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P032::M3A-P032-E001-M3A-P032-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Immune metabolism / lipid and debris handling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'low',
    '{"curator_notes": "Primary title: GP130 Regulates Macrophage Polarization and Functional Recovery after Spinal Cord Injury in Rats: A Single-Cell RNA Sequencing Study.. Note: Macrophage/microglia polarization signaling anchor.", "experiment_tracker_id": "M3A-P033-E001-M3A-P033-E002", "paper_tracker_id": "M3A-P033", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T003", "tracker_id": "M3B-O033"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P033::M3A-P033-E001-M3A-P033-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Macrophage/microglia polarization signaling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'low',
    '{"curator_notes": "Primary title: Temporal regulation of macrophage polarization by abnormally innervated CGRP + Sensory nerves following spinal cord injury.. Note: Macrophage/microglia polarization signaling anchor.", "experiment_tracker_id": "M3A-P034-E001-M3A-P034-E002", "paper_tracker_id": "M3A-P034", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T003", "tracker_id": "M3B-O034"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P034::M3A-P034-E001-M3A-P034-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Macrophage/microglia polarization signaling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Full text / PMC12964225',
    'high',
    '{"curator_notes": "Full-text upgrade from PMID 41799191; translational context retained.", "experiment_tracker_id": "M3A-P035-E001-M3A-P035-E002", "paper_tracker_id": "M3A-P035", "quantitative": "YES", "statistics_reported": "Full text reports randomized rat SCI treatment groups, systemic IL-4 dosing, behavioral recovery, macrophage/microglia polarization, transcriptomic/cytokine analyses, and human translational signature comparison", "topic_id": "M3B-T003", "tracker_id": "M3B-O035"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P035::M3A-P035-E001-M3A-P035-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Macrophage/microglia polarization signaling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Full text / PMC13157101',
    'high',
    '{"curator_notes": "Full-text upgrade from PMID 42111233; biomaterial-delivery boundary retained.", "experiment_tracker_id": "M3A-P038-E001-M3A-P038-E002", "paper_tracker_id": "M3A-P038", "quantitative": "YES", "statistics_reported": "Full text reports neonatal repair comparison, SCMEC lipid metabolism, CXCL12/CXCR4 macrophage recruitment, hydrogel vesicle delivery, scarring, and neuroaxonal repair endpoints", "topic_id": "M3B-T005", "tracker_id": "M3B-O038"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P038::M3A-P038-E001-M3A-P038-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Immune metabolism / lipid and debris handling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P039::M3A-P039-E001-M3A-P039-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Immune metabolism / lipid and debris handling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'low',
    '{"curator_notes": "Primary title: Targeted biohybrid nanoplatform for spinal cord injury treatment: Restoring microglial mitophagy and alleviating oxidative stress.. Note: Immune metabolism / lipid and debris handling anchor.", "experiment_tracker_id": "M3A-P040-E001-M3A-P040-E002", "paper_tracker_id": "M3A-P040", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T005", "tracker_id": "M3B-O040"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P040::M3A-P040-E001-M3A-P040-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Immune metabolism / lipid and debris handling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Abstract / saturated A tracker',
    'low',
    '{"curator_notes": "Primary title: A reparative neutrophil subpopulation accelerates spinal cord regeneration in zebrafish by controlling macrophage inflammation via Il-4.. Note: Macrophage/microglia polarization signaling anchor.", "experiment_tracker_id": "M3A-P044-E001-M3A-P044-E002", "paper_tracker_id": "M3A-P044", "quantitative": "NO", "statistics_reported": "Abstract-level first pass; exact statistics not extracted", "topic_id": "M3B-T003", "tracker_id": "M3B-O044"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P044::M3A-P044-E001-M3A-P044-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Macrophage/microglia polarization signaling'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Full text / PMC12988535',
    'high',
    '{"curator_notes": "Full-text upgrade from PMID 41836554.", "experiment_tracker_id": "M3A-P045-E001-M3A-P045-E002", "paper_tracker_id": "M3A-P045", "quantitative": "YES", "statistics_reported": "Full text reports scRNA-seq, primary pericyte/CXCL4 assays, macrophage co-culture, PMT markers, pathway perturbation, and scar/fibrosis outcomes", "topic_id": "M3B-T002", "tracker_id": "M3B-O045"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P045::M3A-P045-E001-M3A-P045-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
...
WITH inserted AS (
  ...
  SELECT e.experiment_id, et.evidence_type_id, ot.outcome_type_id,
    ...
    'Full text / PMC12936232',
    'high',
    '{"curator_notes": "Full-text upgrade from PMID 41741406.", "experiment_tracker_id": "M3A-P046-E001-M3A-P046-E002", "paper_tracker_id": "M3A-P046", "quantitative": "YES", "statistics_reported": "Full text reports active TGF-beta elevation, macrophage source, MSC/pericyte fibroblast differentiation, fibrotic scar inhibition, and recovery endpoints", "topic_id": "M3B-T002", "tracker_id": "M3B-O046"}'
  FROM _m3_experiment_map e
  CROSS JOIN ControlledVocabulary_EvidenceType et
  CROSS JOIN ControlledVocabulary_OutcomeType ot
  WHERE e.tracker_id = 'M3A-P046::M3A-P046-E001-M3A-P046-E002'
    AND et.evidence_type_name = 'Immune/myeloid intervention or mechanism'
    AND ot.outcome_type_name = 'Macrophage-fibrotic scar interaction'
  RETURNING observation_id
)
...
WITH inserted AS (
  ...
  VALUES (
    'Microglial depletion and CSF1R-pathway modulation are timing-sensitive tools, not universal anti-inflammatory solutions.',
    'M3B-T001',
    1,
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Myeloid cells can both contain wounds and drive fibrosis, so lesion remodeling claims must separate corralling from fibrotic scar programs.',
    'M3B-T002',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Macrophage/microglia polarization evidence is abundant but needs marker-level harmonization before high-confidence mechanistic pooling.',
    'M3B-T003',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Inflammasome, pyroptosis, and PANoptosis pathways form a distinct inflammatory cell-death axis after SCI.',
    'M3B-T004',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Immune metabolism, lipid handling, debris clearance, and efferocytosis connect myeloid state to repair and chronic degeneration.',
    'M3B-T005',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Single-cell and spatial studies should refine Module 3 vocabulary rather than serve as standalone therapeutic proof.',
    'M3B-T006',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Immune-modifying delivery systems are promising but require careful separation of payload, carrier, route, and timing.',
    'M3B-T007',
    1,
    'consensus-ready first pass',
...
WITH inserted AS (
  INSERT INTO Consensus (consensus_statement, topic, version, agreement_level, notes)
  VALUES (
    'Module 3 supports mechanism-specific immune consensus profiles rather than a single claim that suppressing inflammation improves SCI.',
    'M3B-T008',
    1,
    'consensus-ready first pass',
