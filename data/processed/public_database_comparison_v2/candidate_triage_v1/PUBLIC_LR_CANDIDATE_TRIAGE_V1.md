...
This report reduces `7,753` public-only rows to `7,753` normalized candidate units against `8,167` direct ligand--receptor graph edges from `module20_24_mechanism_graph:2026-09-21`.
