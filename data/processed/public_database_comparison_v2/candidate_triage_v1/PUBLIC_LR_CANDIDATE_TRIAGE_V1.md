...
| Completed batch review | 4,700 | Resolved in a batch-specific evidence ledger; excluded from new review batches while retaining the resolution record. |
...
| Discovery review | 2,060 | No automatic graph match and no primary locator in the frozen public snapshot. |

The actionable review queue contains `2,060` units, of which `0` have a primary locator and `2,060` require discovery or broader evidence search.
