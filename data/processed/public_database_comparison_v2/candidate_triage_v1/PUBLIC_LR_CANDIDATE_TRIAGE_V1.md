...
| Completed batch review | 3,100 | Resolved in a batch-specific evidence ledger; excluded from new review batches while retaining the resolution record. |
...
| Discovery review | 3,660 | No automatic graph match and no primary locator in the frozen public snapshot. |

The actionable review queue contains `3,660` units, of which `0` have a primary locator and `3,660` require discovery or broader evidence search.
