...
Release: `module20_24_mechanism_graph:2026-09-23-common-gamma-primary-344`
...
| L→R→output | 8,693 |
| L→R→TF→output | 516 |
| L→R→intracellular→output | 3,234 |
| L→R→intracellular→TF→output | 309,185 |
| L→R→entry→only | 9,307 |

## Audit and public-LR coverage

- Route-evidence records: 334,051
- Graph edges: 14,801
